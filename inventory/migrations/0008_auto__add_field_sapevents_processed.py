...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SapEvents.processed'
        db.add_column('inventory_sapevents', 'processed', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SapEvents.processed'
        db.delete_column('inventory_sapevents', 'processed')
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 4, 12, 59, 23, 867947)', 'auto_now_add': 'True', 'blank': 'True'}),
