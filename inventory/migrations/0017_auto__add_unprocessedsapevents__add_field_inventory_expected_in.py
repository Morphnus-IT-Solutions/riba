...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UnprocessedSAPEvents'
        db.create_table('inventory_unprocessedsapevents', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('article_id', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('receiving_storage_location', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('receiving_site', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('issuing_storage_location', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('issuing_site', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('quantity', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('actual_quantity', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
        ))
        db.send_create_signal('inventory', ['UnprocessedSAPEvents'])

        # Adding field 'Inventory.expected_in'
        db.add_column('inventory_inventory', 'expected_in', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True, default=None), keep_default=True)


    def backwards(self, orm):
        
        # Deleting model 'UnprocessedSAPEvents'
        db.delete_table('inventory_unprocessedsapevents')

        # Deleting field 'Inventory.expected_in'
        db.delete_column('inventory_inventory', 'expected_in')
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 18, 41, 5, 919231)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            ...
            'expected_in': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
