...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InventoryStoLog.inventory'
        db.delete_column('inventory_inventorystolog', 'inventory_id')


    def backwards(self, orm):
        
        # Adding field 'InventoryStoLog.inventory'
        db.add_column('inventory_inventorystolog', 'inventory', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['inventory.Inventory']), keep_default=False)
