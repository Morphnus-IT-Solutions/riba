...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InventoryStoLog.stock_allocated'
        db.add_column('inventory_inventorystolog', 'stock_allocated', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InventoryStoLog.stock_allocated'
        db.delete_column('inventory_inventorystolog', 'stock_allocated')
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 11, 42, 6, 939383)', 'auto_now_add': 'True', 'blank': 'True'}),
