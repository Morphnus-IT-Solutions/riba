...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('inventory_inventory', (
            ...
            ('dc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fulfillment.Dc'], null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(default='physical', max_length=25)),
            ('stock', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ...
            ('bookings', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('outward', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('threshold', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('stock_adjustment', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('bookings_adjustment', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
        ...
        # Adding model 'InventoryDcLspResolution'
        db.create_table('inventory_inventorydclspresolution', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('order_xml_created', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('inventory', ['InventoryDcLspResolution'])

        # Adding model 'InventoryBackorder'
        db.create_table('inventory_inventorybackorder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rate_chart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SellerRateChart'], unique=True)),
            ('dc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fulfillment.Dc'], null=True, blank=True)),
            ('backorderable', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('expected_in', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('inventory', ['InventoryBackorder'])

        # Adding unique constraint on 'InventoryBackorder', fields ['rate_chart', 'dc']
        db.create_unique('inventory_inventorybackorder', ['rate_chart_id', 'dc_id'])

        # Adding model 'InventoryStoLog'
        db.create_table('inventory_inventorystolog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inventory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Inventory'])),
            ('orderitem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.OrderItem'])),
            ('from_dc', self.gf('django.db.models.fields.related.ForeignKey')(related_name='from_dc', to=orm['fulfillment.Dc'])),
            ('to_dc', self.gf('django.db.models.fields.related.ForeignKey')(related_name='to_dc', to=orm['fulfillment.Dc'])),
            ('ack_received', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('inventory', ['InventoryStoLog'])

        # Adding model 'InventoryLog'
        db.create_table('inventory_inventorylog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rate_chart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SellerRateChart'])),
            ('dc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fulfillment.Dc'])),
            ('inventory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Inventory'], null=True, blank=True)),
            ('sto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.InventoryStoLog'], null=True, blank=True)),
            ('backorder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.InventoryBackorder'], null=True, blank=True)),
            ('was_stock', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('new_stock', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('was_starts_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('new_starts_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('was_ends_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('new_ends_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ...
            ('was_bookings', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('new_bookings', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('was_outward', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('new_outward', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('was_threshold', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('new_threshold', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('was_stock_adjustment', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('new_stock_adjustment', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('was_bookings_adjustment', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('new_bookings_adjustment', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Order'], null=True, blank=True)),
            ('orderitem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.OrderItem'], null=True, blank=True)),
            ('lsp', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fulfillment.Lsp'], null=True, blank=True)),
        ...
        db.send_create_signal('inventory', ['InventoryLog'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'InventoryDcLspResolution'
        db.delete_table('inventory_inventorydclspresolution')

        # Deleting model 'InventoryBackorder'
        db.delete_table('inventory_inventorybackorder')

        # Removing unique constraint on 'InventoryBackorder', fields ['rate_chart', 'dc']
        db.delete_unique('inventory_inventorybackorder', ['rate_chart_id', 'dc_id'])

        # Deleting model 'InventoryStoLog'
        db.delete_table('inventory_inventorystolog')

        # Deleting model 'InventoryLog'
        db.delete_table('inventory_inventorylog')
    ...
    models = {
        ...
        'inventory.inventorydclspresolution': {
            ...
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'order_xml_created': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
