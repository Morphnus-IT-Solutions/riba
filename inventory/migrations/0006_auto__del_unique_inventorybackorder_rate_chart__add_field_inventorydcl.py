...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'InventoryBackorder', fields ['rate_chart']
        db.delete_unique('inventory_inventorybackorder', ['rate_chart_id'])

        # Adding field 'InventoryDcLspResolution.stock_allocated'
        db.add_column('inventory_inventorydclspresolution', 'stock_allocated', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Inventory.created_on'
        db.add_column('inventory_inventory', 'created_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 2, 3, 11, 51, 51, 319689), auto_now_add=True, blank=True), keep_default=False)

        # Adding index on 'Inventory', fields ['starts_on']
        db.create_index('inventory_inventory', ['starts_on'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'InventoryBackorder', fields ['rate_chart']
        db.create_unique('inventory_inventorybackorder', ['rate_chart_id'])

        # Deleting field 'InventoryDcLspResolution.stock_allocated'
        db.delete_column('inventory_inventorydclspresolution', 'stock_allocated')

        # Deleting field 'Inventory.created_on'
        db.delete_column('inventory_inventory', 'created_on')

        # Removing index on 'Inventory', fields ['starts_on']
        db.delete_index('inventory_inventory', ['starts_on'])
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 3, 11, 51, 51, 319689)', 'auto_now_add': 'True', 'blank': 'True'}),
