...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SapEvents'
        db.create_table('inventory_sapevents', (
            ...
            ('type', self.gf('django.db.models.fields.CharField')(default='website', max_length=20)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('inventory', ['SapEvents'])

        # Removing unique constraint on 'Inventory', fields ['rate_chart']
        #db.delete_unique('inventory_inventory', ['rate_chart_id'])


    def backwards(self, orm):
        
        # Deleting model 'SapEvents'
        db.delete_table('inventory_sapevents')

        # Adding unique constraint on 'Inventory', fields ['rate_chart']
        #db.create_unique('inventory_inventory', ['rate_chart_id'])
    ...
    models = {
        ...
        'inventory.sapevents': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rate_chart': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.SellerRateChart']"}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'website'", 'max_length': '20'})
        },
        'orders.order': {
