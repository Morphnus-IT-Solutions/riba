...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SapEvents.storage_location'
        db.add_column('inventory_sapevents', 'storage_location', self.gf('django.db.models.fields.PositiveIntegerField')(default=10), keep_default=False)

        # Adding field 'SapEvents.modified_on'
        db.add_column('inventory_sapevents', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2012, 2, 4), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SapEvents.storage_location'
        db.delete_column('inventory_sapevents', 'storage_location')

        # Deleting field 'SapEvents.modified_on'
        db.delete_column('inventory_sapevents', 'modified_on')
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 4, 12, 53, 30, 412319)', 'auto_now_add': 'True', 'blank': 'True'}),
