...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InventoryDcLspResolution.is_valid'
        db.add_column('inventory_inventorydclspresolution', 'is_valid', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True, blank=True), keep_default=True)

        # Adding field 'InventoryStoLog.is_valid'
        db.add_column('inventory_inventorystolog', 'is_valid', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True, blank=True), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'InventoryDcLspResolution.is_valid'
        db.delete_column('inventory_inventorydclspresolution', 'is_valid')

        # Deleting field 'InventoryStoLog.is_valid'
        db.delete_column('inventory_inventorystolog', 'is_valid')
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 9, 15, 12, 6, 3002)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
