...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InventoryLog.was_sto_stock_allocated'
        db.add_column('inventory_inventorylog', 'was_sto_stock_allocated', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True), keep_default=False)

        # Adding field 'InventoryLog.new_sto_stock_allocated'
        db.add_column('inventory_inventorylog', 'new_sto_stock_allocated', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True), keep_default=False)

        # Adding field 'InventoryLog.was_sto_ack_received'
        db.add_column('inventory_inventorylog', 'was_sto_ack_received', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True), keep_default=False)

        # Adding field 'InventoryLog.new_sto_ack_received'
        db.add_column('inventory_inventorylog', 'new_sto_ack_received', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True), keep_default=False)

        # Adding field 'InventoryLog.was_dclsp_stock_allocated'
        db.add_column('inventory_inventorylog', 'was_dclsp_stock_allocated', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True), keep_default=False)

        # Adding field 'InventoryLog.new_dclsp_stock_allocated'
        db.add_column('inventory_inventorylog', 'new_dclsp_stock_allocated', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InventoryLog.was_sto_stock_allocated'
        db.delete_column('inventory_inventorylog', 'was_sto_stock_allocated')

        # Deleting field 'InventoryLog.new_sto_stock_allocated'
        db.delete_column('inventory_inventorylog', 'new_sto_stock_allocated')

        # Deleting field 'InventoryLog.was_sto_ack_received'
        db.delete_column('inventory_inventorylog', 'was_sto_ack_received')

        # Deleting field 'InventoryLog.new_sto_ack_received'
        db.delete_column('inventory_inventorylog', 'new_sto_ack_received')

        # Deleting field 'InventoryLog.was_dclsp_stock_allocated'
        db.delete_column('inventory_inventorylog', 'was_dclsp_stock_allocated')

        # Deleting field 'InventoryLog.new_dclsp_stock_allocated'
        db.delete_column('inventory_inventorylog', 'new_dclsp_stock_allocated')
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 0, 56, 27, 905388)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
