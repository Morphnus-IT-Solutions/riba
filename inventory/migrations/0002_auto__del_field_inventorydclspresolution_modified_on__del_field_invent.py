...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InventoryDcLspResolution.modified_on'
        db.delete_column('inventory_inventorydclspresolution', 'modified_on')

        # Deleting field 'InventoryDcLspResolution.order_xml_created'
        db.delete_column('inventory_inventorydclspresolution', 'order_xml_created')


    def backwards(self, orm):
        
        # Adding field 'InventoryDcLspResolution.modified_on'
        db.add_column('inventory_inventorydclspresolution', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2012, 1, 31), blank=True), keep_default=False)

        # Adding field 'InventoryDcLspResolution.order_xml_created'
        db.add_column('inventory_inventorydclspresolution', 'order_xml_created', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
