...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SapEvents.actual_quantity'
        db.add_column('inventory_sapevents', 'actual_quantity', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SapEvents.actual_quantity'
        db.delete_column('inventory_sapevents', 'actual_quantity')
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 14, 18, 40, 16, 488441)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
