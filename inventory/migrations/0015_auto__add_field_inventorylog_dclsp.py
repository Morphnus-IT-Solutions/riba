...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InventoryLog.dclsp'
        db.add_column('inventory_inventorylog', 'dclsp', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.InventoryDcLspResolution'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InventoryLog.dclsp'
        db.delete_column('inventory_inventorylog', 'dclsp_id')
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 1, 35, 38, 293369)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        'inventory.inventorylog': {
            ...
            'dc': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fulfillment.Dc']"}),
            'dclsp': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['inventory.InventoryDcLspResolution']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
