...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InventoryDcLspResolution.expected_stock_arrival'
        db.add_column('inventory_inventorydclspresolution', 'expected_stock_arrival', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, db_index=True, blank=True), keep_default=True)

        # Adding field 'InventoryDcLspResolution.expected_shipping_date'
        db.add_column('inventory_inventorydclspresolution', 'expected_shipping_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, db_index=True, blank=True), keep_default=True)

        # Adding field 'InventoryDcLspResolution.expected_delivery_date'
        db.add_column('inventory_inventorydclspresolution', 'expected_delivery_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, db_index=True, blank=True), keep_default=True)

        # Adding field 'InventoryDcLspResolution.type'
        db.add_column('inventory_inventorydclspresolution', 'type', self.gf('django.db.models.fields.CharField')(default='physical', max_length=25), keep_default=True)

        # Adding index on 'InventoryDcLspResolution', fields ['stock_allocated']
        db.create_index('inventory_inventorydclspresolution', ['stock_allocated'])


    def backwards(self, orm):
        
        # Deleting field 'InventoryDcLspResolution.expected_stock_arrival'
        db.delete_column('inventory_inventorydclspresolution', 'expected_stock_arrival')

        # Deleting field 'InventoryDcLspResolution.expected_shipping_date'
        db.delete_column('inventory_inventorydclspresolution', 'expected_shipping_date')

        # Deleting field 'InventoryDcLspResolution.expected_delivery_date'
        db.delete_column('inventory_inventorydclspresolution', 'expected_delivery_date')

        # Deleting field 'InventoryDcLspResolution.type'
        db.delete_column('inventory_inventorydclspresolution', 'type')

        # Removing index on 'InventoryDcLspResolution', fields ['stock_allocated']
        db.delete_index('inventory_inventorydclspresolution', ['stock_allocated'])
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 27, 12, 3, 14, 268833)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        'inventory.inventorydclspresolution': {
            ...
            'expected_delivery_date': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'expected_shipping_date': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'expected_stock_arrival': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'stock_allocated': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True', 'blank': 'True'}),
