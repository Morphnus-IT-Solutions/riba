...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'InventoryLog', fields ['created_on']
        db.create_index('inventory_inventorylog', ['created_on'])

        # Adding index on 'InventoryDcLspResolution', fields ['created_on']
        db.create_index('inventory_inventorydclspresolution', ['created_on'])

        # Adding index on 'Inventory', fields ['ends_on']
        db.create_index('inventory_inventory', ['ends_on'])

        # Adding index on 'Inventory', fields ['created_on']
        db.create_index('inventory_inventory', ['created_on'])

        # Adding index on 'InventoryStoLog', fields ['created_on']
        db.create_index('inventory_inventorystolog', ['created_on'])


    def backwards(self, orm):
        
        # Removing index on 'InventoryLog', fields ['created_on']
        db.delete_index('inventory_inventorylog', ['created_on'])

        # Removing index on 'InventoryDcLspResolution', fields ['created_on']
        db.delete_index('inventory_inventorydclspresolution', ['created_on'])

        # Removing index on 'Inventory', fields ['ends_on']
        db.delete_index('inventory_inventory', ['ends_on'])

        # Removing index on 'Inventory', fields ['created_on']
        db.delete_index('inventory_inventory', ['created_on'])

        # Removing index on 'InventoryStoLog', fields ['created_on']
        db.delete_index('inventory_inventorystolog', ['created_on'])
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 18, 32, 4, 145391)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
