...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InventoryLog.was_is_active'
        db.add_column('inventory_inventorylog', 'was_is_active', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True), keep_default=True)

        # Adding field 'InventoryLog.new_is_active'
        db.add_column('inventory_inventorylog', 'new_is_active', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'InventoryLog.was_is_active'
        db.delete_column('inventory_inventorylog', 'was_is_active')

        # Deleting field 'InventoryLog.new_is_active'
        db.delete_column('inventory_inventorylog', 'new_is_active')
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 17, 20, 18, 29, 706910)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
