...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InventoryDcLspResolution.stock_to_be_allocated'
        db.add_column('inventory_inventorydclspresolution', 'stock_to_be_allocated', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'InventoryStoLog.stock_to_be_allocated'
        db.add_column('inventory_inventorystolog', 'stock_to_be_allocated', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InventoryDcLspResolution.stock_to_be_allocated'
        db.delete_column('inventory_inventorydclspresolution', 'stock_to_be_allocated')

        # Deleting field 'InventoryStoLog.stock_to_be_allocated'
        db.delete_column('inventory_inventorystolog', 'stock_to_be_allocated')
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 23, 0, 45, 30, 818642)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
