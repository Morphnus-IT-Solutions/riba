...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InventoryLog.was_expected_in'
        db.add_column('inventory_inventorylog', 'was_expected_in', self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'InventoryLog.new_expected_in'
        db.add_column('inventory_inventorylog', 'new_expected_in', self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InventoryLog.was_expected_in'
        db.delete_column('inventory_inventorylog', 'was_expected_in')

        # Deleting field 'InventoryLog.new_expected_in'
        db.delete_column('inventory_inventorylog', 'new_expected_in')
    ...
    models = {
        ...
        'inventory.inventory': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 7, 15, 47, 58, 736603)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
