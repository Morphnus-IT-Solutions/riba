...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InventoryLog.sapevent'
        db.add_column('inventory_inventorylog', 'sapevent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.SapEvents'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InventoryLog.sapevent'
        db.delete_column('inventory_inventorylog', 'sapevent_id')
