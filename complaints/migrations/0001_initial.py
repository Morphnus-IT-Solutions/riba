...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('complaints_complaint', (
            ...
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='order_complaints', null=True, to=orm['orders.Order'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_complaints', to=orm['users.Profile'])),
            ('status', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=15, null=True, blank=True)),
            ('category', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=50, null=True, blank=True)),
        ...
        # Adding model 'Update'
        db.create_table('complaints_update', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('added_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['users.Profile'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('complaints', ['Update'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('complaints_update')
