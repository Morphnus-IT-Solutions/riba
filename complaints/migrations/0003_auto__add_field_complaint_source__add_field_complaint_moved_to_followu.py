...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Complaint.source'
        db.add_column('complaints_complaint', 'source', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'Complaint.moved_to_followup'
        db.add_column('complaints_complaint', 'moved_to_followup', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Complaint.closed_on'
        db.add_column('complaints_complaint', 'closed_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Complaint.TAT'
        db.add_column('complaints_complaint', 'TAT', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Complaint.source'
        db.delete_column('complaints_complaint', 'source')

        # Deleting field 'Complaint.moved_to_followup'
        db.delete_column('complaints_complaint', 'moved_to_followup')

        # Deleting field 'Complaint.closed_on'
        db.delete_column('complaints_complaint', 'closed_on')

        # Deleting field 'Complaint.TAT'
        db.delete_column('complaints_complaint', 'TAT')
    ...
    models = {
        ...
        'complaints.complaint': {
            ...
            'TAT': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'category': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '15', 'null': 'True', 'blank': 'True'}),
            'moved_to_followup': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'order_complaints'", 'null': 'True', 'to': "orm['orders.Order']"}),
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'product_complaint'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['catalog.Product']"}),
            'source': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '15', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_complaints'", 'to': "orm['users.Profile']"})
        },
        'complaints.update': {
            'Meta': {'object_name': 'Update'},
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['users.Profile']"}),
            'category': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'complaint': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['complaints.Complaint']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
