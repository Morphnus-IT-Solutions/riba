...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InformationFlow.state'
        db.add_column('support_informationflow', 'state', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', to=orm['support.State']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InformationFlow.state'
        db.delete_column('support_informationflow', 'state_id')
