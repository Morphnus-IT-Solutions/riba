...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubState.tat'
        db.alter_column('support_substate', 'tat', self.gf('utils.fields.TimeDeltaField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'SubState.tat'
        db.alter_column('support_substate', 'tat', self.gf('utils.fields.TimeDeltaField')(max_length=200, null=True, blank=True))
