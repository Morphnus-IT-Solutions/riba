...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('support_orderlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='order_log', to=orm['orders.Order'])),
            ('action', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['support.Action'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['support.User'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('support', ['OrderLog'])

        # Deleting field 'Action.active'
        db.delete_column('support_action', 'active')

        # Deleting field 'Action.order_item'
        db.delete_column('support_action', 'order_item_id')

        # Deleting field 'Action.order'
        db.delete_column('support_action', 'order_id')

        # Adding field 'Action.entity_type'
        db.add_column('support_action', 'entity_type', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'Action.entity_object_id'
        db.add_column('support_action', 'entity_object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=None), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('support_orderstatus', (
            ...
            ('substate', self.gf('django.db.models.fields.related.ForeignKey')(related_name='orders', null=True, to=orm['support.SubState'], blank=True)),
            ('last_shifted_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('last_action', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['support.Action'], blank=True)),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(related_name='orders', null=True, to=orm['support.State'], blank=True)),
            ('last_acted_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['support.User'], blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.delete_table('support_orderlog')

        # Adding field 'Action.active'
        db.add_column('support_action', 'active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'Action.order_item'
        db.add_column('support_action', 'order_item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['orders.OrderItem'], blank=True), keep_default=False)

        # Adding field 'Action.order'
        db.add_column('support_action', 'order', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', to=orm['support.OrderStatus']), keep_default=False)

        # Deleting field 'Action.entity_type'
        db.delete_column('support_action', 'entity_type_id')

        # Deleting field 'Action.entity_object_id'
        db.delete_column('support_action', 'entity_object_id')
    ...
    models = {
        ...
        'support.action': {
            ...
            'entity_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['contenttypes.ContentType']"}),
        ...
        'support.informationflow': {
            ...
            'state': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['support.State']"}),
        ...
        'support.orderlog': {
            ...
            'action': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['support.Action']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'order_log'", 'to': "orm['orders.Order']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['support.User']"})
        },
        'support.state': {
        ...
        'support.substate': {
            ...
            'tat': ('utils.fields.TimeDeltaField', [], {'null': 'True', 'blank': 'True'})
        },
        'support.team': {
