...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ActionFlow', fields ['final_substate', 'name', 'initial_substate']
        db.delete_unique('support_actionflow', ['final_substate_id', 'name', 'initial_substate_id'])

        # Adding unique constraint on 'ActionFlow', fields ['group', 'final_substate', 'name', 'initial_substate']
        db.create_unique('support_actionflow', ['group', 'final_substate_id', 'name', 'initial_substate_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'ActionFlow', fields ['final_substate', 'name', 'initial_substate']
        db.create_unique('support_actionflow', ['final_substate_id', 'name', 'initial_substate_id'])

        # Removing unique constraint on 'ActionFlow', fields ['group', 'final_substate', 'name', 'initial_substate']
        db.delete_unique('support_actionflow', ['group', 'final_substate_id', 'name', 'initial_substate_id'])
    ...
    models = {
        ...
        'support.action': {
            ...
            'entity_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'actions'", 'to': "orm['contenttypes.ContentType']"}),
        ...
        'support.actionflow': {
            'Meta': {'unique_together': "(('name', 'initial_substate', 'final_substate', 'group'),)", 'object_name': 'ActionFlow'},
            ...
            'group': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'support.substate': {
            'Meta': {'unique_together': "(('name', 'entity'),)", 'object_name': 'SubState'},
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'substates'", 'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
