...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubState.entity'
        db.add_column('support_substate', 'entity', self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, default=None, related_name='substates', to=orm['contenttypes.ContentType']), keep_default=True)

        # Removing unique constraint on 'SubState', fields ['state', 'name']
        db.delete_unique('support_substate', ['state_id', 'name'])

        # Adding unique constraint on 'SubState', fields ['name', 'entity']
        db.create_unique('support_substate', ['name', 'entity_id'])


    def backwards(self, orm):
        
        # Deleting field 'SubState.entity'
        db.delete_column('support_substate', 'entity_id')

        # Adding unique constraint on 'SubState', fields ['state', 'name']
        db.create_unique('support_substate', ['state_id', 'name'])

        # Removing unique constraint on 'SubState', fields ['name', 'entity']
        db.delete_unique('support_substate', ['name', 'entity_id'])
