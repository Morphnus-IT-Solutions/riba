...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActionFlow.group'
        db.add_column('support_actionflow', 'group', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'ActionFlow.group'
        db.delete_column('support_actionflow', 'group')
