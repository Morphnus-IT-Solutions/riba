...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Address.first_name'
        db.add_column('locations_address', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'Address.last_name'
        db.add_column('locations_address', 'last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Changing field 'Address.name'
        db.alter_column('locations_address', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True))

        # Adding field 'AddressBook.first_name'
        db.add_column('locations_addressbook', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'AddressBook.last_name'
        db.add_column('locations_addressbook', 'last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Changing field 'AddressBook.name'
        db.alter_column('locations_addressbook', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'Address.first_name'
        db.delete_column('locations_address', 'first_name')

        # Deleting field 'Address.last_name'
        db.delete_column('locations_address', 'last_name')

        # Changing field 'Address.name'
        db.alter_column('locations_address', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Deleting field 'AddressBook.first_name'
        db.delete_column('locations_addressbook', 'first_name')

        # Deleting field 'AddressBook.last_name'
        db.delete_column('locations_addressbook', 'last_name')

        # Changing field 'AddressBook.name'
        db.alter_column('locations_addressbook', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))
