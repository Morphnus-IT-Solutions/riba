...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('locations_addressbook', (
            ...
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'], null=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ))
        db.send_create_signal('locations', ['AddressBook'])


    def backwards(self, orm):
        
        # Deleting model 'AddressBook'
        db.delete_table('locations_addressbook')
