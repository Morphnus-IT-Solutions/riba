...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('locations_address', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.City'], null=True, blank=True))

        # Changing field 'Address.country'
        db.alter_column('locations_address', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Country'], null=True, blank=True))

        # Changing field 'Address.state'
        db.alter_column('locations_address', 'state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.State'], null=True, blank=True))

        # Changing field 'Address.address'
        db.alter_column('locations_address', 'address', self.gf('django.db.models.fields.TextField')(blank=True))

        # Changing field 'Country.name'
        db.alter_column('locations_country', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True))

        # Changing field 'State.name'
        db.alter_column('locations_state', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True))

        # Changing field 'City.name'
        db.alter_column('locations_city', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Address.city'
        db.alter_column('locations_address', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.City']))

        # Changing field 'Address.country'
        db.alter_column('locations_address', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Country']))

        # Changing field 'Address.state'
        db.alter_column('locations_address', 'state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.State']))

        # Changing field 'Address.address'
        db.alter_column('locations_address', 'address', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Country.name'
        db.alter_column('locations_country', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'State.name'
        db.alter_column('locations_state', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'City.name'
        db.alter_column('locations_city', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))
