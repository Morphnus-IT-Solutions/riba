...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('locations_address', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Address.email'
        db.alter_column('locations_address', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75))
