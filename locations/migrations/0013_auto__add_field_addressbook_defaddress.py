...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AddressBook.defaddress'
        db.add_column('locations_addressbook', 'defaddress', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AddressBook.defaddress'
        db.delete_column('locations_addressbook', 'defaddress')
