...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('locations_address', 'email', self.gf('django.db.models.fields.EmailField')(default=1, max_length=75), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Address.email'
        db.delete_column('locations_address', 'email')
