...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('locations_address', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'Address.phone'
        db.add_column('locations_address', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Address.name'
        db.delete_column('locations_address', 'name')

        # Deleting field 'Address.phone'
        db.delete_column('locations_address', 'phone')
