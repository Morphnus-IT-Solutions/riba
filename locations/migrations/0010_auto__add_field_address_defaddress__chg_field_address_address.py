...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Address.defaddress'
        db.add_column('locations_address', 'defaddress', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Address.defaddress'
        db.delete_column('locations_address', 'defaddress')
