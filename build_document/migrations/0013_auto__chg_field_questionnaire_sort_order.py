...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Questionnaire.sort_order'
        db.alter_column('build_document_questionnaire', 'sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Questionnaire.sort_order'
        db.alter_column('build_document_questionnaire', 'sort_order', self.gf('django.db.models.fields.IntegerField')())
