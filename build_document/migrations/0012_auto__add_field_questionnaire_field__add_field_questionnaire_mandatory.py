...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Questionnaire.field'
        db.add_column('build_document_questionnaire', 'field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['question.Field'], null=True, blank=True), keep_default=True)

        # Adding field 'Questionnaire.mandatory'
        db.add_column('build_document_questionnaire', 'mandatory', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'Questionnaire.field'
        db.delete_column('build_document_questionnaire', 'field_id')

        # Deleting field 'Questionnaire.mandatory'
        db.delete_column('build_document_questionnaire', 'mandatory')
