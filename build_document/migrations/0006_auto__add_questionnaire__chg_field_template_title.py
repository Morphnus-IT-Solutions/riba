...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Template.title'
        db.alter_column('build_document_template', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Adding index on 'Template', fields ['title']
        db.create_index('build_document_template', ['title'])

        # Adding index on 'Template', fields ['offer_price']
        db.create_index('build_document_template', ['offer_price'])

        # Adding index on 'Template', fields ['state']
        db.create_index('build_document_template', ['state'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Template.title'
        db.alter_column('build_document_template', 'title', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Removing index on 'Template', fields ['title']
        db.delete_index('build_document_template', ['title'])

        # Removing index on 'Template', fields ['offer_price']
        db.delete_index('build_document_template', ['offer_price'])

        # Removing index on 'Template', fields ['state']
        db.delete_index('build_document_template', ['state'])
