...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ClientLevelPriceList.pricelist'
        db.delete_column('pricing_clientlevelpricelist', 'pricelist_id')

        # Adding field 'ClientLevelPriceList.price_list'
        db.add_column('pricing_clientlevelpricelist', 'price_list', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pricing.PriceList']), keep_default=False)

        # Deleting field 'DomainLevelPriceList.pricelist'
        db.delete_column('pricing_domainlevelpricelist', 'pricelist_id')

        # Adding field 'DomainLevelPriceList.price_list'
        db.add_column('pricing_domainlevelpricelist', 'price_list', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pricing.PriceList']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ClientLevelPriceList.pricelist'
        db.add_column('pricing_clientlevelpricelist', 'pricelist', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pricing.PriceList']), keep_default=False)

        # Deleting field 'ClientLevelPriceList.price_list'
        db.delete_column('pricing_clientlevelpricelist', 'price_list_id')

        # Adding field 'DomainLevelPriceList.pricelist'
        db.add_column('pricing_domainlevelpricelist', 'pricelist', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pricing.PriceList']), keep_default=False)

        # Deleting field 'DomainLevelPriceList.price_list'
        db.delete_column('pricing_domainlevelpricelist', 'price_list_id')
