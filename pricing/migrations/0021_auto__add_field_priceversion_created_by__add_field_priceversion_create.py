...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PriceVersion.created_by'
        db.add_column('pricing_priceversion', 'created_by', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'PriceVersion.created_on'
        db.add_column('pricing_priceversion', 'created_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'PriceVersion.approved_by'
        db.add_column('pricing_priceversion', 'approved_by', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'PriceVersion.approved_on'
        db.add_column('pricing_priceversion', 'approved_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PriceVersion.created_by'
        db.delete_column('pricing_priceversion', 'created_by')

        # Deleting field 'PriceVersion.created_on'
        db.delete_column('pricing_priceversion', 'created_on')

        # Deleting field 'PriceVersion.approved_by'
        db.delete_column('pricing_priceversion', 'approved_by')

        # Deleting field 'PriceVersion.approved_on'
        db.delete_column('pricing_priceversion', 'approved_on')
