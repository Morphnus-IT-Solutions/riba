...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ClientLevelPriceList'
        db.create_table('pricing_clientlevelpricelist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('price', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pricing.Price'])),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Client'])),
            ('priority', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
        ))
        db.send_create_signal('pricing', ['ClientLevelPriceList'])

        # Adding model 'DomainLevelPriceList'
        db.create_table('pricing_domainlevelpricelist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('price', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pricing.Price'])),
            ('domain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.ClientDomain'])),
            ('priority', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
        ))
        db.send_create_signal('pricing', ['DomainLevelPriceList'])


    def backwards(self, orm):
        
        # Deleting model 'ClientLevelPriceList'
        db.delete_table('pricing_clientlevelpricelist')

        # Deleting model 'DomainLevelPriceList'
        db.delete_table('pricing_domainlevelpricelist')
    ...
    models = {
        ...
        'pricing.clientlevelpricelist': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Client']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pricing.Price']"}),
            'priority': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'})
        },
