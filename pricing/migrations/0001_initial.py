...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pricing_pricelist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('offer_price_label', self.gf('django.db.models.fields.CharField')(default='Offer Price', max_length=100)),
            ('list_price_label', self.gf('django.db.models.fields.CharField')(default='List Price', max_length=100)),
        ))
        db.send_create_signal('pricing', ['PriceList'])

        # Adding model 'Price'
        db.create_table('pricing_price', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('pricing', ['Price'])


    def backwards(self, orm):
        
        # Deleting model 'PriceList'
        db.delete_table('pricing_pricelist')

        # Deleting model 'Price'
        db.delete_table('pricing_price')
