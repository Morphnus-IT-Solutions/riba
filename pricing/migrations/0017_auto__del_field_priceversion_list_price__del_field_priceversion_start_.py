...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PriceVersion.list_price'
        db.delete_column('pricing_priceversion', 'list_price')

        # Deleting field 'PriceVersion.start_time'
        db.delete_column('pricing_priceversion', 'start_time')

        # Deleting field 'PriceVersion.offer_price'
        db.delete_column('pricing_priceversion', 'offer_price')

        # Deleting field 'PriceVersion.end_time'
        db.delete_column('pricing_priceversion', 'end_time')

        # Adding field 'PriceVersion.current_list_price'
        db.add_column('pricing_priceversion', 'current_list_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'PriceVersion.new_list_price'
        db.add_column('pricing_priceversion', 'new_list_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'PriceVersion.current_offer_price'
        db.add_column('pricing_priceversion', 'current_offer_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'PriceVersion.new_offer_price'
        db.add_column('pricing_priceversion', 'new_offer_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'PriceVersion.current_start_time'
        db.add_column('pricing_priceversion', 'current_start_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'PriceVersion.new_start_time'
        db.add_column('pricing_priceversion', 'new_start_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'PriceVersion.current_end_time'
        db.add_column('pricing_priceversion', 'current_end_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'PriceVersion.new_end_time'
        db.add_column('pricing_priceversion', 'new_end_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'PriceVersion.list_price'
        db.add_column('pricing_priceversion', 'list_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'PriceVersion.start_time'
        db.add_column('pricing_priceversion', 'start_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'PriceVersion.offer_price'
        db.add_column('pricing_priceversion', 'offer_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'PriceVersion.end_time'
        db.add_column('pricing_priceversion', 'end_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Deleting field 'PriceVersion.current_list_price'
        db.delete_column('pricing_priceversion', 'current_list_price')

        # Deleting field 'PriceVersion.new_list_price'
        db.delete_column('pricing_priceversion', 'new_list_price')

        # Deleting field 'PriceVersion.current_offer_price'
        db.delete_column('pricing_priceversion', 'current_offer_price')

        # Deleting field 'PriceVersion.new_offer_price'
        db.delete_column('pricing_priceversion', 'new_offer_price')

        # Deleting field 'PriceVersion.current_start_time'
        db.delete_column('pricing_priceversion', 'current_start_time')

        # Deleting field 'PriceVersion.new_start_time'
        db.delete_column('pricing_priceversion', 'new_start_time')

        # Deleting field 'PriceVersion.current_end_time'
        db.delete_column('pricing_priceversion', 'current_end_time')

        # Deleting field 'PriceVersion.new_end_time'
        db.delete_column('pricing_priceversion', 'new_end_time')
    ...
    models = {
        ...
        'pricing.clientlevelpricelist': {
            'Meta': {'object_name': 'ClientLevelPriceList'},
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Client']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price_list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pricing.PriceList']"}),
            'priority': ('django.db.models.fields.IntegerField', [], {})
        },
        'pricing.domainlevelpricelist': {
            'Meta': {'object_name': 'DomainLevelPriceList'},
        ...
        'pricing.price': {
            ...
            'price_list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pricing.PriceList']"}),
            'price_type': ('django.db.models.fields.CharField', [], {'default': "'fixed'", 'max_length': '15', 'db_index': 'True'}),
        ...
        'pricing.priceversion': {
            'Meta': {'object_name': 'PriceVersion'},
            'action': ('django.db.models.fields.CharField', [], {'default': "'update'", 'max_length': '10', 'db_index': 'True'}),
            'current_end_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'current_list_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'current_offer_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'current_start_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_end_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'new_list_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'new_offer_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'new_start_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'price_list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pricing.PriceList']"}),
            'price_type': ('django.db.models.fields.CharField', [], {'default': "'fixed'", 'max_length': '15', 'db_index': 'True'}),
            'pricing_job': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pricing.PricingJob']"}),
            'rate_chart': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.SellerRateChart']"})
        },
        'pricing.pricingjob': {
            'Meta': {'object_name': 'PricingJob'},
            'approved_by': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
