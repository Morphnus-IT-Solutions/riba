...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PriceVersion.action'
        db.add_column('pricing_priceversion', 'action', self.gf('django.db.models.fields.CharField')(default='update', max_length=10, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PriceVersion.action'
        db.delete_column('pricing_priceversion', 'action')
