...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Price', fields ['start_time']
        db.create_index('pricing_price', ['start_time'])

        # Adding index on 'Price', fields ['end_time']
        db.create_index('pricing_price', ['end_time'])


    def backwards(self, orm):
        
        # Removing index on 'Price', fields ['start_time']
        db.delete_index('pricing_price', ['start_time'])

        # Removing index on 'Price', fields ['end_time']
        db.delete_index('pricing_price', ['end_time'])
