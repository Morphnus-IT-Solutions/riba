...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PriceList.exchange_rate'
        db.alter_column('pricing_pricelist', 'exchange_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'PriceList.exchange_rate'
        db.alter_column('pricing_pricelist', 'exchange_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))
