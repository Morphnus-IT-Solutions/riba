...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PriceVersion.pricing_job'
        db.delete_column('pricing_priceversion', 'pricing_job_id')


    def backwards(self, orm):
        
        # Adding field 'PriceVersion.pricing_job'
        db.add_column('pricing_priceversion', 'pricing_job', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pricing.PricingJob']), keep_default=False)
