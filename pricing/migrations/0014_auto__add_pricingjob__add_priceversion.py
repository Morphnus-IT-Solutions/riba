...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PricingJob'
        db.create_table('pricing_pricingjob', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='pending', max_length=20, db_index=True)),
            ...
            ('approved_by', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('approved_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('pricing', ['PricingJob'])

        # Adding model 'PriceVersion'
        db.create_table('pricing_priceversion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rate_chart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SellerRateChart'])),
            ('price_list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pricing.PriceList'])),
            ('list_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
            ('offer_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
            ('price_type', self.gf('django.db.models.fields.CharField')(default='fixed', max_length=15, db_index=True)),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('job_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pricing.PricingJob'])),
        ))
        db.send_create_signal('pricing', ['PriceVersion'])


    def backwards(self, orm):
        
        # Deleting model 'PricingJob'
        db.delete_table('pricing_pricingjob')

        # Deleting model 'PriceVersion'
        db.delete_table('pricing_priceversion')
    ...
    models = {
        ...
        'pricing.priceversion': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pricing.PricingJob']"}),
            'list_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'offer_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'price_list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pricing.PriceList']"}),
            'price_type': ('django.db.models.fields.CharField', [], {'default': "'fixed'", 'max_length': '15', 'db_index': 'True'}),
