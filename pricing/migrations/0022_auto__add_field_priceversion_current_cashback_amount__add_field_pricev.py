...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PriceVersion.current_cashback_amount'
        #db.add_column('pricing_priceversion', 'current_cashback_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'PriceVersion.new_cashback_amount'
        #db.add_column('pricing_priceversion', 'new_cashback_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'PriceList.exchange_rate'
        #db.add_column('pricing_pricelist', 'exchange_rate', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=4, decimal_places=2), keep_default=False)

        # Adding field 'PriceList.currency'
        #db.add_column('pricing_pricelist', 'currency', self.gf('django.db.models.fields.CharField')(default='inr', max_length=3), keep_default=False)

        # Adding field 'Price.cashback_amount'
        #db.add_column('pricing_price', 'cashback_amount', self.gf('django.db.models.fields.DecimalField')(default='0', null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)
        pass


    def backwards(self, orm):
        
        # Deleting field 'PriceVersion.current_cashback_amount'
        db.delete_column('pricing_priceversion', 'current_cashback_amount')

        # Deleting field 'PriceVersion.new_cashback_amount'
        db.delete_column('pricing_priceversion', 'new_cashback_amount')

        # Deleting field 'PriceList.exchange_rate'
        db.delete_column('pricing_pricelist', 'exchange_rate')

        # Deleting field 'PriceList.currency'
        db.delete_column('pricing_pricelist', 'currency')

        # Deleting field 'Price.cashback_amount'
        db.delete_column('pricing_price', 'cashback_amount')
    ...
    models = {
        ...
        'pricing.price': {
            ...
            'cashback_amount': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
        ...
        'pricing.priceversion': {
            ...
            'current_cashback_amount': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_cashback_amount': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
