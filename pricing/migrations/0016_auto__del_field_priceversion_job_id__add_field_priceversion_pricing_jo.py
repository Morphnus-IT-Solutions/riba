...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PriceVersion.job_id'
        db.delete_column('pricing_priceversion', 'job_id_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'PriceVersion.job_id'
        db.add_column('pricing_priceversion', 'job_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pricing.PricingJob']), keep_default=False)
