...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pricing_pricelist', 'exchange_rate', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=3, decimal_places=2), keep_default=False)
    ...
    models = {
        ...
        'pricing.pricelist': {
            ...
            'currency': ('django.db.models.fields.CharField', [], {'default': "'inr'", 'max_length': '3'}),
            'exchange_rate': ('django.db.models.fields.DecimalField', [], {'default': '1', 'max_digits': '3', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
