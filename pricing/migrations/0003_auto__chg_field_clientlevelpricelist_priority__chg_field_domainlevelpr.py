...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClientLevelPriceList.priority'
        db.alter_column('pricing_clientlevelpricelist', 'priority', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'DomainLevelPriceList.priority'
        db.alter_column('pricing_domainlevelpricelist', 'priority', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'ClientLevelPriceList.priority'
        db.alter_column('pricing_clientlevelpricelist', 'priority', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True))

        # Changing field 'DomainLevelPriceList.priority'
        db.alter_column('pricing_domainlevelpricelist', 'priority', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True))
