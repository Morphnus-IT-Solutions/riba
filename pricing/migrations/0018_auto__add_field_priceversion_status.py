...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PriceVersion.status'
        db.add_column('pricing_priceversion', 'status', self.gf('django.db.models.fields.CharField')(default='pending', max_length=20, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PriceVersion.status'
        db.delete_column('pricing_priceversion', 'status')
