...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ClientLevelPriceList.price'
        db.delete_column('pricing_clientlevelpricelist', 'price_id')
        ...
        # Deleting field 'DomainLevelPriceList.price'
        db.delete_column('pricing_domainlevelpricelist', 'price_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ClientLevelPriceList.price'
        db.add_column('pricing_clientlevelpricelist', 'price', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['pricing.Price']), keep_default=False)

        # Deleting field 'ClientLevelPriceList.pricelist'
        db.delete_column('pricing_clientlevelpricelist', 'pricelist_id')

        # Adding field 'DomainLevelPriceList.price'
        db.add_column('pricing_domainlevelpricelist', 'price', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['pricing.Price']), keep_default=False)
