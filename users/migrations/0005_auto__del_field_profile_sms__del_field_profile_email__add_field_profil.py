...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.sms'
        db.delete_column('users_profile', 'sms')

        # Deleting field 'Profile.email'
        db.delete_column('users_profile', 'email')

        # Adding field 'Profile.dob'
        db.add_column('users_profile', 'dob', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding field 'Profile.marketing_alerts'
        db.add_column('users_profile', 'marketing_alerts', self.gf('django.db.models.fields.CharField')(default='neutral', max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Profile.sms'
        db.add_column('users_profile', 'sms', self.gf('django.db.models.fields.CharField')(default='neutral', max_length=25), keep_default=False)

        # Adding field 'Profile.email'
        db.add_column('users_profile', 'email', self.gf('django.db.models.fields.CharField')(default='neutral', max_length=25), keep_default=False)

        # Deleting field 'Profile.dob'
        db.delete_column('users_profile', 'dob')

        # Deleting field 'Profile.marketing_alerts'
        db.delete_column('users_profile', 'marketing_alerts')
