...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailySubscription.last_modified_date'
        db.add_column('users_dailysubscription', 'last_modified_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 30, 19, 19, 29, 686402), auto_now=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DailySubscription.last_modified_date'
        db.delete_column('users_dailysubscription', 'last_modified_date')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 30, 19, 19, 29, 686402)', 'auto_now': 'True', 'blank': 'True'}),
