...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DailySubscription'
        db.create_table('users_dailysubscription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('newsletter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.NewsLetter'])),
            ('email_alert', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('sms_alert', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('users', ['DailySubscription'])

        # Adding model 'NewsLetter'
        db.create_table('users_newsletter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('newsletter', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('users', ['NewsLetter'])

        # Adding M2M table for field client on 'NewsLetter'
        db.create_table('users_newsletter_client', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('newsletter', models.ForeignKey(orm['users.newsletter'], null=False)),
            ('client', models.ForeignKey(orm['accounts.client'], null=False))
        ))
        db.create_unique('users_newsletter_client', ['newsletter_id', 'client_id'])


    def backwards(self, orm):
        
        # Deleting model 'DailySubscription'
        db.delete_table('users_dailysubscription')

        # Deleting model 'NewsLetter'
        db.delete_table('users_newsletter')

        # Removing M2M table for field client on 'NewsLetter'
        db.delete_table('users_newsletter_client')
