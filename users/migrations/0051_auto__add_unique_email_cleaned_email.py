...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Email', fields ['cleaned_email']
        db.create_unique('users_email', ['cleaned_email'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Email', fields ['cleaned_email']
        db.delete_unique('users_email', ['cleaned_email'])
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 2, 13, 59, 59, 481665)', 'auto_now': 'True', 'blank': 'True'}),
