...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Email.cleaned_email'
        db.add_column('users_email', 'cleaned_email', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'Email.cleaned_email'
        db.delete_column('users_email', 'cleaned_email')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 31, 15, 50, 22, 300838)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'users.email': {
            ...
            'cleaned_email': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
