...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.webpage'
        db.add_column('users_profile', 'webpage', self.gf('django.db.models.fields.CharField')(default='www.google.com', max_length=200), keep_default=False)

        # Adding field 'Profile.facebook'
        db.add_column('users_profile', 'facebook', self.gf('django.db.models.fields.CharField')(default='www.facebook.com', max_length=200), keep_default=False)

        # Adding field 'Profile.twitter'
        db.add_column('users_profile', 'twitter', self.gf('django.db.models.fields.CharField')(default='www.twitter.com', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.webpage'
        db.delete_column('users_profile', 'webpage')

        # Deleting field 'Profile.facebook'
        db.delete_column('users_profile', 'facebook')

        # Deleting field 'Profile.twitter'
        db.delete_column('users_profile', 'twitter')
