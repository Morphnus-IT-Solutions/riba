...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.primary_phone'
        db.alter_column('users_profile', 'primary_phone', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True))

        # Removing unique constraint on 'Profile', fields ['primary_phone']
        db.delete_unique('users_profile', ['primary_phone'])


    def backwards(self, orm):
        
        # Changing field 'Profile.primary_phone'
        db.alter_column('users_profile', 'primary_phone', self.gf('django.db.models.fields.CharField')(max_length=15, unique=True))

        # Adding unique constraint on 'Profile', fields ['primary_phone']
        db.create_unique('users_profile', ['primary_phone'])
