...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.atg_username'
        db.add_column('users_profile', 'atg_username', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.atg_username'
        db.delete_column('users_profile', 'atg_username')
