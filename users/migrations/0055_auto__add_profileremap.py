...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProfileRemap'
        db.create_table('users_profileremap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Email'], null=True, blank=True)),
            ('phone', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Phone'], null=True, blank=True)),
            ('old_profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='oldprofiles', to=orm['users.Profile'])),
            ('new_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'])),
        ))
        db.send_create_signal('users', ['ProfileRemap'])


    def backwards(self, orm):
        
        # Deleting model 'ProfileRemap'
        db.delete_table('users_profileremap')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 19, 16, 38, 41, 908040)', 'auto_now': 'True', 'blank': 'True'}),
