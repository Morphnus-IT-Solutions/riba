...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_profile', 'full_name', self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True), keep_default=False)

        # Adding field 'Profile.primary_email'
        db.add_column('users_profile', 'primary_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True), keep_default=False)

        # Adding field 'Profile.secondary_email'
        db.add_column('users_profile', 'secondary_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True), keep_default=False)

        # Adding field 'Profile.gender'
        db.add_column('users_profile', 'gender', self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True), keep_default=False)

        # Adding field 'Profile.salutation'
        db.add_column('users_profile', 'salutation', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('users_profile', 'full_name')

        # Deleting field 'Profile.primary_email'
        db.delete_column('users_profile', 'primary_email')

        # Deleting field 'Profile.secondary_email'
        db.delete_column('users_profile', 'secondary_email')

        # Deleting field 'Profile.gender'
        db.delete_column('users_profile', 'gender')

        # Deleting field 'Profile.salutation'
        db.delete_column('users_profile', 'salutation')
