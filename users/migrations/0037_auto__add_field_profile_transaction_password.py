...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.transaction_password'
        db.add_column('users_profile', 'transaction_password', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.transaction_password'
        db.delete_column('users_profile', 'transaction_password')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 20, 19, 24, 33, 742568)', 'auto_now': 'True', 'blank': 'True'}),
