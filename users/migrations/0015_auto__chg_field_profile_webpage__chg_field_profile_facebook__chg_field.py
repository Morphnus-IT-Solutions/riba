...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.webpage'
        db.alter_column('users_profile', 'webpage', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True))

        # Changing field 'Profile.facebook'
        db.alter_column('users_profile', 'facebook', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True))

        # Changing field 'Profile.twitter'
        db.alter_column('users_profile', 'twitter', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Profile.webpage'
        db.alter_column('users_profile', 'webpage', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Profile.facebook'
        db.alter_column('users_profile', 'facebook', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Profile.twitter'
        db.alter_column('users_profile', 'twitter', self.gf('django.db.models.fields.CharField')(max_length=200))
