...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacebookInfo.linking_done'
        db.add_column('users_facebookinfo', 'linking_done', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacebookInfo.linking_done'
        db.delete_column('users_facebookinfo', 'linking_done')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 17, 18, 28, 3, 221719)', 'auto_now': 'True', 'blank': 'True'}),
