...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Email.is_verified'
        db.add_column('users_email', 'is_verified', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=True)

        # Adding field 'Email.verified_on'
        db.add_column('users_email', 'verified_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Email.verification_code'
        db.add_column('users_email', 'verification_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Email.is_verified'
        db.delete_column('users_email', 'is_verified')

        # Deleting field 'Email.verified_on'
        db.delete_column('users_email', 'verified_on')

        # Deleting field 'Email.verification_code'
        db.delete_column('users_email', 'verification_code')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 28, 20, 2, 8, 530025)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'users.profileremap': {
            'Meta': {'object_name': 'ProfileRemap'},
            'email': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Email']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Profile']"}),
            'old_profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'oldprofiles'", 'to': "orm['users.Profile']"}),
        ...
        'users.usertab': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tabs'", 'to': "orm['users.Profile']"})
        },
        'users.usertag': {
