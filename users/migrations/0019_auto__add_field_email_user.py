...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_email', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['users.Profile']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Email.user'
        db.delete_column('users_email', 'user_id')
