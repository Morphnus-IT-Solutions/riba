...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacebookAppScore.facebook_name'
        db.add_column('users_facebookappscore', 'facebook_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacebookAppScore.facebook_name'
        db.delete_column('users_facebookappscore', 'facebook_name')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 24, 17, 27, 17, 490041)', 'auto_now': 'True', 'blank': 'True'}),
