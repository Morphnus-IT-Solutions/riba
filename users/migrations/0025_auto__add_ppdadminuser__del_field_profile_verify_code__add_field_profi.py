...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.profession'
        db.add_column('users_profile', 'profession', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.user_photo'
        db.add_column('users_profile', 'user_photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        

        # Deleting field 'Profile.profession'
        db.delete_column('users_profile', 'profession')

        # Deleting field 'Profile.user_photo'
        db.delete_column('users_profile', 'user_photo')
