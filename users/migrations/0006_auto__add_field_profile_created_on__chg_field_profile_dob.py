...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_profile', 'created_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 7, 1, 20, 58, 17, 427139)), keep_default=False)

        # Changing field 'Profile.dob'
        db.alter_column('users_profile', 'dob', self.gf('django.db.models.fields.DateField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'Profile.created_on'
        db.delete_column('users_profile', 'created_on')

        # Changing field 'Profile.dob'
        db.alter_column('users_profile', 'dob', self.gf('django.db.models.fields.DateField')(null=True))
