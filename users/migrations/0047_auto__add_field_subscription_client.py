...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.client'
        db.add_column('users_subscription', 'client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Client'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subscription.client'
        db.delete_column('users_subscription', 'client_id')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 10, 10, 3, 10, 733759)', 'auto_now': 'True', 'blank': 'True'}),
