...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.verification_code'
        db.add_column('users_profile', 'verification_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
       
        # Deleting field 'Profile.verification_code'
        db.delete_column('users_profile', 'verification_code')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 9, 12, 36, 23, 306574)', 'auto_now': 'True', 'blank': 'True'}),
