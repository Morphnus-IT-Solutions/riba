...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailySubscription.sms_alert_on'
        db.alter_column('users_dailysubscription', 'sms_alert_on_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Phone'], null=True, blank=True))

        # Changing field 'DailySubscription.email_alert_on'
        db.alter_column('users_dailysubscription', 'email_alert_on_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Email'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'DailySubscription.sms_alert_on'
        db.alter_column('users_dailysubscription', 'sms_alert_on_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Phone'], blank=True))

        # Changing field 'DailySubscription.email_alert_on'
        db.alter_column('users_dailysubscription', 'email_alert_on_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Email'], blank=True))
