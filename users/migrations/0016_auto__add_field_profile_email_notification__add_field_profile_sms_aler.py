...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.email_notification'
        db.add_column('users_profile', 'email_notification', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Profile.sms_alert'
        db.add_column('users_profile', 'sms_alert', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.email_notification'
        db.delete_column('users_profile', 'email_notification')

        # Deleting field 'Profile.sms_alert'
        db.delete_column('users_profile', 'sms_alert')
