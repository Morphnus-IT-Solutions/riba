...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailySubscription.verified_on'
        #db.add_column('users_dailysubscription', 'verified_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
        # Adding field 'DailySubscription.verification_code'
        #db.add_column('users_dailysubscription', 'verification_code', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('users_subscription', (
            ('phone', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, null=True, blank=True)),
            ('reason', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True)),
            ('subscription_type', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True)),
            ('unsubscribed_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('tag', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=255, null=True, blank=True)),
        ...
        # Deleting field 'DailySubscription.verified_on'
        db.delete_column('users_dailysubscription', 'verified_on')

        # Deleting field 'DailySubscription.verification_code'
        db.delete_column('users_dailysubscription', 'verification_code')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 22, 19, 50, 9, 421938)', 'auto_now': 'True', 'blank': 'True'}),
