...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailySubscription.source'
        db.add_column('users_dailysubscription', 'source', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True), keep_default=False)

        # Adding field 'DailySubscription.is_email_alert'
        #db.add_column('users_dailysubscription', 'is_email_alert', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'DailySubscription.is_sms_alert'
        #db.add_column('users_dailysubscription', 'is_sms_alert', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'PpdAdminUser.canvas_page'
        # Deleting field 'DailySubscription.source'
        db.delete_column('users_dailysubscription', 'source')

        # Deleting field 'DailySubscription.is_email_alert'
        #db.delete_column('users_dailysubscription', 'is_email_alert')

        # Deleting field 'DailySubscription.is_sms_alert'
        #db.delete_column('users_dailysubscription', 'is_sms_alert')
