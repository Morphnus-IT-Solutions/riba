...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Phone.is_verified'
        db.add_column('users_phone', 'is_verified', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=True)

        # Adding field 'Phone.verified_on'
        db.add_column('users_phone', 'verified_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True, default=None), keep_default=True)

        # Adding field 'Phone.verification_code'
        db.add_column('users_phone', 'verification_code', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=50, null=True, blank=True, default=None), keep_default=True)

        # Adding field 'Profile.cod_status'
        db.add_column('users_profile', 'cod_status', self.gf('django.db.models.fields.CharField')(default='neutral', max_length=25), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'Phone.is_verified'
        db.delete_column('users_phone', 'is_verified')

        # Deleting field 'Phone.verified_on'
        db.delete_column('users_phone', 'verified_on')

        # Deleting field 'Phone.verification_code'
        db.delete_column('users_phone', 'verification_code')

        # Deleting field 'Profile.cod_status'
        db.delete_column('users_profile', 'cod_status')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 31, 19, 5, 46, 406497)', 'auto_now': 'True', 'blank': 'True'}),
