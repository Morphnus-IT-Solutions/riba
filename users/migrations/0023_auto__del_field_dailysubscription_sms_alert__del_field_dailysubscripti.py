...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DailySubscription.sms_alert'
        db.delete_column('users_dailysubscription', 'sms_alert')

        # Deleting field 'DailySubscription.email_alert'
        db.delete_column('users_dailysubscription', 'email_alert')

        # Deleting field 'DailySubscription.user'
        db.delete_column('users_dailysubscription', 'user_id')

        # Adding field 'DailySubscription.email_alert_on'
        db.add_column('users_dailysubscription', 'email_alert_on', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['users.Email'], blank=True), keep_default=False)

        # Adding field 'DailySubscription.sms_alert_on'
        db.add_column('users_dailysubscription', 'sms_alert_on', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['users.Phone'], blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'DailySubscription.sms_alert'
        db.add_column('users_dailysubscription', 'sms_alert', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'DailySubscription.email_alert'
        db.add_column('users_dailysubscription', 'email_alert', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'DailySubscription.user'
        db.add_column('users_dailysubscription', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']), keep_default=False)

        # Deleting field 'DailySubscription.email_alert_on'
        db.delete_column('users_dailysubscription', 'email_alert_on_id')

        # Deleting field 'DailySubscription.sms_alert_on'
        db.delete_column('users_dailysubscription', 'sms_alert_on_id')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'email_alert_on': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Email']", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'newsletter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.NewsLetter']"}),
            'sms_alert_on': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Phone']", 'blank': 'True'})
        },
        'users.email': {
