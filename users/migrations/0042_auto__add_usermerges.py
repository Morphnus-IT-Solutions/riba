...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserMerges'
        db.create_table('users_usermerges', (
            ...
            ('merged_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['users.Profile'])),
        ))
        db.send_create_signal('users', ['UserMerges'])


    def backwards(self, orm):
        
        # Deleting model 'UserMerges'
        db.delete_table('users_usermerges')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 18, 0, 26, 3, 298039)', 'auto_now': 'True', 'blank': 'True'}),
