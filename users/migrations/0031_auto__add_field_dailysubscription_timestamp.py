...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailySubscription.timestamp'
        db.add_column('users_dailysubscription', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 5, 4, 10, 55, 12, 80769), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DailySubscription.timestamp'
        db.delete_column('users_dailysubscription', 'timestamp')
