...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.created_on'
        db.alter_column('users_profile', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Profile.created_on'
        db.alter_column('users_profile', 'created_on', self.gf('django.db.models.fields.DateTimeField')())
