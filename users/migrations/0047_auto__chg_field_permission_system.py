...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Permission.system'
        db.alter_column('users_permission', 'system', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'Permission.system'
        db.alter_column('users_permission', 'system', self.gf('django.db.models.fields.CharField')(max_length=300))
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 22, 18, 31, 11, 270747)', 'auto_now': 'True', 'blank': 'True'}),
