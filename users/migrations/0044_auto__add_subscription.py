...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_subscription', (
            ...
            ('contact_type', self.gf('django.db.models.fields.CharField')(default='email', max_length=10)),
            ('contact', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('subscribed_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ...
            ('subscription_alert', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
        ))
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 22, 19, 51, 46, 27367)', 'auto_now': 'True', 'blank': 'True'}),
