...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('users', ['Phone'])

        # Adding model 'Email'
        db.create_table('users_email', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
        db.send_create_signal('users', ['Email'])


    def backwards(self, orm):
        
        # Deleting model 'Phone'
        db.delete_table('users_phone')

        # Deleting model 'Email'
        db.delete_table('users_email')
