...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FacebookAppScore'
        db.create_table('users_facebookappscore', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('facebook_user', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('users', ['FacebookAppScore'])


    def backwards(self, orm):
        
        # Deleting model 'FacebookAppScore'
        db.delete_table('users_facebookappscore')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 23, 15, 24, 30, 957306)', 'auto_now': 'True', 'blank': 'True'}),
