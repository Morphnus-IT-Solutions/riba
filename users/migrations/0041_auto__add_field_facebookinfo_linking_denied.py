...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacebookInfo.linking_denied'
        db.add_column('users_facebookinfo', 'linking_denied', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacebookInfo.linking_denied'
        db.delete_column('users_facebookinfo', 'linking_denied')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 17, 21, 5, 1, 428707)', 'auto_now': 'True', 'blank': 'True'}),
