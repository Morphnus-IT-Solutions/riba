...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewsLetter.affiliate_logo'
        db.add_column('users_newsletter', 'affiliate_logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'NewsLetter.affiliate_text'
        db.add_column('users_newsletter', 'affiliate_text', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NewsLetter.affiliate_logo'
        db.delete_column('users_newsletter', 'affiliate_logo')

        # Deleting field 'NewsLetter.affiliate_text'
        db.delete_column('users_newsletter', 'affiliate_text')
