...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.secondary_email'
        db.alter_column('users_profile', 'secondary_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Profile.secondary_email'
        db.alter_column('users_profile', 'secondary_email', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True))
