...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FacebookInfo'
        db.create_table('users_facebookinfo', (
        ...
        db.send_create_signal('users', ['FacebookInfo'])


    def backwards(self, orm):
        
        # Deleting model 'FacebookInfo'
        db.delete_table('users_facebookinfo')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 17, 17, 47, 55, 69339)', 'auto_now': 'True', 'blank': 'True'}),
