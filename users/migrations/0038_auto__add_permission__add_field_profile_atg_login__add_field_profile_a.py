...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.atg_login'
        db.add_column('users_profile', 'atg_login', self.gf('django.db.models.fields.CharField')(max_length=40, unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.atg_password'
        db.add_column('users_profile', 'atg_password', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Profile.atg_login'
        db.delete_column('users_profile', 'atg_login')

        # Deleting field 'Profile.atg_password'
        db.delete_column('users_profile', 'atg_password')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 5, 12, 42, 10, 234028)', 'auto_now': 'True', 'blank': 'True'}),
