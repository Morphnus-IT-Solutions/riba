...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Permission', fields ['user', 'object_id', 'system']
        db.create_unique('users_permission', ['user_id', 'object_id', 'system'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Permission', fields ['user', 'object_id', 'system']
        db.delete_unique('users_permission', ['user_id', 'object_id', 'system'])
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 18, 20, 10, 46, 16560)', 'auto_now': 'True', 'blank': 'True'}),
