...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ShoppingPage'
        db.create_table('users_shoppingpage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('redirect_page', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('newsletter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.NewsLetter'])),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('users', ['ShoppingPage'])

        # Adding field 'NewsLetter.affiliate_name'
        db.add_column('users_newsletter', 'affiliate_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ShoppingPage'
        db.delete_table('users_shoppingpage')

        # Deleting field 'NewsLetter.affiliate_name'
        db.delete_column('users_newsletter', 'affiliate_name')
