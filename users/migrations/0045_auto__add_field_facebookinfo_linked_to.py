...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacebookInfo.linked_to'
        db.add_column('users_facebookinfo', 'linked_to', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacebookInfo.linked_to'
        db.delete_column('users_facebookinfo', 'linked_to')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 23, 11, 22, 22, 5249)', 'auto_now': 'True', 'blank': 'True'}),
