...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.salt'
        db.add_column('users_profile', 'salt', self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True), keep_default=False)

        # Adding field 'Profile.passcode'
        db.add_column('users_profile', 'passcode', self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.salt'
        db.delete_column('users_profile', 'salt')

        # Deleting field 'Profile.passcode'
        db.delete_column('users_profile', 'passcode')
