...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_profile', (
            ...
            ('primary_phone', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('secondary_phone', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True)),
            ('buyer_or_seller', self.gf('django.db.models.fields.CharField')(default='Buyer', max_length=100)),
            ('acquired_through_account', self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_customers', blank=True, null=True, to=orm['accounts.Account'])),
        ))
        db.send_create_signal('users', ['Profile'])

        # Adding M2M table for field customer_of_accounts on 'Profile'
        db.create_table('users_profile_customer_of_accounts', (
        ...
        db.create_unique('users_profile_customer_of_accounts', ['profile_id', 'account_id'])

        # Adding M2M table for field managed_accounts on 'Profile'
        db.create_table('users_profile_managed_accounts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm['users.profile'], null=False)),
            ('account', models.ForeignKey(orm['accounts.account'], null=False))
        ))
        db.create_unique('users_profile_managed_accounts', ['profile_id', 'account_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field customer_of_accounts on 'Profile'
        db.delete_table('users_profile_customer_of_accounts')

        # Removing M2M table for field managed_accounts on 'Profile'
        db.delete_table('users_profile_managed_accounts')
