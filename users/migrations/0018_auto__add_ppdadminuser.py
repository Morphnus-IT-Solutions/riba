...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PpdAdminUser'
        db.create_table('users_ppdadminuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'])),
            ('canvas_page', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40)),
        ))
        db.send_create_signal('users', ['PpdAdminUser'])

        # Adding M2M table for field accounts on 'PpdAdminUser'
        db.create_table('users_ppdadminuser_accounts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ppdadminuser', models.ForeignKey(orm['users.ppdadminuser'], null=False)),
            ('account', models.ForeignKey(orm['accounts.account'], null=False))
        ))
        db.create_unique('users_ppdadminuser_accounts', ['ppdadminuser_id', 'account_id'])


    def backwards(self, orm):
        
        # Deleting model 'PpdAdminUser'
        db.delete_table('users_ppdadminuser')

        # Removing M2M table for field accounts on 'PpdAdminUser'
        db.delete_table('users_ppdadminuser_accounts')
    ...
    models = {
        ...
        'users.ppdadminuser': {
            ...
            'canvas_page': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
