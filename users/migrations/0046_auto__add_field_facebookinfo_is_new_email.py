...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacebookInfo.is_new_email'
        db.add_column('users_facebookinfo', 'is_new_email', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacebookInfo.is_new_email'
        db.delete_column('users_facebookinfo', 'is_new_email')
    ...
    models = {
        ...
        'users.dailysubscription': {
            ...
            'last_modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 24, 0, 37, 33, 641467)', 'auto_now': 'True', 'blank': 'True'}),
