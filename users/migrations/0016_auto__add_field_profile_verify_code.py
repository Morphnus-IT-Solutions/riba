...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.verify_code'
        db.add_column('users_profile', 'verify_code', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.verify_code'
        db.delete_column('users_profile', 'verify_code')
