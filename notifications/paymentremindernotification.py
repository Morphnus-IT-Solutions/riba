...
class PaymentReminderNotification(Notification):
    source = 'web'
    ...
    def fill_attributes(self,order,order_item,product,body_st,subject_st,
        ...
        #body_st['payment_mode'] = order.payment_mode
        payment_mode = PaymentMode.objects.get(code=order.payment_mode)
        payment_option = PaymentOption.objects.get(payment_mode=payment_mode,payment_mode__client=order.client)
