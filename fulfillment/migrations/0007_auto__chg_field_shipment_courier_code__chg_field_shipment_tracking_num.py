...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Shipment.courier_code'
        db.alter_column('fulfillment_shipment', 'courier_code', self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True))

        # Changing field 'Shipment.tracking_number'
        db.alter_column('fulfillment_shipment', 'tracking_number', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))

        # Changing field 'Shipment.invoice_number'
        db.alter_column('fulfillment_shipment', 'invoice_number', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))

        # Changing field 'Shipment.delivery_number'
        db.alter_column('fulfillment_shipment', 'delivery_number', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))

        # Changing field 'ShipmentItem.order_item'
        db.alter_column('fulfillment_shipmentitem', 'order_item_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['orders.OrderItem']))

        # Adding unique constraint on 'ShipmentItem', fields ['order_item']
        db.create_unique('fulfillment_shipmentitem', ['order_item_id'])


    def backwards(self, orm):
        
        # Changing field 'Shipment.courier_code'
        db.alter_column('fulfillment_shipment', 'courier_code', self.gf('django.db.models.fields.CharField')(max_length=45))

        # Changing field 'Shipment.tracking_number'
        db.alter_column('fulfillment_shipment', 'tracking_number', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Shipment.invoice_number'
        db.alter_column('fulfillment_shipment', 'invoice_number', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Shipment.delivery_number'
        db.alter_column('fulfillment_shipment', 'delivery_number', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'ShipmentItem.order_item'
        db.alter_column('fulfillment_shipmentitem', 'order_item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.OrderItem']))

        # Removing unique constraint on 'ShipmentItem', fields ['order_item']
        db.delete_unique('fulfillment_shipmentitem', ['order_item_id'])
    ...
    models = {
        ...
        'fulfillment.shipment': {
            ...
            'courier_code': ('django.db.models.fields.CharField', [], {'max_length': '45', 'null': 'True', 'blank': 'True'}),
            ...
            'delivery_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'fulfillment.shipmentitem': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_item': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'shipment_item'", 'unique': 'True', 'to': "orm['orders.OrderItem']"}),
