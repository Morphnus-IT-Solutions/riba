...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Shipment.courier_code'
        #db.delete_column('fulfillment_shipment', 'courier_code')

        # Adding field 'Shipment.lsp'
        db.add_column('fulfillment_shipment', 'lsp', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='shipments', null=True, to=orm['fulfillment.Lsp'], default=None), keep_default=True)

        # Adding field 'Shipment.expected_delivery_date'
        db.add_column('fulfillment_shipment', 'expected_delivery_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True, default=None), keep_default=True)


    def backwards(self, orm):
        
        # Adding field 'Shipment.courier_code'
        #db.add_column('fulfillment_shipment', 'courier_code', self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True), keep_default=False)

        # Deleting field 'Shipment.lsp'
        db.delete_column('fulfillment_shipment', 'lsp_id')

        # Deleting field 'Shipment.expected_delivery_date'
        db.delete_column('fulfillment_shipment', 'expected_delivery_date')
