...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Shipment.created_on'
        db.alter_column('fulfillment_shipment', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Shipment.created_on'
        db.alter_column('fulfillment_shipment', 'created_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))
