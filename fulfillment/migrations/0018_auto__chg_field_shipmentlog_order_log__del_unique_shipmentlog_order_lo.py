...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShipmentLog.order_log'
        db.alter_column('fulfillment_shipmentlog', 'order_log_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.OrderLog']))

        # Removing unique constraint on 'ShipmentLog', fields ['order_log']
        #db.delete_unique('fulfillment_shipmentlog', ['order_log_id'])
        

    def backwards(self, orm):
        
        # Changing field 'ShipmentLog.order_log'
        db.alter_column('fulfillment_shipmentlog', 'order_log_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['orders.OrderLog']))

        # Adding unique constraint on 'ShipmentLog', fields ['order_log']
        db.create_unique('fulfillment_shipmentlog', ['order_log_id'])
    ...
    models = {
        ...
        'fulfillment.shipmentlog': {
            ...
            'order_log': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shipment_log'", 'to': "orm['orders.OrderLog']"}),
