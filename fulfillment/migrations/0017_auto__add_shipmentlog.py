...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ShipmentLog'
        db.create_table('fulfillment_shipmentlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shipment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shipment_log', to=orm['fulfillment.Shipment'])),
            ('order_log', self.gf('django.db.models.fields.related.OneToOneField')(related_name='shipment_log', unique=True, to=orm['orders.OrderLog'])),
            ...
            ('delivery_number', self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True)),
            ('invoice_number', self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True)),
            ('tracking_number', self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True)),
            ('lsp', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, blank=True, to=orm['fulfillment.Lsp'])),
            ('dc', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, blank=True, to=orm['fulfillment.Dc'])),
            ('notes', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('fulfillment', ['ShipmentLog'])


    def backwards(self, orm):
        
        # Deleting model 'ShipmentLog'
        db.delete_table('fulfillment_shipmentlog')
    ...
    models = {
        ...
        'fulfillment.shipmentlog': {
            'Meta': {'object_name': 'ShipmentLog'},
            ...
            'delivery_number': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_number': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'order_log': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'shipment_log'", 'unique': 'True', 'to': "orm['orders.OrderLog']"}),
            'shipment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shipment_log'", 'to': "orm['fulfillment.Shipment']"}),
            'status': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'tracking_number': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
