...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Shipment', fields ['tracking_number']
        db.create_index('fulfillment_shipment', ['tracking_number'])

        # Adding index on 'Shipment', fields ['invoice_number']
        db.create_index('fulfillment_shipment', ['invoice_number'])

        # Adding index on 'Shipment', fields ['delivery_number']
        db.create_index('fulfillment_shipment', ['delivery_number'])


    def backwards(self, orm):
        
        # Removing index on 'Shipment', fields ['tracking_number']
        db.delete_index('fulfillment_shipment', ['tracking_number'])

        # Removing index on 'Shipment', fields ['invoice_number']
        db.delete_index('fulfillment_shipment', ['invoice_number'])

        # Removing index on 'Shipment', fields ['delivery_number']
        db.delete_index('fulfillment_shipment', ['delivery_number'])
