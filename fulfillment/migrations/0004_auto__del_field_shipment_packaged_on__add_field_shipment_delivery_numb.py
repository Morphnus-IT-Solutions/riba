...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Shipment.packaged_on'
        db.delete_column('fulfillment_shipment', 'packaged_on')

        # Adding field 'Shipment.delivery_number'
        db.add_column('fulfillment_shipment', 'delivery_number', self.gf('django.db.models.fields.CharField')(default=None, max_length=100), keep_default=False)

        # Adding field 'Shipment.invoice_number'
        db.add_column('fulfillment_shipment', 'invoice_number', self.gf('django.db.models.fields.CharField')(default=None, max_length=100), keep_default=False)

        # Adding field 'Shipment.amount'
        db.add_column('fulfillment_shipment', 'amount', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=12, decimal_places=2), keep_default=False)

        # Adding field 'Shipment.invoiced_on'
        db.add_column('fulfillment_shipment', 'invoiced_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Shipment.packaged_on'
        db.add_column('fulfillment_shipment', 'packaged_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Shipment.delivery_number'
        db.delete_column('fulfillment_shipment', 'delivery_number')

        # Deleting field 'Shipment.invoice_number'
        db.delete_column('fulfillment_shipment', 'invoice_number')

        # Deleting field 'Shipment.amount'
        db.delete_column('fulfillment_shipment', 'amount')

        # Deleting field 'Shipment.invoiced_on'
        db.delete_column('fulfillment_shipment', 'invoiced_on')
    ...
    models = {
        ...
        'fulfillment.shipment': {
            ...
            'courier_code': ('django.db.models.fields.CharField', [], {'max_length': '45'}),
            ...
            'delivery_number': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_number': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'invoiced_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'last_modified_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'tracking_number': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'fulfillment.shipmentitem': {
            'Meta': {'object_name': 'ShipmentItem'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shipment_item'", 'to': "orm['orders.OrderItem']"}),
