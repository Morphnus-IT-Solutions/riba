...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        return        
        # Adding index on 'Dc', fields ['code']
        #not creating an index as this table will have atmost 10's of entries - prady
        db.create_index('fulfillment_dc', ['code'])


    def backwards(self, orm):
        return
        # Removing index on 'Dc', fields ['code']
        db.delete_index('fulfillment_dc', ['code'])
