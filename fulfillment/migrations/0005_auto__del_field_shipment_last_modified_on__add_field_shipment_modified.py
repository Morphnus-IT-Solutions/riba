...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Shipment.last_modified_on'
        db.delete_column('fulfillment_shipment', 'last_modified_on')

        # Adding field 'Shipment.modified_on'
        db.add_column('fulfillment_shipment', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)

        # Adding field 'Shipment.status'
        db.add_column('fulfillment_shipment', 'status', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)

        # Adding field 'ShipmentItem.status'
        db.add_column('fulfillment_shipmentitem', 'status', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Shipment.last_modified_on'
        db.add_column('fulfillment_shipment', 'last_modified_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Shipment.modified_on'
        db.delete_column('fulfillment_shipment', 'modified_on')

        # Deleting field 'Shipment.status'
        db.delete_column('fulfillment_shipment', 'status')

        # Deleting field 'ShipmentItem.status'
        db.delete_column('fulfillment_shipmentitem', 'status')
