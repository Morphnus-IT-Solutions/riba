...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fulfillment_shipmentstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shipment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='statuslog', to=orm['fulfillment.Shipment'])),
            ('status', self.gf('django.db.models.fields.TextField')()),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('fulfillment', ['ShipmentStatus'])


    def backwards(self, orm):
        
        # Deleting model 'ShipmentStatus'
        db.delete_table('fulfillment_shipmentstatus')
