...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Shipment', fields ['status']
        db.create_index('fulfillment_shipment', ['status'])


    def backwards(self, orm):
        
        # Removing index on 'Shipment', fields ['status']
        db.delete_index('fulfillment_shipment', ['status'])
    ...
    models = {
        ...
        'fulfillment.shipment': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '25', 'null': 'True', 'blank': 'True'}),
