...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShipmentItem.sap_order_item'
        db.add_column('fulfillment_shipmentitem', 'sap_order_item', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='shipment_items', null=True, blank=True, to=orm['orders.SAPOrderItem']), keep_default=True)

        # Removing unique constraint on 'ShipmentItem', fields ['order_item', 'part_id', 'shipment']
        db.delete_unique('fulfillment_shipmentitem', ['order_item_id', 'part_id', 'shipment_id'])

        # Adding unique constraint on 'ShipmentItem', fields ['sap_order_item', 'part_id', 'shipment']
        db.create_unique('fulfillment_shipmentitem', ['sap_order_item_id', 'part_id', 'shipment_id'])


    def backwards(self, orm):
        
        # Deleting field 'ShipmentItem.sap_order_item'
        db.delete_column('fulfillment_shipmentitem', 'sap_order_item_id')

        # Adding unique constraint on 'ShipmentItem', fields ['order_item', 'part_id', 'shipment']
        db.create_unique('fulfillment_shipmentitem', ['order_item_id', 'part_id', 'shipment_id'])

        # Removing unique constraint on 'ShipmentItem', fields ['sap_order_item', 'part_id', 'shipment']
        db.delete_unique('fulfillment_shipmentitem', ['sap_order_item_id', 'part_id', 'shipment_id'])
    ...
    models = {
        ...
        'fulfillment.shipment': {
            'Meta': {'unique_together': "(('order', 'delivery_number'),)", 'object_name': 'Shipment'},
        ...
        'fulfillment.shipmentitem': {
            'Meta': {'unique_together': "(('shipment', 'sap_order_item', 'part_id'),)", 'object_name': 'ShipmentItem'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shipment_items'", 'to': "orm['orders.OrderItem']"}),
            'part_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'quantity': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'sap_order_item': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'shipment_items'", 'null': 'True', 'blank': 'True', 'to': "orm['orders.SAPOrderItem']"}),
        ...
        'orders.saporderitem': {
            'Meta': {'unique_together': "(('order', 'sno'),)", 'object_name': 'SAPOrderItem'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'sap_order_items'", 'null': 'True', 'to': "orm['orders.Order']"}),
            'order_item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sap_order_items'", 'to': "orm['orders.OrderItem']"}),
