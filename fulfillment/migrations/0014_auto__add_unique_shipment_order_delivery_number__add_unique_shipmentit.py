...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Shipment', fields ['order', 'delivery_number']
        db.create_unique('fulfillment_shipment', ['order_id', 'delivery_number'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Shipment', fields ['order', 'delivery_number']
        db.delete_unique('fulfillment_shipment', ['order_id', 'delivery_number'])
    ...
    models = {
        ...
        'fulfillment.shipmentitem': {
            'Meta': {'unique_together': "(('shipment', 'order_item', 'part_id'),)", 'object_name': 'ShipmentItem'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
