...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fulfillment_shipment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shipments', to=orm['orders.Order'])),
            ('tracking_number', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('courier_code', self.gf('django.db.models.fields.CharField')(max_length=45)),
            ('packaged_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('pickedup_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ...
            ('last_modified_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('fulfillment', ['Shipment'])

        # Adding model 'ShipmentItem'
        db.create_table('fulfillment_shipmentitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shipment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shipment_items', to=orm['fulfillment.Shipment'])),
            ('order_item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shipment_item', to=orm['orders.OrderItem'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('part_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('fulfillment', ['ShipmentItem'])


    def backwards(self, orm):
        
        # Deleting model 'Shipment'
        db.delete_table('fulfillment_shipment')

        # Deleting model 'ShipmentItem'
        db.delete_table('fulfillment_shipmentitem')
    ...
    models = {
        ...
        'fulfillment.shipment': {
            ...
            'packaged_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
