...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Agent.report_to'
        db.add_column('ccm_agent', 'report_to', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='agents', null=True, to=orm['ccm.Agent']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Agent.report_to'
        db.delete_column('ccm_agent', 'report_to_id')
    ...
    models = {
        ...
        'ccm.agentloginlogout': {
            ...
            'destination': ('django.db.models.fields.CharField', [], {'default': "'asterisk'", 'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
