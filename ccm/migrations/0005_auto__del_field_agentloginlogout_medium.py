...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AgentLoginLogout.medium'
        db.delete_column('ccm_agentloginlogout', 'medium')


    def backwards(self, orm):
        
        # Adding field 'AgentLoginLogout.medium'
        db.add_column('ccm_agentloginlogout', 'medium', self.gf('django.db.models.fields.CharField')(max_length=20, null=True), keep_default=False)
