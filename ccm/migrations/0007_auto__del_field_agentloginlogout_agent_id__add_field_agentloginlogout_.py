...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AgentLoginLogout.agent_id'
        db.delete_column('ccm_agentloginlogout', 'agent_id_id')

        # Adding field 'AgentLoginLogout.agent'
        db.add_column('ccm_agentloginlogout', 'agent', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ccm.Agent']), keep_default=False)

        # Changing field 'CallSlot.days_of_week'
        db.alter_column('ccm_callslot', 'days_of_week', self.gf('django.db.models.fields.CharField')(max_length=7, blank=True))


    def backwards(self, orm):
        
        # Adding field 'AgentLoginLogout.agent_id'
        db.add_column('ccm_agentloginlogout', 'agent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ccm.Agent']), keep_default=False)

        # Deleting field 'AgentLoginLogout.agent'
        db.delete_column('ccm_agentloginlogout', 'agent_id')

        # Changing field 'CallSlot.days_of_week'
        db.alter_column('ccm_callslot', 'days_of_week', self.gf('django.db.models.fields.CharField')(max_length=7))
    ...
    models = {
        ...
        'ccm.agentloginlogout': {
            ...
            'agent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ccm.Agent']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'time': ('django.db.models.fields.DateTimeField', [], {})
        },
        'ccm.callslot': {
            'Meta': {'object_name': 'CallSlot'},
            'days_of_week': ('django.db.models.fields.CharField', [], {'default': "'0111110'", 'max_length': '7', 'blank': 'True'}),
        ...
        'ccm.extension': {
            ...
            'allotted_to': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'extension'", 'to': "orm['ccm.Agent']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
