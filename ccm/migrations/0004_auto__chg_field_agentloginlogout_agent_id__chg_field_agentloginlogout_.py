...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AgentLoginLogout.agent_id'
        db.alter_column('ccm_agentloginlogout', 'agent_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ccm.Agent']))

        # Changing field 'AgentLoginLogout.medium'
        db.alter_column('ccm_agentloginlogout', 'medium', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))


    def backwards(self, orm):
        
        # Changing field 'AgentLoginLogout.agent_id'
        db.alter_column('ccm_agentloginlogout', 'agent_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ccm.Extension']))

        # Changing field 'AgentLoginLogout.medium'
        db.alter_column('ccm_agentloginlogout', 'medium', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'ccm.agentloginlogout': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'medium': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
