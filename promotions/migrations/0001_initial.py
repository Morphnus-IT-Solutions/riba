...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Coupon'
        db.create_table('promotions_coupon', (
            ...
            ('use_when', self.gf('django.db.models.fields.CharField')(default='manual', max_length=25)),
            ('given_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'], null=True, blank=True)),
            ('applies_to', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('discount_type', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('discount_value', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
        ))
        db.send_create_signal('promotions', ['Coupon'])

        # Adding unique constraint on 'Coupon', fields ['code', 'status']
        db.create_unique('promotions_coupon', ['code', 'status'])

        # Adding model 'CouponConstraint'
        db.create_table('promotions_couponconstraint', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('coupon', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['promotions.Coupon'])),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('logical_operator', self.gf('django.db.models.fields.CharField')(default='and', max_length='3')),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='category_coupons', null=True, to=orm['categories.Category'])),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='account_coupons', null=True, to=orm['accounts.Account'])),
            ('order_min_total', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('product_qty_min', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('promotions', ['CouponConstraint'])

        # Adding M2M table for field products on 'CouponConstraint'
        db.create_table('promotions_couponconstraint_products', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('couponconstraint', models.ForeignKey(orm['promotions.couponconstraint'], null=False)),
            ('product', models.ForeignKey(orm['catalog.product'], null=False))
        ))
        db.create_unique('promotions_couponconstraint_products', ['couponconstraint_id', 'product_id'])

        # Adding model 'FeaturedProducts'
        db.create_table('promotions_featuredproducts', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(default='store', max_length=25, db_index=True)),
            ('section', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Product'], null=True)),
        ...
        db.send_create_signal('promotions', ['FeaturedProducts'])

        # Adding model 'Offer'
        db.create_table('promotions_offer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('price_label', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='draft', max_length=25)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('starts_on', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('ends_on', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('stackable', self.gf('django.db.models.fields.CharField')(default='no', max_length=25)),
        ))
        db.send_create_signal('promotions', ['Offer'])

        # Adding model 'OfferProduct'
        db.create_table('promotions_offerproduct', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('sticker_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('transfer_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
        ))
        db.send_create_signal('promotions', ['OfferProduct'])


    def backwards(self, orm):
        
        # Deleting model 'Coupon'
        db.delete_table('promotions_coupon')

        # Removing unique constraint on 'Coupon', fields ['code', 'status']
        db.delete_unique('promotions_coupon', ['code', 'status'])

        # Deleting model 'CouponConstraint'
        db.delete_table('promotions_couponconstraint')

        # Removing M2M table for field products on 'CouponConstraint'
        db.delete_table('promotions_couponconstraint_products')

        # Deleting model 'FeaturedProducts'
        db.delete_table('promotions_featuredproducts')

        # Deleting model 'Offer'
        db.delete_table('promotions_offer')

        # Deleting model 'OfferProduct'
        db.delete_table('promotions_offerproduct')
