...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'ScratchCard', fields ['status']
        db.create_index('promotions_scratchcard', ['status'])

        # Adding index on 'ScratchCard', fields ['scratch_card_no']
        db.create_index('promotions_scratchcard', ['scratch_card_no'])

        # Adding index on 'ScratchCard', fields ['coupon_code']
        db.create_index('promotions_scratchcard', ['coupon_code'])


    def backwards(self, orm):
        
        # Removing index on 'ScratchCard', fields ['status']
        db.delete_index('promotions_scratchcard', ['status'])

        # Removing index on 'ScratchCard', fields ['scratch_card_no']
        db.delete_index('promotions_scratchcard', ['scratch_card_no'])

        # Removing index on 'ScratchCard', fields ['coupon_code']
        db.delete_index('promotions_scratchcard', ['coupon_code'])
