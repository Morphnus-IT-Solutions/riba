...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Coupon.newsletter'
        db.add_column('promotions_coupon', 'newsletter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.NewsLetter'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Coupon.newsletter'
        db.delete_column('promotions_coupon', 'newsletter_id')
    ...
    models = {
        ...
        'users.newsletter': {
            ...
            'shopping_page': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        }
    }
