...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BundleOffer'
        db.create_table('promotions_bundleoffer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('offer_product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['promotions.OfferProduct'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='active', max_length=25)),
            ('bundle_product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SellerRateChart'])),
            ('percentage_off', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
        ))
        db.send_create_signal('promotions', ['BundleOffer'])


    def backwards(self, orm):
        
        # Deleting model 'BundleOffer'
        db.delete_table('promotions_bundleoffer')
    ...
    models = {
        ...
        'promotions.bundleoffer': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'offer_product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['promotions.OfferProduct']"}),
