...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScratchCardCoupons.store'
        db.add_column('promotions_scratchcardcoupons', 'store', self.gf('django.db.models.fields.CharField')(default='future_group', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScratchCardCoupons.store'
        db.delete_column('promotions_scratchcardcoupons', 'store')
    ...
    models = {
        ...
        'promotions.scratchcard': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 1, 19, 23, 37, 800659)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'})
        },
