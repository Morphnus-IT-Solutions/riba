...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field applicable_on on 'Coupon'
        db.create_table('promotions_coupon_applicable_on', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('coupon', models.ForeignKey(orm['promotions.coupon'], null=False)),
            ('sellerratechart', models.ForeignKey(orm['catalog.sellerratechart'], null=False))
        ))
        db.create_unique('promotions_coupon_applicable_on', ['coupon_id', 'sellerratechart_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field applicable_on on 'Coupon'
        db.delete_table('promotions_coupon_applicable_on')
