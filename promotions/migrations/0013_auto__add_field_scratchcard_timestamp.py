...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScratchCard.timestamp'
        db.add_column('promotions_scratchcard', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 11, 12, 5, 34, 585870), auto_now_add=True, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScratchCard.timestamp'
        db.delete_column('promotions_scratchcard', 'timestamp')
    ...
    models = {
        ...
        'promotions.scratchcard': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 11, 12, 5, 34, 585870)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'})
        },
        'users.newsletter': {
