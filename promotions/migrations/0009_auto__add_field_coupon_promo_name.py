...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Coupon.promo_name'
        db.add_column('promotions_coupon', 'promo_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Coupon.promo_name'
        db.delete_column('promotions_coupon', 'promo_name')
