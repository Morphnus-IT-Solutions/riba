...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Coupon.discount_available_on'
        db.add_column('promotions_coupon', 'discount_available_on', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Coupon.discount_available_on'
        db.delete_column('promotions_coupon', 'discount_available_on')
