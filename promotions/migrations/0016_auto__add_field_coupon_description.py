...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Coupon.description'
        db.add_column('promotions_coupon', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Coupon.description'
        db.delete_column('promotions_coupon', 'description')
    ...
    models = {
        ...
        'promotions.scratchcard': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 25, 13, 46, 18, 213972)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'})
        },
        'users.newsletter': {
