...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScratchCard.store'
        db.add_column('promotions_scratchcard', 'store', self.gf('django.db.models.fields.CharField')(default='future_group', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScratchCard.store'
        db.delete_column('promotions_scratchcard', 'store')
    ...
    models = {
        ...
        'promotions.scratchcard': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 5, 13, 6, 43, 440527)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'})
        },
        'users.newsletter': {
