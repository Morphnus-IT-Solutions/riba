...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FeaturedCategories'
        db.create_table('promotions_featuredcategories', (
        ...
        db.send_create_signal('promotions', ['FeaturedCategories'])


    def backwards(self, orm):
        
        # Deleting model 'FeaturedCategories'
        db.delete_table('promotions_featuredcategories')
    ...
    models = {
        ...
        'promotions.scratchcard': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 2, 18, 46, 5, 766349)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'})
        },
        'users.newsletter': {
