...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ScratchCardCoupons'
        db.create_table('promotions_scratchcardcoupons', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('coupon_code', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('promotions', ['ScratchCardCoupons'])


    def backwards(self, orm):
        
        # Deleting model 'ScratchCardCoupons'
        db.delete_table('promotions_scratchcardcoupons')
    ...
    models = {
        ...
        'promotions.scratchcard': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 18, 58, 50, 581711)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'})
        },
