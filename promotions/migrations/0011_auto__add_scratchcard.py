...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ScratchCard'
        db.create_table('promotions_scratchcard', (
            ...
            ('scratch_card_no', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('coupon_code', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='active', max_length=25)),
        ))
        db.send_create_signal('promotions', ['ScratchCard'])


    def backwards(self, orm):
        
        # Deleting model 'ScratchCard'
        db.delete_table('promotions_scratchcard')
    ...
    models = {
        ...
        'promotions.scratchcard': {
            ...
            'scratch_card_no': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '25'})
        },
        'users.newsletter': {
