...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sms_sms', (
            ...
            ('mask', self.gf('django.db.models.fields.CharField')(default='9222221947', max_length=10)),
            ('gateway', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('notification', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notifications.Notification'], null=True, blank=True)),
            ...
            ('delivered_at', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
    ...
    models = {
        ...
        'notifications.notification': {
            ...
            'to': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Account']", 'null': 'True', 'blank': 'True'}),
        ...
        'sms.sms': {
            ...
            'delivered_at': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'gateway': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mask': ('django.db.models.fields.CharField', [], {'default': "'9222221947'", 'max_length': '10'}),
            'message': ('django.db.models.fields.TextField', [], {}),
            'mobile': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'notification': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['notifications.Notification']", 'null': 'True', 'blank': 'True'}),
