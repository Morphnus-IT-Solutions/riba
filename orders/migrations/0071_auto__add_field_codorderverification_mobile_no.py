...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CodOrderVerification.mobile_no'
        db.add_column('orders_codorderverification', 'mobile_no', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True, default=''), keep_default=True)

        # Adding index on 'CodOrderVerification', fields ['created_on']
        db.create_index('orders_codorderverification', ['created_on'])

    def backwards(self, orm):
        
        # Deleting field 'CodOrderVerification.mobile_no'
        db.delete_column('orders_codorderverification', 'mobile_no')

        # Removing index on 'CodOrderVerification', fields ['created_on']
        db.delete_index('orders_codorderverification', ['created_on'])
