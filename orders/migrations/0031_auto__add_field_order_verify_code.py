...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.verify_code'
        db.add_column('orders_order', 'verify_code', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.verify_code'
        db.delete_column('orders_order', 'verify_code')
