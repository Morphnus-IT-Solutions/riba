...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Order', fields ['timestamp']
        db.create_index('orders_order', ['timestamp'])

        # Adding index on 'Order', fields ['modified_on']
        db.create_index('orders_order', ['modified_on'])


    def backwards(self, orm):
        
        # Removing index on 'Order', fields ['timestamp']
        db.delete_index('orders_order', ['timestamp'])

        # Removing index on 'Order', fields ['modified_on']
        db.delete_index('orders_order', ['modified_on'])
