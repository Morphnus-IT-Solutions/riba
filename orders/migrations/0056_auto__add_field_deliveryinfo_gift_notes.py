...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeliveryInfo.gift_notes'
        db.add_column('orders_deliveryinfo', 'gift_notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True, default=None), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'DeliveryInfo.gift_notes'
        db.delete_column('orders_deliveryinfo', 'gift_notes')
