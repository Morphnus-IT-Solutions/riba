...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderItem.dispatch_due_on'
        db.alter_column('orders_orderitem', 'dispatch_due_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))

        # Changing field 'OrderItem.delivered_on'
        db.alter_column('orders_orderitem', 'delivered_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))

        # Changing field 'OrderItem.dispatched_on'
        db.alter_column('orders_orderitem', 'dispatched_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'OrderItem.dispatch_due_on'
        db.alter_column('orders_orderitem', 'dispatch_due_on', self.gf('django.db.models.fields.DateTimeField')(blank=True))

        # Changing field 'OrderItem.delivered_on'
        db.alter_column('orders_orderitem', 'delivered_on', self.gf('django.db.models.fields.DateTimeField')(blank=True))

        # Changing field 'OrderItem.dispatched_on'
        db.alter_column('orders_orderitem', 'dispatched_on', self.gf('django.db.models.fields.DateTimeField')(blank=True))
