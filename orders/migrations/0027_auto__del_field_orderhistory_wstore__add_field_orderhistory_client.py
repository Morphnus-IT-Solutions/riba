...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OrderHistory.wstore'
        db.delete_column('orders_orderhistory', 'wstore_id')

        # Adding field 'OrderHistory.client'
        db.add_column('orders_orderhistory', 'client', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Client']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'OrderHistory.wstore'
        db.add_column('orders_orderhistory', 'wstore', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Account']), keep_default=False)
