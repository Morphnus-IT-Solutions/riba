...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SAPOrderItem.status'
        db.alter_column('orders_saporderitem', 'status', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True))


    def backwards(self, orm):
        
        # Changing field 'SAPOrderItem.status'
        db.alter_column('orders_saporderitem', 'status', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True))
