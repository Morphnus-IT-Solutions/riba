...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OrderItemLog.exected_delivery_date'
        db.delete_column('orders_orderitemlog', 'exected_delivery_date')

        # Adding field 'OrderItemLog.expected_delivery_date'
        db.add_column('orders_orderitemlog', 'expected_delivery_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True), keep_default=True)


    def backwards(self, orm):
        
        # Adding field 'OrderItemLog.exected_delivery_date'
        db.add_column('orders_orderitemlog', 'exected_delivery_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True), keep_default=False)

        # Deleting field 'OrderItemLog.expected_delivery_date'
        db.delete_column('orders_orderitemlog', 'expected_delivery_date')
