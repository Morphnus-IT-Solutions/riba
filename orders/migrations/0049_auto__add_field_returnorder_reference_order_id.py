...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReturnOrder.reference_order_id'
        db.add_column('orders_returnorder', 'reference_order_id', self.gf('django.db.models.fields.CharField')(db_index=True, default=None, max_length=15, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReturnOrder.reference_order_id'
        db.delete_column('orders_returnorder', 'reference_order_id')
