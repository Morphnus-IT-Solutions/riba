...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ReturnOrderItem'
        db.delete_table('orders_returnorderitem')

        # Adding field 'ReturnOrder.sap_order_item_id'
        db.add_column('orders_returnorder', 'sap_order_item_id', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Adding field 'ReturnOrder.actual_order_item'
        db.add_column('orders_returnorder', 'actual_order_item', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['orders.OrderItem']), keep_default=False)

        # Adding field 'ReturnOrder.quantity'
        db.add_column('orders_returnorder', 'quantity', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ReturnOrder.points'
        db.add_column('orders_returnorder', 'points', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ReturnOrder.points_value'
        db.add_column('orders_returnorder', 'points_value', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2), keep_default=False)

        # Adding field 'ReturnOrder.burn_points'
        db.add_column('orders_returnorder', 'burn_points', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ReturnOrder.reason'
        db.add_column('orders_returnorder', 'reason', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'ReturnOrderItem'
        db.create_table('orders_returnorderitem', (
            ('status', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('sap_order_item_id', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('actual_order_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.OrderItem'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('return_order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.ReturnOrder'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('orders', ['ReturnOrderItem'])

        # Deleting field 'ReturnOrder.sap_order_item_id'
        db.delete_column('orders_returnorder', 'sap_order_item_id')

        # Deleting field 'ReturnOrder.actual_order_item'
        db.delete_column('orders_returnorder', 'actual_order_item_id')

        # Deleting field 'ReturnOrder.quantity'
        db.delete_column('orders_returnorder', 'quantity')

        # Deleting field 'ReturnOrder.points'
        db.delete_column('orders_returnorder', 'points')

        # Deleting field 'ReturnOrder.points_value'
        db.delete_column('orders_returnorder', 'points_value')

        # Deleting field 'ReturnOrder.burn_points'
        db.delete_column('orders_returnorder', 'burn_points')

        # Deleting field 'ReturnOrder.reason'
        db.delete_column('orders_returnorder', 'reason')
