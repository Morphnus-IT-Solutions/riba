...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BundleItem.bundle_item'
        db.alter_column('orders_bundleitem', 'bundle_item_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['orders.OrderItem']))

        # Adding unique constraint on 'BundleItem', fields ['bundle_item']
        db.create_unique('orders_bundleitem', ['bundle_item_id'])


    def backwards(self, orm):
        
        # Changing field 'BundleItem.bundle_item'
        db.alter_column('orders_bundleitem', 'bundle_item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.OrderItem']))

        # Removing unique constraint on 'BundleItem', fields ['bundle_item']
        db.delete_unique('orders_bundleitem', ['bundle_item_id'])
