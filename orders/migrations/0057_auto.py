...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Order', fields ['payment_realized_on']
        db.create_index('orders_order', ['payment_realized_on'])


    def backwards(self, orm):
        
        # Removing index on 'Order', fields ['payment_realized_on']
        db.delete_index('orders_order', ['payment_realized_on'])
