...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.client'
        db.add_column('orders_order', 'client', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Client']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.client'
        db.delete_column('orders_order', 'client_id')
    ...
    models = {
        ...
        'orders.orderhistory': {
            'Meta': {'object_name': 'OrderHistory', '_ormbases': ['orders.Order']},
