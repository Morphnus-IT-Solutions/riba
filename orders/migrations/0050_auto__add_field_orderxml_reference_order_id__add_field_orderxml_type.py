...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderXML.reference_order_id'
        db.add_column('orders_orderxml', 'reference_order_id', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)

        # Adding field 'OrderXML.type'
        db.add_column('orders_orderxml', 'type', self.gf('django.db.models.fields.CharField')(default=None, max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderXML.reference_order_id'
        db.delete_column('orders_orderxml', 'reference_order_id')

        # Deleting field 'OrderXML.type'
        db.delete_column('orders_orderxml', 'type')
