...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('orders_order', 'state', self.gf('django.db.models.fields.CharField')(max_length=25))


    def backwards(self, orm):
        
        # Changing field 'Order.state'
        db.alter_column('orders_order', 'state', self.gf('django.db.models.fields.CharField')(max_length=15))
