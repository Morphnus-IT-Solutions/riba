...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ReturnOrder'
        db.delete_table('orders_returnorder')

        # Deleting model 'SAPOrderItem'
        db.delete_table('orders_saporderitem')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'orders', (
            ('coupondiscount', self.gf('django.db.models.fields.DecimalField')(max_digits=27, null=True, decimal_places=2, db_column='couponDiscount', blank=True)),
            ...
            ('payableamount', self.gf('django.db.models.fields.DecimalField')(decimal_places=5, db_column='payableAmount', max_digits=27)),
            ('paymentmode', self.gf('django.db.models.fields.CharField')(max_length=90, db_column='paymentMode', blank=True)),
            ('shippingcharges', self.gf('django.db.models.fields.DecimalField')(max_digits=12, null=True, decimal_places=2, db_column='shippingCharges', blank=True)),
            ...
            ('billedamount', self.gf('django.db.models.fields.DecimalField')(decimal_places=5, db_column='billedAmount', max_digits=27)),
        ...
        db.create_table(u'order_items', (
            ...
            ('payableamount', self.gf('django.db.models.fields.DecimalField')(max_digits=27, null=True, decimal_places=5, db_column='payableAmount', blank=True)),
            ('modifiedon', self.gf('django.db.models.fields.DateTimeField')(null=True, db_column='modifiedOn', blank=True)),
            ...
            ('itemprice', self.gf('django.db.models.fields.DecimalField')(max_digits=27, null=True, decimal_places=5, db_column='itemPrice', blank=True)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('orders', ['OrderItems'])

        # Adding model 'ReturnOrder'
        db.create_table('orders_returnorder', (
            ('burn_points', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('sap_order_id', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('actual_order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Order'])),
            ...
            ('points_value', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('reference_order_id', self.gf('django.db.models.fields.CharField')(blank=True, max_length=15, db_index=True)),
            ...
            ('sap_order_item', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['orders.SAPOrderItem'], null=True, blank=True)),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('points', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('orders', ['ReturnOrder'])

        # Adding model 'SAPOrderItem'
        db.create_table('orders_saporderitem', (
            ('revised_stock_arrival', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('sno', self.gf('django.db.models.fields.IntegerField')(default=10)),
            ('dc', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['fulfillment.Dc'], blank=True)),
            ('lsp', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['fulfillment.Lsp'], blank=True)),
            ('order_item', self.gf('django.db.models.fields.related.OneToOneField')(related_name='sap_order_item', unique=True, to=orm['orders.OrderItem'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('po_date', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True)),
            ('po_number', self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('sap_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='sap_order_items', null=True, to=orm['orders.Order'], blank=True)),
        ))
        db.send_create_signal('orders', ['SAPOrderItem'])
    ...
    models = {
        ...
        'orders.bulkorderdetails': {
            'Meta': {'object_name': 'BulkOrderDetails'},
        ...
        'orders.bundleitem': {
            'Meta': {'object_name': 'BundleItem'},
            'bundle_item': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'bundle_item'", 'unique': 'True', 'to': "orm['orders.OrderItem']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.Order']"}),
            'parent_item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['orders.OrderItem']"}),
        ...
        'orders.codorderverification': {
            'Meta': {'object_name': 'CodOrderVerification'},
            ...
            'mobile_no': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '15', 'null': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.Order']"}),
            'reference_order_id': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '15', 'null': 'True', 'blank': 'True'}),
        ...
        'orders.thirdpartyorders': {
            'Meta': {'object_name': 'ThirdPartyOrders'},
            'bp_number': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.Order']"}),
            'receipt_no': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'third_party_order': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
        'promotions.coupon': {
