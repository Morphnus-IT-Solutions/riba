...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderXML.error_type'
        db.add_column('orders_orderxml', 'error_type', self.gf('django.db.models.fields.CharField')(default=None, max_length=20), keep_default=True)

        # Adding field 'SAPOrderItem.status'
        db.add_column('orders_saporderitem', 'status', self.gf('django.db.models.fields.CharField')(default=None, max_length=20, blank=True, null=True), keep_default=True)

        # Deleting field 'OrderItem.dispatch_due_on'
        #db.delete_column('orders_orderitem', 'dispatch_due_on')

        # Deleting field 'OrderItem.delivered_on'
        #db.delete_column('orders_orderitem', 'delivered_on')

        # Deleting field 'OrderItem.dispatched_on'
        #db.delete_column('orders_orderitem', 'dispatched_on')

        # Adding field 'OrderItem.expected_stock_arrival'
        db.add_column('orders_orderitem', 'expected_stock_arrival', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True, default=None), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'OrderXML.error_type'
        db.delete_column('orders_orderxml', 'error_type')

        # Deleting field 'SAPOrderItem.status'
        db.delete_column('orders_saporderitem', 'status')

        # Adding field 'OrderItem.dispatch_due_on'
        #db.add_column('orders_orderitem', 'dispatch_due_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True, default=None), keep_default=True)

        # Adding field 'OrderItem.delivered_on'
        #db.add_column('orders_orderitem', 'delivered_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True, default=None), keep_default=True)

        # Adding field 'OrderItem.dispatched_on'
        #db.add_column('orders_orderitem', 'dispatched_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True, default=None), keep_default=True)

        # Deleting field 'OrderItem.expected_stock_arrival'
        db.delete_column('orders_orderitem', 'expected_stock_arrival')
