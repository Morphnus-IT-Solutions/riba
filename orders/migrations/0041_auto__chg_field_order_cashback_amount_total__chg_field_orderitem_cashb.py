...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.cashback_amount_total'
        db.alter_column('orders_order', 'cashback_amount_total', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=22, decimal_places=2, blank=True))

        # Changing field 'OrderItem.cashback_amount'
        db.alter_column('orders_orderitem', 'cashback_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=22, decimal_places=2, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Order.cashback_amount_total'
        db.alter_column('orders_order', 'cashback_amount_total', self.gf('django.db.models.fields.DecimalField')(max_digits=22, decimal_places=2))

        # Changing field 'OrderItem.cashback_amount'
        db.alter_column('orders_orderitem', 'cashback_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=22, decimal_places=2))
