...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.payment_mode'
        db.alter_column('orders_order', 'payment_mode', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True))

        # Changing field 'Order.payment_realized_mode'
        db.alter_column('orders_order', 'payment_realized_mode', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Order.payment_mode'
        db.alter_column('orders_order', 'payment_mode', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True))

        # Changing field 'Order.payment_realized_mode'
        db.alter_column('orders_order', 'payment_realized_mode', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True))
