...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #db.add_column('orders_orderdailycount', 'client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Client'], null=True, blank=True, default=None), keep_default=True)

        # Adding field 'OrderCount.client'
        db.add_column('orders_ordercount', 'client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Client'], null=True, blank=True, default=None), keep_default=True)
