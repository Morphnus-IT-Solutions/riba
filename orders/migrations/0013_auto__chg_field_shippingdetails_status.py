...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShippingDetails.status'
        db.alter_column('orders_shippingdetails', 'status', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'ShippingDetails.status'
        db.alter_column('orders_shippingdetails', 'status', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))
