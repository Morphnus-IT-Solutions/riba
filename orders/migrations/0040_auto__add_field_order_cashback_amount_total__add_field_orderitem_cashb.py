...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('orders_order', 'cashback_amount_total', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2), keep_default=False)

        # Adding field 'OrderItem.cashback_amount'
        db.add_column('orders_orderitem', 'cashback_amount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2), keep_default=False)
    ...
    models = {
        ...
        'orders.order': {
            ...
            'cashback_amount_total': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '22', 'decimal_places': '2'}),
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Client']"}),
        ...
        'orders.orderitem': {
            ...
            'cashback_amount': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '22', 'decimal_places': '2'}),
