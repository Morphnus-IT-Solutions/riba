...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderXML.reason'
        db.add_column('orders_orderxml', 'reason', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'OrderXML.reason'
        db.delete_column('orders_orderxml', 'reason')
