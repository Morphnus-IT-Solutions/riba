...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubscriptionDetails.order_item'
        db.add_column('orders_subscriptiondetails', 'order_item', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['orders.OrderItem']), keep_default=False)

        # Deleting field 'Order.gift_info'
        db.delete_column('orders_order', 'gift_info_id')

        # Deleting field 'Order.billing_info'
        db.delete_column('orders_order', 'billing_info_id')

        # Deleting field 'Order.delivery_info'
        db.delete_column('orders_order', 'delivery_info_id')

        # Adding field 'BillingInfo.order'
        db.add_column('orders_billinginfo', 'order', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['orders.Order']), keep_default=False)

        # Adding field 'DeliveryInfo.order'
        db.add_column('orders_deliveryinfo', 'order', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['orders.Order']), keep_default=False)

        # Adding field 'ShippingDetails.order_item'
        db.add_column('orders_shippingdetails', 'order_item', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['orders.OrderItem']), keep_default=False)

        # Deleting field 'OrderItem.shipping_info'
        db.delete_column('orders_orderitem', 'shipping_info_id')

        # Deleting field 'OrderItem.subscription_info'
        db.delete_column('orders_orderitem', 'subscription_info_id')

        # Adding field 'GiftInfo.order'
        db.add_column('orders_giftinfo', 'order', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['orders.Order']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubscriptionDetails.order_item'
        db.delete_column('orders_subscriptiondetails', 'order_item_id')

        # Adding field 'Order.gift_info'
        db.add_column('orders_order', 'gift_info', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.GiftInfo'], null=True, blank=True), keep_default=False)

        # Adding field 'Order.billing_info'
        db.add_column('orders_order', 'billing_info', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.BillingInfo'], null=True, blank=True), keep_default=False)

        # Adding field 'Order.delivery_info'
        db.add_column('orders_order', 'delivery_info', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.DeliveryInfo'], null=True, blank=True), keep_default=False)

        # Deleting field 'BillingInfo.order'
        db.delete_column('orders_billinginfo', 'order_id')

        # Deleting field 'DeliveryInfo.order'
        db.delete_column('orders_deliveryinfo', 'order_id')

        # Deleting field 'ShippingDetails.order_item'
        db.delete_column('orders_shippingdetails', 'order_item_id')

        # Adding field 'OrderItem.shipping_info'
        db.add_column('orders_orderitem', 'shipping_info', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.ShippingDetails'], null=True, blank=True), keep_default=False)

        # Adding field 'OrderItem.subscription_info'
        db.add_column('orders_orderitem', 'subscription_info', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.SubscriptionDetails'], null=True, blank=True), keep_default=False)

        # Deleting field 'GiftInfo.order'
        db.delete_column('orders_giftinfo', 'order_id')
