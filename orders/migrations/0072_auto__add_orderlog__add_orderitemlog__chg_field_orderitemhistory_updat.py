...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('orders_orderlog', (
            ...
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, blank=True, to=orm['users.Profile'])),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('status', self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True, blank=True)),
            ('payment_mode_old', self.gf('django.db.models.fields.CharField')(default=None, max_length=15, null=True, blank=True)),
            ('payment_mode_new', self.gf('django.db.models.fields.CharField')(default=None, max_length=15, null=True, blank=True)),
            ('coupon_old', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, blank=True, to=orm['promotions.Coupon'])),
            ('coupon_new', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, blank=True, to=orm['promotions.Coupon'])),
            ('discount_old', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=22, decimal_places=2, blank=True)),
            ('discount_new', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=22, decimal_places=2, blank=True)),
            ('auto_promotions_discount_old', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=22, decimal_places=2, blank=True)),
            ('auto_promotions_discount_new', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=22, decimal_places=2, blank=True)),
            ('shipping_charges_old', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=22, decimal_places=2, blank=True)),
            ('shipping_charges_new', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=22, decimal_places=2, blank=True)),
            ('payable_amount', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=22, decimal_places=2, blank=True)),
            ('earn_points', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True)),
            ('burn_points', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True)),
            ('address_old', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('address_new', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('orders', ['OrderLog'])

        # Adding model 'OrderItemLog'
        db.create_table('orders_orderitemlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order_item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='item_log', to=orm['orders.OrderItem'])),
            ('order_log', self.gf('django.db.models.fields.related.ForeignKey')(related_name='item_log', to=orm['orders.OrderLog'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('status', self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True, blank=True)),
            ('qty_old', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True)),
            ('qty_new', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True)),
            ('expected_stock_arrival', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('exected_delivery_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('orders', ['OrderItemLog'])


    def backwards(self, orm):
        
        # Deleting model 'OrderLog'
        db.delete_table('orders_orderlog')

        # Deleting model 'OrderItemLog'
        db.delete_table('orders_orderitemlog')
    ...
    models = {
        ...
        'orders.orderitemlog': {
            'Meta': {'unique_together': "(('order_item', 'order_log'),)", 'object_name': 'OrderItemLog'},
            'action': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'exected_delivery_date': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        'orders.returnorder': {
            ...
            'sap_order_item': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['orders.SAPOrderItem']", 'null': 'True', 'blank': 'True'}),
        ...
        'orders.saporderitem': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'sap_order_items'", 'null': 'True', 'blank': 'True', 'to': "orm['orders.Order']"}),
