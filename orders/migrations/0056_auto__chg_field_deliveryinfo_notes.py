...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeliveryInfo.notes'
        db.alter_column('orders_deliveryinfo', 'notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'DeliveryInfo.notes'
        db.alter_column('orders_deliveryinfo', 'notes', self.gf('django.db.models.fields.TextField')(blank=True))
