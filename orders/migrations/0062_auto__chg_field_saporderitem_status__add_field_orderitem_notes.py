...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('orders_orderitem', 'notes', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.notes'
        db.delete_column('orders_orderitem', 'notes')
