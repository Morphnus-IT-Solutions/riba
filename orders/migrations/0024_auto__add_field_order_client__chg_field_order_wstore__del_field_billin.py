...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BillingInfo.user'
        db.add_column('orders_billinginfo', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['users.Profile']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BillingInfo.user'
        db.delete_column('orders_billinginfo', 'user_id')
