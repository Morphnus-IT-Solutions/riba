...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.wstore'
        db.alter_column('orders_order', 'wstore_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Order.wstore'
        db.alter_column('orders_order', 'wstore_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account']))
