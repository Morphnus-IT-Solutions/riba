...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        return
        # Changing field 'OrderItem.total_amount'
        #db.alter_column('orders_orderitem', 'total_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=22, decimal_places=2))


    def backwards(self, orm):
        return
        # Changing field 'OrderItem.total_amount'
        #db.alter_column('orders_orderitem', 'total_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=22, decimal_places=2, blank=True))
