...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderHistory.payment_mode'
        db.alter_column('orders_orderhistory', 'payment_mode', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True))

        # Changing field 'Order.payback_id'
        #db.alter_column('orders_order', 'payback_id', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True))

        # Adding field 'OrderItem.currency'
        db.add_column('orders_orderitem', 'currency', self.gf('django.db.models.fields.CharField')(default='inr', max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'OrderHistory.payment_mode'
        db.alter_column('orders_orderhistory', 'payment_mode', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True))

        # Changing field 'Order.payback_id'
        #db.alter_column('orders_order', 'payback_id', self.gf('django.db.models.fields.CharField')(blank=True, max_length=50, null=True))

        # Deleting field 'OrderItem.currency'
        db.delete_column('orders_orderitem', 'currency')
