...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Order', fields ['support_state']
        db.create_index('orders_order', ['support_state'])

        # Adding index on 'Order', fields ['state']
        db.create_index('orders_order', ['state'])


    def backwards(self, orm):
        
        # Removing index on 'Order', fields ['support_state']
        db.delete_index('orders_order', ['support_state'])

        # Removing index on 'Order', fields ['state']
        db.delete_index('orders_order', ['state'])
