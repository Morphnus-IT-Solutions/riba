...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CodOrderVerification.reference_order_id'
        db.add_column('orders_codorderverification', 'reference_order_id', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=15, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CodOrderVerification.reference_order_id'
        db.delete_column('orders_codorderverification', 'reference_order_id')
