...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'orders', (
            ...
            ('friendlyorderid', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='friendlyOrderId', blank=True)),
            ('process', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('billedamount', self.gf('django.db.models.fields.DecimalField')(db_column='billedAmount', decimal_places=5, max_digits=27)),
            ('discount', self.gf('django.db.models.fields.DecimalField')(max_digits=27, decimal_places=5)),
            ('payableamount', self.gf('django.db.models.fields.DecimalField')(db_column='payableAmount', decimal_places=5, max_digits=27)),
            ('userid', self.gf('django.db.models.fields.BigIntegerField')(db_column='userId')),
            ('timestamp', self.gf('django.db.models.fields.DateField')()),
            ('modifiedon', self.gf('django.db.models.fields.DateTimeField')(null=True, db_column='modifiedOn', blank=True)),
            ('fulfilledon', self.gf('django.db.models.fields.DateTimeField')(null=True, db_column='fulfilledOn', blank=True)),
            ('paymentrealizedon', self.gf('django.db.models.fields.DateTimeField')(null=True, db_column='paymentRealizedOn', blank=True)),
            ('expireson', self.gf('django.db.models.fields.DateTimeField')(null=True, db_column='expiresOn', blank=True)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ('paymentmode', self.gf('django.db.models.fields.CharField')(max_length=90, db_column='paymentMode', blank=True)),
            ('paymentrealizedmode', self.gf('django.db.models.fields.CharField')(max_length=90, db_column='paymentRealizedMode', blank=True)),
            ('billingname', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='billingName', blank=True)),
            ('billingphone', self.gf('django.db.models.fields.CharField')(max_length=45, db_column='billingPhone', blank=True)),
            ('billingaddress', self.gf('django.db.models.fields.CharField')(max_length=1500, db_column='billingAddress', blank=True)),
            ('billinglocality', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='billingLocality', blank=True)),
            ('billingcity', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='billingCity', blank=True)),
            ('billingstate', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='billingState', blank=True)),
            ('billingcountry', self.gf('django.db.models.fields.CharField')(max_length=75, db_column='billingCountry', blank=True)),
            ('billingpincode', self.gf('django.db.models.fields.CharField')(max_length=30, db_column='billingPincode', blank=True)),
            ('deliveryname', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='deliveryName', blank=True)),
            ('deliveryphone', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='deliveryPhone', blank=True)),
            ('deliveryaddress', self.gf('django.db.models.fields.CharField')(max_length=1500, db_column='deliveryAddress', blank=True)),
            ('deliverylocality', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='deliveryLocality', blank=True)),
            ('deliverycity', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='deliveryCity', blank=True)),
            ('deliverystate', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='deliveryState', blank=True)),
            ('deliverycountry', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='deliveryCountry', blank=True)),
            ('deliverypincode', self.gf('django.db.models.fields.CharField')(max_length=30, db_column='deliveryPincode', blank=True)),
            ('deliverynotes', self.gf('django.db.models.fields.CharField')(max_length=1500, db_column='deliveryNotes', blank=True)),
            ('deliverygiftnotes', self.gf('django.db.models.fields.CharField')(max_length=1500, db_column='deliveryGiftNotes', blank=True)),
            ('deliverydate', self.gf('django.db.models.fields.DateTimeField')(null=True, db_column='deliveryDate', blank=True)),
            ('callid', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='callId', blank=True)),
            ('createdby', self.gf('django.db.models.fields.CharField')(max_length=75, db_column='createdBy', blank=True)),
            ('coupondiscount', self.gf('django.db.models.fields.DecimalField')(blank=True, null=True, db_column='couponDiscount', decimal_places=2, max_digits=27)),
            ('discountcode', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='discountCode', blank=True)),
            ('discountsponsorid', self.gf('django.db.models.fields.BigIntegerField')(null=True, db_column='discountSponsorId', blank=True)),
            ('shippingcharges', self.gf('django.db.models.fields.DecimalField')(blank=True, null=True, db_column='shippingCharges', decimal_places=2, max_digits=12)),
        ))
        db.send_create_signal('orders', ['Orders'])

        # Adding model 'OrderItems'
        db.create_table(u'order_items', (
            ('id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True)),
            ('orderid', self.gf('django.db.models.fields.BigIntegerField')(db_column='orderId')),
            ('itemtype', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='itemType')),
            ('itemprice', self.gf('django.db.models.fields.DecimalField')(blank=True, null=True, db_column='itemPrice', decimal_places=5, max_digits=27)),
            ('discount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=27, decimal_places=5, blank=True)),
            ('payableamount', self.gf('django.db.models.fields.DecimalField')(blank=True, null=True, db_column='payableAmount', decimal_places=5, max_digits=27)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('billedamount', self.gf('django.db.models.fields.FloatField')(null=True, db_column='billedAmount', blank=True)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('modifiedon', self.gf('django.db.models.fields.DateTimeField')(null=True, db_column='modifiedOn', blank=True)),
            ('itemid', self.gf('django.db.models.fields.CharField')(max_length=300, db_column='itemId', blank=True)),
            ('itemdata', self.gf('django.db.models.fields.CharField')(max_length=3000, db_column='itemData', blank=True)),
            ('sellerid', self.gf('django.db.models.fields.BigIntegerField')(null=True, db_column='sellerId', blank=True)),
            ('planid', self.gf('django.db.models.fields.BigIntegerField')(null=True, db_column='planId', blank=True)),
            ...
            ('discountcode', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='discountCode', blank=True)),
            ('discountsponsorid', self.gf('django.db.models.fields.BigIntegerField')(null=True, db_column='discountSponsorId', blank=True)),
            ('couriertrackingnumber', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='courierTrackingNumber', blank=True)),
            ('courierservicename', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='courierServiceName', blank=True)),
            ('courierurl', self.gf('django.db.models.fields.CharField')(max_length=300, db_column='courierUrl', blank=True)),
            ('notes', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('deliverystatus', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='deliveryStatus', blank=True)),
            ('weight', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('producttype', self.gf('django.db.models.fields.CharField')(max_length=150, db_column='productType', blank=True)),
            ('shippingcharges', self.gf('django.db.models.fields.DecimalField')(blank=True, null=True, db_column='shippingCharges', decimal_places=2, max_digits=12)),
        ))
        db.send_create_signal('orders', ['OrderItems'])

        # Deleting field 'DeliveryInfo.name'
        db.delete_column('orders_deliveryinfo', 'name')

        # Deleting field 'DeliveryInfo.phone'
        db.delete_column('orders_deliveryinfo', 'phone')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'order_items')

        # Adding field 'DeliveryInfo.name'
        db.add_column('orders_deliveryinfo', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'DeliveryInfo.phone'
        db.add_column('orders_deliveryinfo', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)
