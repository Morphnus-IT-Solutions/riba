...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('orders_returnorderitem', (
            ...
            ('sap_order_item_id', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ...
        db.create_table('orders_returnorder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sap_order_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
    ...
    models = {
        ...
        'orders.returnorder': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'sap_order_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}),
        ...
        'orders.returnorderitem': {
            ...
            'sap_order_item_id': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'})
        },
