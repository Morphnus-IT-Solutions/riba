...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OrderDailyCount.pending_order_count'
        db.delete_column('orders_orderdailycount', 'pending_order_count')

        # Deleting field 'OrderDailyCount.confirmed_order_count'
        db.delete_column('orders_orderdailycount', 'confirmed_order_count')

        # Adding field 'OrderDailyCount.order_count'
        db.add_column('orders_orderdailycount', 'order_count', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=0), keep_default=False)

        # Deleting field 'OrderCount.pending_order_count'
        db.delete_column('orders_ordercount', 'pending_order_count')

        # Deleting field 'OrderCount.confirmed_order_count'
        db.delete_column('orders_ordercount', 'confirmed_order_count')

        # Adding field 'OrderCount.order_count'
        db.add_column('orders_ordercount', 'order_count', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'OrderDailyCount.pending_order_count'
        db.add_column('orders_orderdailycount', 'pending_order_count', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=0), keep_default=False)

        # Adding field 'OrderDailyCount.confirmed_order_count'
        db.add_column('orders_orderdailycount', 'confirmed_order_count', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=0), keep_default=False)

        # Deleting field 'OrderDailyCount.order_count'
        db.delete_column('orders_orderdailycount', 'order_count')

        # Adding field 'OrderCount.pending_order_count'
        db.add_column('orders_ordercount', 'pending_order_count', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=0), keep_default=False)

        # Adding field 'OrderCount.confirmed_order_count'
        db.add_column('orders_ordercount', 'confirmed_order_count', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=0), keep_default=False)

        # Deleting field 'OrderCount.order_count'
        db.delete_column('orders_ordercount', 'order_count')
