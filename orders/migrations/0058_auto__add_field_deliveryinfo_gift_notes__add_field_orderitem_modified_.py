...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderItem.modified_on'
        db.add_column('orders_orderitem', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime.now()), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.modified_on'
        db.delete_column('orders_orderitem', 'modified_on')
