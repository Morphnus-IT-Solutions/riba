...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('orders_order', 'agent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='agent_orders', null=True, to=orm['users.Profile']), keep_default=False)
