...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReturnOrderItem.sap_order_item_id'
        db.alter_column('orders_returnorderitem', 'sap_order_item_id', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True))

        # Changing field 'ReturnOrder.sap_order_id'
        db.alter_column('orders_returnorder', 'sap_order_id', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True))

        # Removing unique constraint on 'ReturnOrder', fields ['sap_order_id']
        db.delete_unique('orders_returnorder', ['sap_order_id'])


    def backwards(self, orm):
        
        # Changing field 'ReturnOrderItem.sap_order_item_id'
        db.alter_column('orders_returnorderitem', 'sap_order_item_id', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'ReturnOrder.sap_order_id'
        db.alter_column('orders_returnorder', 'sap_order_id', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))

        # Adding unique constraint on 'ReturnOrder', fields ['sap_order_id']
        db.create_unique('orders_returnorder', ['sap_order_id'])
    ...
    models = {
        ...
        'orders.returnorderitem': {
            'Meta': {'object_name': 'ReturnOrderItem'},
            ...
            'return_order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.ReturnOrder']"}),
