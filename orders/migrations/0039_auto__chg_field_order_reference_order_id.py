...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.reference_order_id'
        db.alter_column('orders_order', 'reference_order_id', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Order.reference_order_id'
        db.alter_column('orders_order', 'reference_order_id', self.gf('django.db.models.fields.CharField')(blank=True, max_length=10))
