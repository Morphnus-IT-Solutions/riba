...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShippingDetails.shipper_status'
        db.add_column('orders_shippingdetails', 'shipper_status', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ShippingDetails.shipper_status'
        db.delete_column('orders_shippingdetails', 'shipper_status')
