...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderCountByState.client'
        db.add_column('orders_ordercountbystate', 'client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Client'], null=True, blank=True), keep_default=False)

        # Adding field 'Order.cashback_amount_total'
        #db.add_column('orders_order', 'cashback_amount_total', self.gf('django.db.models.fields.DecimalField')(default='0', null=True, max_digits=22, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'Order.booking_agent'
        #db.add_column('orders_order', 'booking_agent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='booking_agent_orders', null=True, to=orm['users.Profile']), keep_default=False)

        # Adding field 'Order.confirming_agent'
        #db.add_column('orders_order', 'confirming_agent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='confirming_agent_orders', null=True, to=orm['users.Profile']), keep_default=False)

        # Adding field 'Order.booking_timestamp'
        #db.add_column('orders_order', 'booking_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)

        # Adding field 'Order.confirming_timestamp'
        #db.add_column('orders_order', 'confirming_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)

        # Changing field 'Order.modified_on'
        db.alter_column('orders_order', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True))

        # Adding field 'OrderDailyCount.client'
        db.add_column('orders_orderdailycount', 'client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Client'], null=True, blank=True), keep_default=False)

        # Changing field 'OrderHistory.reference_order_id'
        db.alter_column('orders_orderhistory', 'reference_order_id', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True))

        # Adding field 'OrderCount.client'
        db.add_column('orders_ordercount', 'client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Client'], null=True, blank=True), keep_default=False)

        # Adding index on 'OrderCount', fields ['order_count']
        db.create_index('orders_ordercount', ['order_count'])

        # Adding field 'OrderItem.cashback_amount'
        #db.add_column('orders_orderitem', 'cashback_amount', self.gf('django.db.models.fields.DecimalField')(default='0', null=True, max_digits=22, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'OrderItem.is_inventory_blocked'
        #db.add_column('orders_orderitem', 'is_inventory_blocked', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderCountByState.client'
        db.delete_column('orders_ordercountbystate', 'client_id')

        # Deleting field 'Order.cashback_amount_total'
        #db.delete_column('orders_order', 'cashback_amount_total')
        ...
        # Deleting field 'Order.booking_timestamp'
        #db.delete_column('orders_order', 'booking_timestamp')

        # Deleting field 'Order.confirming_timestamp'
        #db.delete_column('orders_order', 'confirming_timestamp')

        # Changing field 'Order.modified_on'
        db.alter_column('orders_order', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))

        # Deleting field 'OrderDailyCount.client'
        db.delete_column('orders_orderdailycount', 'client_id')

        # Changing field 'OrderHistory.reference_order_id'
        db.alter_column('orders_orderhistory', 'reference_order_id', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True))

        # Deleting field 'OrderCount.client'
        db.delete_column('orders_ordercount', 'client_id')

        # Removing index on 'OrderCount', fields ['order_count']
        db.delete_index('orders_ordercount', ['order_count'])

        # Deleting field 'OrderItem.cashback_amount'
        #db.delete_column('orders_orderitem', 'cashback_amount')

        # Deleting field 'OrderItem.is_inventory_blocked'
        #db.delete_column('orders_orderitem', 'is_inventory_blocked')
    ...
    models = {
        ...
        'orders.orderhistory': {
            ...
            'payment_realized_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'reference_order_id': ('django.db.models.fields.CharField', [], {'max_length': '15', 'blank': 'True'}),
