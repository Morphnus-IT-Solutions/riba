...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderItem.discount'
        db.add_column('orders_orderitem', 'discount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.discount'
        db.delete_column('orders_orderitem', 'discount')
    ...
    models = {
        ...
        'orders.bundleitem': {
            'Meta': {'unique_together': "(('order', 'bundle_item', 'parent_item'),)", 'object_name': 'BundleItem'},
            'bundle_item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['orders.OrderItem']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
