...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OrderItemHistory.dispatch_due_on'
        db.delete_column('orders_orderitemhistory', 'dispatch_due_on')

        # Deleting field 'OrderItemHistory.itemid'
        db.delete_column('orders_orderitemhistory', 'itemid')

        # Deleting field 'OrderItemHistory.revision_time'
        db.delete_column('orders_orderitemhistory', 'revision_time')

        # Deleting field 'OrderItemHistory.list_price'
        db.delete_column('orders_orderitemhistory', 'list_price')

        # Deleting field 'OrderItemHistory.item_title'
        db.delete_column('orders_orderitemhistory', 'item_title')

        # Deleting field 'OrderItemHistory.revised_by'
        db.delete_column('orders_orderitemhistory', 'revised_by_id')

        # Deleting field 'OrderItemHistory.delivered_on'
        db.delete_column('orders_orderitemhistory', 'delivered_on')

        # Deleting field 'OrderItemHistory.seller_rate_chart'
        db.delete_column('orders_orderitemhistory', 'seller_rate_chart_id')

        # Deleting field 'OrderItemHistory.order'
        db.delete_column('orders_orderitemhistory', 'order_id')

        # Deleting field 'OrderItemHistory.dispatched_on'
        db.delete_column('orders_orderitemhistory', 'dispatched_on')

        # Deleting field 'OrderItemHistory.sale_price'
        db.delete_column('orders_orderitemhistory', 'sale_price')

        # Deleting field 'OrderItemHistory.gift_title'
        db.delete_column('orders_orderitemhistory', 'gift_title')

        # Adding field 'OrderItemHistory.order_item'
        db.add_column('orders_orderitemhistory', 'order_item', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['orders.OrderItem']), keep_default=False)

        # Adding field 'OrderItemHistory.timestamp'
        db.add_column('orders_orderitemhistory', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=None, blank=True), keep_default=False)

        # Adding field 'OrderItemHistory.updated_by'
        db.add_column('orders_orderitemhistory', 'updated_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.Profile']), keep_default=False)

        # Changing field 'OrderItemHistory.state'
        db.alter_column('orders_orderitemhistory', 'state', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True))

        # Deleting field 'OrderHistory.agent'
        db.delete_column('orders_orderhistory', 'agent_id')

        # Deleting field 'OrderHistory.modified_on'
        db.delete_column('orders_orderhistory', 'modified_on')

        # Deleting field 'OrderHistory.partner'
        db.delete_column('orders_orderhistory', 'partner')

        # Deleting field 'OrderHistory.total'
        db.delete_column('orders_orderhistory', 'total')

        # Deleting field 'OrderHistory.revision_time'
        db.delete_column('orders_orderhistory', 'revision_time')

        # Deleting field 'OrderHistory.transaction_charges'
        db.delete_column('orders_orderhistory', 'transaction_charges')

        # Deleting field 'OrderHistory.list_price_total'
        db.delete_column('orders_orderhistory', 'list_price_total')

        # Deleting field 'OrderHistory.call_id'
        db.delete_column('orders_orderhistory', 'call_id')

        # Deleting field 'OrderHistory.ga_tracked'
        db.delete_column('orders_orderhistory', 'ga_tracked')

        # Deleting field 'OrderHistory.client'
        db.delete_column('orders_orderhistory', 'client_id')

        # Deleting field 'OrderHistory.payment_realized_on'
        db.delete_column('orders_orderhistory', 'payment_realized_on')

        # Deleting field 'OrderHistory.medium'
        db.delete_column('orders_orderhistory', 'medium')

        # Deleting field 'OrderHistory.coupon_discount'
        db.delete_column('orders_orderhistory', 'coupon_discount')

        # Deleting field 'OrderHistory.reference_order_id'
        db.delete_column('orders_orderhistory', 'reference_order_id')

        # Deleting field 'OrderHistory.revised_by'
        db.delete_column('orders_orderhistory', 'revised_by_id')

        # Deleting field 'OrderHistory.user'
        db.delete_column('orders_orderhistory', 'user_id')

        # Deleting field 'OrderHistory.payment_mode'
        db.delete_column('orders_orderhistory', 'payment_mode')

        # Deleting field 'OrderHistory.taxes'
        db.delete_column('orders_orderhistory', 'taxes')

        # Deleting field 'OrderHistory.payment_realized_mode'
        db.delete_column('orders_orderhistory', 'payment_realized_mode')

        # Adding field 'OrderHistory.order'
        db.add_column('orders_orderhistory', 'order', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['orders.Order']), keep_default=False)

        # Adding field 'OrderHistory.updated_by'
        db.add_column('orders_orderhistory', 'updated_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.Profile']), keep_default=False)

        # Changing field 'OrderHistory.shipping_charges'
        db.alter_column('orders_orderhistory', 'shipping_charges', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=22, decimal_places=2, blank=True))

        # Changing field 'OrderHistory.timestamp'
        db.alter_column('orders_orderhistory', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))

        # Changing field 'OrderHistory.state'
        db.alter_column('orders_orderhistory', 'state', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'OrderHistory.payable_amount'
        db.alter_column('orders_orderhistory', 'payable_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=22, decimal_places=2, blank=True))


    def backwards(self, orm):
        
        # Adding field 'OrderItemHistory.dispatch_due_on'
        db.add_column('orders_orderitemhistory', 'dispatch_due_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'OrderItemHistory.itemid'
        db.add_column('orders_orderitemhistory', 'itemid', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'OrderItemHistory.revision_time'
        db.add_column('orders_orderitemhistory', 'revision_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'OrderItemHistory.list_price'
        db.add_column('orders_orderitemhistory', 'list_price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2), keep_default=False)

        # Adding field 'OrderItemHistory.item_title'
        db.add_column('orders_orderitemhistory', 'item_title', self.gf('django.db.models.fields.CharField')(default=None, max_length=500), keep_default=False)

        # Adding field 'OrderItemHistory.revised_by'
        db.add_column('orders_orderitemhistory', 'revised_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.Profile']), keep_default=False)

        # Adding field 'OrderItemHistory.delivered_on'
        db.add_column('orders_orderitemhistory', 'delivered_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'OrderItemHistory.seller_rate_chart'
        db.add_column('orders_orderitemhistory', 'seller_rate_chart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SellerRateChart'], null=True, blank=True), keep_default=False)

        # Adding field 'OrderItemHistory.order'
        db.add_column('orders_orderitemhistory', 'order', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['orders.Order']), keep_default=False)

        # Adding field 'OrderItemHistory.dispatched_on'
        db.add_column('orders_orderitemhistory', 'dispatched_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'OrderItemHistory.sale_price'
        db.add_column('orders_orderitemhistory', 'sale_price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2), keep_default=False)

        # Adding field 'OrderItemHistory.gift_title'
        db.add_column('orders_orderitemhistory', 'gift_title', self.gf('django.db.models.fields.CharField')(default=None, max_length=500, blank=True), keep_default=False)

        # Deleting field 'OrderItemHistory.order_item'
        db.delete_column('orders_orderitemhistory', 'order_item_id')

        # Deleting field 'OrderItemHistory.timestamp'
        db.delete_column('orders_orderitemhistory', 'timestamp')

        # Deleting field 'OrderItemHistory.updated_by'
        db.delete_column('orders_orderitemhistory', 'updated_by_id')

        # Changing field 'OrderItemHistory.state'
        db.alter_column('orders_orderitemhistory', 'state', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))

        # Adding field 'OrderHistory.agent'
        db.add_column('orders_orderhistory', 'agent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='agent_orders_inhistory', null=True, to=orm['users.Profile'], blank=True), keep_default=False)

        # Adding field 'OrderHistory.modified_on'
        db.add_column('orders_orderhistory', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'OrderHistory.partner'
        db.add_column('orders_orderhistory', 'partner', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, blank=True), keep_default=False)

        # Adding field 'OrderHistory.total'
        db.add_column('orders_orderhistory', 'total', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2), keep_default=False)

        # Adding field 'OrderHistory.revision_time'
        db.add_column('orders_orderhistory', 'revision_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'OrderHistory.transaction_charges'
        db.add_column('orders_orderhistory', 'transaction_charges', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2), keep_default=False)

        # Adding field 'OrderHistory.list_price_total'
        db.add_column('orders_orderhistory', 'list_price_total', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2), keep_default=False)

        # Adding field 'OrderHistory.call_id'
        db.add_column('orders_orderhistory', 'call_id', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'OrderHistory.ga_tracked'
        db.add_column('orders_orderhistory', 'ga_tracked', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'OrderHistory.client'
        db.add_column('orders_orderhistory', 'client', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['accounts.Client']), keep_default=False)

        # Adding field 'OrderHistory.payment_realized_on'
        db.add_column('orders_orderhistory', 'payment_realized_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'OrderHistory.medium'
        db.add_column('orders_orderhistory', 'medium', self.gf('django.db.models.fields.CharField')(default='cc', max_length=5, blank=True), keep_default=False)

        # Adding field 'OrderHistory.coupon_discount'
        db.add_column('orders_orderhistory', 'coupon_discount', self.gf('django.db.models.fields.DecimalField')(default='0', null=True, max_digits=22, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'OrderHistory.reference_order_id'
        db.add_column('orders_orderhistory', 'reference_order_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=15, blank=True), keep_default=False)

        # Adding field 'OrderHistory.revised_by'
        db.add_column('orders_orderhistory', 'revised_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='order_modifying_agent', to=orm['users.Profile']), keep_default=False)

        # Adding field 'OrderHistory.user'
        db.add_column('orders_orderhistory', 'user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='order_buyer', null=True, to=orm['users.Profile'], blank=True), keep_default=False)

        # Adding field 'OrderHistory.payment_mode'
        db.add_column('orders_orderhistory', 'payment_mode', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'OrderHistory.taxes'
        db.add_column('orders_orderhistory', 'taxes', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2), keep_default=False)

        # Adding field 'OrderHistory.payment_realized_mode'
        db.add_column('orders_orderhistory', 'payment_realized_mode', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)

        # Deleting field 'OrderHistory.order'
        db.delete_column('orders_orderhistory', 'order_id')

        # Deleting field 'OrderHistory.updated_by'
        db.delete_column('orders_orderhistory', 'updated_by_id')

        # Changing field 'OrderHistory.shipping_charges'
        db.alter_column('orders_orderhistory', 'shipping_charges', self.gf('django.db.models.fields.DecimalField')(max_digits=22, decimal_places=2))

        # Changing field 'OrderHistory.timestamp'
        db.alter_column('orders_orderhistory', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True))

        # Changing field 'OrderHistory.state'
        db.alter_column('orders_orderhistory', 'state', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'OrderHistory.payable_amount'
        db.alter_column('orders_orderhistory', 'payable_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=22, decimal_places=2))
    ...
    models = {
        ...
        'locations.state': {
            ...
            'sap_code': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'primary'", 'max_length': "'15'", 'db_index': 'True'}),
            'user_created': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True', 'blank': 'True'})
        },
        'orders.billinginfo': {
        ...
        'orders.orderhistory': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Profile']"})
        },
        'orders.orderitem': {
        ...
        'orders.orderxml': {
            'Meta': {'object_name': 'OrderXML'},
            'attempts': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'error_type': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'expiry_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.Order']"}),
            'reason': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'reference_order_id': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'xml': ('django.db.models.fields.TextField', [], {})
        },
        'orders.returnorder': {
            'Meta': {'object_name': 'ReturnOrder'},
            'actual_order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.Order']"}),
            'actual_order_item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.OrderItem']"}),
            'amount': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '22', 'decimal_places': '2'}),
            'burn_points': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'points': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'points_value': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '22', 'decimal_places': '2'}),
            'quantity': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'reason': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'reference_order_id': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '15', 'blank': 'True'}),
            'sap_order_id': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'sap_order_item_id': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'})
        },
        'orders.saporderitem': {
            'Meta': {'unique_together': "(('order_item', 'sno'),)", 'object_name': 'SAPOrderItem'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_item': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'sap_order_item'", 'unique': 'True', 'to': "orm['orders.OrderItem']"}),
            'sno': ('django.db.models.fields.IntegerField', [], {'default': '10'}),
