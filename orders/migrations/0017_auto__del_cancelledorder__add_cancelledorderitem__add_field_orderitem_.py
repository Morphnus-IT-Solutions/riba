...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'CancelledOrder'
        db.delete_table('orders_cancelledorder')
        ...
        # Adding field 'OrderItem.state'
        db.add_column('orders_orderitem', 'state', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'CancelledOrder'
        db.create_table('orders_cancelledorder', (
            ('refund_status', self.gf('django.db.models.fields.CharField')(default='pending', max_length=100)),
            ('notes', self.gf('django.db.models.fields.TextField')(blank=True)),
        ...
        db.send_create_signal('orders', ['CancelledOrder'])

        # Deleting model 'CancelledOrderItem'
        db.delete_table('orders_cancelledorderitem')

        # Deleting field 'OrderItem.state'
        db.delete_column('orders_orderitem', 'state')
