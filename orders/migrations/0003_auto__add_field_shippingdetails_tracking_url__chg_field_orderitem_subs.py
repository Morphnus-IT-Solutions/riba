...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShippingDetails.tracking_url'
        db.add_column('orders_shippingdetails', 'tracking_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Changing field 'OrderItem.subscription_info'
        db.alter_column('orders_orderitem', 'subscription_info_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.SubscriptionDetails'], null=True, blank=True))

        # Changing field 'OrderItem.shipping_info'
        db.alter_column('orders_orderitem', 'shipping_info_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.ShippingDetails'], null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'ShippingDetails.tracking_url'
        db.delete_column('orders_shippingdetails', 'tracking_url')

        # Changing field 'OrderItem.subscription_info'
        db.alter_column('orders_orderitem', 'subscription_info_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.SubscriptionDetails']))

        # Changing field 'OrderItem.shipping_info'
        db.alter_column('orders_orderitem', 'shipping_info_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.ShippingDetails']))
    ...
    models = {
        ...
        'orders.order': {
            ...
            'billed_amount': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '22', 'decimal_places': '2'}),
