...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Order', fields ['reference_order_id']
        db.create_index('orders_order', ['reference_order_id'])


    def backwards(self, orm):
        
        # Removing index on 'Order', fields ['reference_order_id']
        db.delete_index('orders_order', ['reference_order_id'])
