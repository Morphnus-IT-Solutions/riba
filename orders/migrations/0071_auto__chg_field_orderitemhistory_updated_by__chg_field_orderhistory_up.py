...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        return
        # Changing field 'OrderItemHistory.updated_by'
        db.alter_column('orders_orderitemhistory', 'updated_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'], null=True, blank=True))

        # Changing field 'OrderHistory.updated_by'
        db.alter_column('orders_orderhistory', 'updated_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'], null=True, blank=True))


    def backwards(self, orm):
        return
        # Changing field 'OrderItemHistory.updated_by'
        db.alter_column('orders_orderitemhistory', 'updated_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile']))

        # Changing field 'OrderHistory.updated_by'
        db.alter_column('orders_orderhistory', 'updated_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile']))
