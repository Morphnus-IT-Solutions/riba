...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.client_domain'
        db.add_column('orders_order', 'client_domain', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['accounts.ClientDomain'], null=True, blank=True), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'Order.client_domain'
        db.delete_column('orders_order', 'client_domain_id')
