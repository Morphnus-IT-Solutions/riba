...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SAPOrderItem.sap_date'
        db.add_column('orders_saporderitem', 'sap_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'SAPOrderItem.sap_date'
        db.delete_column('orders_saporderitem', 'sap_date')
