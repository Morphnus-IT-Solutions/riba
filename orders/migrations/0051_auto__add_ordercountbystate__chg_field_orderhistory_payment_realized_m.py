...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderHistory.payment_realized_mode'
        db.alter_column('orders_orderhistory', 'payment_realized_mode', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True))


    def backwards(self, orm):
        # Changing field 'OrderHistory.payment_realized_mode'
        db.alter_column('orders_orderhistory', 'payment_realized_mode', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True))
