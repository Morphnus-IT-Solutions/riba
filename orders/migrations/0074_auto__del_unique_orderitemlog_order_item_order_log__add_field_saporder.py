...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SAPOrderItem.dc'
        db.add_column('orders_saporderitem', 'dc', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, blank=True, to=orm['fulfillment.Dc']), keep_default=True)

        # Adding field 'SAPOrderItem.lsp'
        db.add_column('orders_saporderitem', 'lsp', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, blank=True, to=orm['fulfillment.Lsp']), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'SAPOrderItem.dc'
        db.delete_column('orders_saporderitem', 'dc_id')

        # Deleting field 'SAPOrderItem.lsp'
        db.delete_column('orders_saporderitem', 'lsp_id')
