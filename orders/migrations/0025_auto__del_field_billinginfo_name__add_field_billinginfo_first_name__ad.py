...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BillingInfo.name'
        db.delete_column('orders_billinginfo', 'name')

        # Adding field 'BillingInfo.first_name'
        db.add_column('orders_billinginfo', 'first_name', self.gf('django.db.models.fields.CharField')(default='s', max_length=200), keep_default=False)

        # Adding field 'BillingInfo.last_name'
        db.add_column('orders_billinginfo', 'last_name', self.gf('django.db.models.fields.CharField')(default='j', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'BillingInfo.name'
        db.add_column('orders_billinginfo', 'name', self.gf('django.db.models.fields.CharField')(default=0, max_length=200), keep_default=False)

        # Deleting field 'BillingInfo.first_name'
        db.delete_column('orders_billinginfo', 'first_name')

        # Deleting field 'BillingInfo.last_name'
        db.delete_column('orders_billinginfo', 'last_name')
