...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OrderItemHistory'
        db.create_table('orders_orderitemhistory', (
            ...
            ('seller_rate_chart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SellerRateChart'], null=True, blank=True)),
            ('item_title', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('gift_title', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
            ('list_price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ...
            ('offer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['promotions.Offer'], null=True, blank=True)),
            ('dispatch_due_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('dispatched_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('delivered_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('revision_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('revised_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'])),
        ))
        db.send_create_signal('orders', ['OrderItemHistory'])

        # Adding model 'OrderHistory'
        db.create_table('orders_orderhistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='order_buyer', null=True, to=orm['users.Profile'])),
            ('state', self.gf('django.db.models.fields.CharField')(default='unassigned_cart', max_length=15)),
            ('list_price_total', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('total', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('shipping_charges', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('taxes', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('transaction_charges', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('coupon_discount', self.gf('django.db.models.fields.DecimalField')(default='0', null=True, max_digits=22, decimal_places=2, blank=True)),
            ('coupon', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['promotions.Coupon'], null=True, blank=True)),
            ('payable_amount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('payment_realized_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('payment_mode', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True)),
            ('payment_realized_mode', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True)),
            ('agent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='agent_orders_inhistory', null=True, to=orm['users.Profile'])),
            ('medium', self.gf('django.db.models.fields.CharField')(default='cc', max_length=5, blank=True)),
            ('partner', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('call_id', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True)),
            ('reference_order_id', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('ga_tracked', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('wstore', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'])),
            ('revision_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('revised_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='order_modifying_agent', to=orm['users.Profile'])),
        ))
        db.send_create_signal('orders', ['OrderHistory'])


    def backwards(self, orm):
        
        # Deleting model 'OrderItemHistory'
        db.delete_table('orders_orderitemhistory')

        # Deleting model 'OrderHistory'
        db.delete_table('orders_orderhistory')
