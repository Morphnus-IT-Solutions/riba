...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShippingDetails.status'
        db.add_column('orders_shippingdetails', 'status', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'ShippingDetails.is_shipped'
        db.add_column('orders_shippingdetails', 'is_shipped', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'ShippingDetails.is_delivered'
        db.add_column('orders_shippingdetails', 'is_delivered', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ShippingDetails.status'
        db.delete_column('orders_shippingdetails', 'status')

        # Deleting field 'ShippingDetails.is_shipped'
        db.delete_column('orders_shippingdetails', 'is_shipped')

        # Deleting field 'ShippingDetails.is_delivered'
        db.delete_column('orders_shippingdetails', 'is_delivered')
    ...
    models = {
        ...
        'orders.shippingdetails': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_delivered': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'is_shipped': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
