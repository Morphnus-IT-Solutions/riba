...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SAPOrderItem.order'
        db.add_column('orders_saporderitem', 'order', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='sap_order_items', null=True, blank=True, to=orm['orders.Order']), keep_default=True)

        # Deleting field 'ReturnOrder.sap_order_item_id'
        #Can delete this field without any problem since it is being added again as a foreign key - prady
        db.delete_column('orders_returnorder', 'sap_order_item_id')

        # Adding field 'ReturnOrder.sap_order_item'
        db.add_column('orders_returnorder', 'sap_order_item', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['orders.SAPOrderItem'], null=True, blank=True), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'SAPOrderItem.order'
        db.delete_column('orders_saporderitem', 'order_id')

        # Deleting field 'ReturnOrder.sap_order_item'
        db.delete_column('orders_returnorder', 'sap_order_item_id')
