...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BulkOrderDetails.phone'
        db.alter_column('orders_bulkorderdetails', 'phone', self.gf('django.db.models.fields.CharField')(max_length=11))

        # Adding field 'OrderItem.received_by'
        #db.add_column('orders_orderitem', 'received_by', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'OrderItem.receivers_contact'
        #db.add_column('orders_orderitem', 'receivers_contact', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'BulkOrderDetails.phone'
        db.alter_column('orders_bulkorderdetails', 'phone', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Deleting field 'OrderItem.received_by'
        #db.delete_column('orders_orderitem', 'received_by')

        # Deleting field 'OrderItem.receivers_contact'
        #db.delete_column('orders_orderitem', 'receivers_contact')
    ...
    models = {
        ...
        'orders.orderhistory': {
            ...
            'payment_realized_mode': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'blank': 'True'}),
            'payment_realized_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
