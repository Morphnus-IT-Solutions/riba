...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderItem.created_on'
        db.add_column('orders_orderitem', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.created_on'
        db.delete_column('orders_orderitem', 'created_on')
