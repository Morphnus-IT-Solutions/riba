...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.auto_promotions_discount'
        db.add_column('orders_order', 'auto_promotions_discount', self.gf('django.db.models.fields.DecimalField')(default='0', null=True, max_digits=22, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.auto_promotions_discount'
        db.delete_column('orders_order', 'auto_promotions_discount')
