...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OrderCount'
        db.create_table('orders_ordercount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Product'])),
            ('pending_order_count', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=0)),
            ('confirmed_order_count', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=0)),
        ))
        db.send_create_signal('orders', ['OrderCount'])

        # Adding model 'OrderDailyCount'
        db.create_table('orders_orderdailycount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('orders', ['OrderDailyCount'])


    def backwards(self, orm):
        
        # Deleting model 'OrderCount'
        db.delete_table('orders_ordercount')

        # Deleting model 'OrderDailyCount'
        db.delete_table('orders_orderdailycount')
    ...
    models = {
        ...
        'orders.ordercount': {
            ...
            'confirmed_order_count': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '8', 'decimal_places': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pending_order_count': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '8', 'decimal_places': '0'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Product']"})
        },
