...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderItem.delivery_days'
        db.add_column('orders_orderitem', 'delivery_days', self.gf('django.db.models.fields.IntegerField')(default='0', null=True, blank=True), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.delivery_days'
        db.delete_column('orders_orderitem', 'delivery_days')
