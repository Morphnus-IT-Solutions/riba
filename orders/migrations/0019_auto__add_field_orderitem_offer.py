...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderItem.offer'
        db.add_column('orders_orderitem', 'offer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['promotions.Offer'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.offer'
        db.delete_column('orders_orderitem', 'offer_id')
