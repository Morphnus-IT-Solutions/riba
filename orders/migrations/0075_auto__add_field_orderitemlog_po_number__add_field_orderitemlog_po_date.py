...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderItemLog.po_number'
        db.add_column('orders_orderitemlog', 'po_number', self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True, blank=True), keep_default=True)

        # Adding field 'OrderItemLog.po_date'
        db.add_column('orders_orderitemlog', 'po_date', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True), keep_default=True)

        # Adding field 'SAPOrderItem.po_number'
        db.add_column('orders_saporderitem', 'po_number', self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True, blank=True), keep_default=True)

        # Adding field 'SAPOrderItem.po_date'
        db.add_column('orders_saporderitem', 'po_date', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True), keep_default=True)

        # Adding field 'SAPOrderItem.notes'
        db.add_column('orders_saporderitem', 'notes', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'OrderItemLog.po_number'
        db.delete_column('orders_orderitemlog', 'po_number')

        # Deleting field 'OrderItemLog.po_date'
        db.delete_column('orders_orderitemlog', 'po_date')

        # Deleting field 'SAPOrderItem.po_number'
        db.delete_column('orders_saporderitem', 'po_number')

        # Deleting field 'SAPOrderItem.po_date'
        db.delete_column('orders_saporderitem', 'po_date')

        # Deleting field 'SAPOrderItem.notes'
        db.delete_column('orders_saporderitem', 'notes')
    ...
    models = {
        ...
        'orders.saporderitem': {
            ...
            'dc': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'+'", 'null': 'True', 'blank': 'True', 'to': "orm['fulfillment.Dc']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lsp': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'+'", 'null': 'True', 'blank': 'True', 'to': "orm['fulfillment.Lsp']"}),
            'notes': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
