...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CancelledOrderItem.modified_on'
        #db.add_column('orders_cancelledorderitem', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)
        ...
        # Adding field 'BillingInfo.modified_on'
        #db.add_column('orders_billinginfo', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)

        # Adding field 'DeliveryInfo.modified_on'
        #db.add_column('orders_deliveryinfo', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)

        # Adding field 'ShippingDetails.modified_on'
        #db.add_column('orders_shippingdetails', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)
        pass

    def backwards(self, orm):
        
        # Deleting field 'CancelledOrderItem.modified_on'
        db.delete_column('orders_cancelledorderitem', 'modified_on')
        ...
        # Deleting field 'BillingInfo.modified_on'
        db.delete_column('orders_billinginfo', 'modified_on')

        # Deleting field 'DeliveryInfo.modified_on'
        db.delete_column('orders_deliveryinfo', 'modified_on')

        # Deleting field 'ShippingDetails.modified_on'
        db.delete_column('orders_shippingdetails', 'modified_on')
