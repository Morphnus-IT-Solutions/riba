...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OrderItemHistory.item_id'
        db.delete_column('orders_orderitemhistory', 'item_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'OrderItemHistory.item_id'
        db.add_column('orders_orderitemhistory', 'item_id', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)
