...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.support_state'
        #db.alter_column('orders_order', 'support_state', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True))

        # Adding field 'OrderItem.total_amount'
        db.add_column('orders_orderitem', 'total_amount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2), keep_default=True)


    def backwards(self, orm):
        
        # Changing field 'Order.support_state'
        #db.alter_column('orders_order', 'support_state', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Deleting field 'OrderItem.total_amount'
        db.delete_column('orders_orderitem', 'total_amount')
    ...
    models = {
        ...
        'orders.orderitem': {
            ...
            'total_amount': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'null': 'True', 'max_digits': '22', 'decimal_places': '2', 'blank': 'True'})
        },
