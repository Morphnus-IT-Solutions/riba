...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.call_id'
        db.alter_column('orders_order', 'call_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True))

        # Changing field 'Order.confirming_timestamp'
        db.alter_column('orders_order', 'confirming_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))

        # Adding field 'BillingInfo.order'
        db.add_column('orders_billinginfo', 'order', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='billing_info', null=True, to=orm['orders.Order'], default=None), keep_default=True)

        # Changing field 'BillingInfo.first_name'
        db.alter_column('orders_billinginfo', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True))

        # Changing field 'BillingInfo.last_name'
        db.alter_column('orders_billinginfo', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True))

        # Changing field 'BillingInfo.phone'
        db.alter_column('orders_billinginfo', 'phone', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))

        # Changing field 'BillingInfo.user'
        db.alter_column('orders_billinginfo', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'], null=True, blank=True))

        # Changing field 'DeliveryInfo.order'
        #db.alter_column('orders_deliveryinfo', 'order_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['orders.Order']))
        db.alter_column('orders_deliveryinfo', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Order'], null=True, blank=True))

        # Adding unique constraint on 'DeliveryInfo', fields ['order']
        #db.create_unique('orders_deliveryinfo', ['order_id'])

        # Adding field 'CancelledOrder.user'
        db.add_column('orders_cancelledorder', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.Profile']), keep_default=True)

        # Adding field 'CancelledOrder.notes'
        db.add_column('orders_cancelledorder', 'notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=True)

        # Adding field 'CancelledOrder.refund_amount'
        db.add_column('orders_cancelledorder', 'refund_amount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2), keep_default=True)

        # Adding field 'OrderItem.expected_delivery_date'
        db.add_column('orders_orderitem', 'expected_delivery_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True, default=None), keep_default=True)


    def backwards(self, orm):
         
        # Changing field 'Order.call_id'
        db.alter_column('orders_order', 'call_id', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True))

        ## Changing field 'Order.confirming_timestamp'
        db.alter_column('orders_order', 'confirming_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True))

        ## Deleting field 'BillingInfo.order'
        db.delete_column('orders_billinginfo', 'order_id')

        ## Changing field 'BillingInfo.first_name'
        db.alter_column('orders_billinginfo', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=200))

        ## Changing field 'BillingInfo.last_name'
        db.alter_column('orders_billinginfo', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=200))

        ## Changing field 'BillingInfo.phone'
        db.alter_column('orders_billinginfo', 'phone', self.gf('django.db.models.fields.CharField')(max_length=100))

        ## Changing field 'BillingInfo.user'
        db.alter_column('orders_billinginfo', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile']))

        # Changing field 'DeliveryInfo.order'
        db.alter_column('orders_deliveryinfo', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Order']))

        # Removing unique constraint on 'DeliveryInfo', fields ['order']
        #db.delete_unique('orders_deliveryinfo', ['order_id'])

        # Deleting field 'CancelledOrder.user'
        db.delete_column('orders_cancelledorder', 'user_id')

        # Deleting field 'CancelledOrder.notes'
        db.delete_column('orders_cancelledorder', 'notes')

        # Deleting field 'CancelledOrder.refund_amount'
        db.delete_column('orders_cancelledorder', 'refund_amount')

        # Deleting field 'OrderItem.expected_delivery_date'
        db.delete_column('orders_orderitem', 'expected_delivery_date')
