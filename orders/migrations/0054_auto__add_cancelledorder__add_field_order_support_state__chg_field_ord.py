...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.support_state'
        db.add_column('orders_order', 'support_state', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True, null=True, default=None), keep_default=True)

        # Changing field 'Order.medium'
        db.alter_column('orders_order', 'medium', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Order.support_state'
        db.delete_column('orders_order', 'support_state')

        # Changing field 'Order.medium'
        db.alter_column('orders_order', 'medium', self.gf('django.db.models.fields.CharField')(max_length=5, blank=True))
    ...
    models = {
        ...
        'orders.order': {
            ...
            'support_state': ('django.db.models.fields.CharField', [], {'default': "'new'", 'max_length': '15'}),
