...
class RobinageFeed(Feed):
	...
	url = 'http://192.168.91.101:8080/listing/select?indent=on&version=2.2&q=make%3A%22american+comic+book%22+AND+isActive%3Atrue&start=0&rows=10&fl=*&qt=standard&wt=json&explainOther=&hl.fl='
        ...
        for product in prods:
            ...
            data['cleaned_data']['brand'] = Brand.objects.get(name='american comic book')
