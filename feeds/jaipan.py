...
class JaipanFeed(Feed):
	...
	url = 'http://192.168.91.101:8080/listing/select?indent=on&version=2.2&q=userId%3A189241+AND+isActive%3Atrue&start=0&rows=100&fl=*&qt=standard&wt=json&explainOther=&hl.fl='
