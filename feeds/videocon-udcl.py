...
class VideoconFeed(Feed):
    config = {
            'ACCOUNT': 'videocon-udcl',
            }
    ...
    def parse(self, sync, *args, **kwargs):
        ...
        url = 'http://192.168.91.101:8080/listing/select?indent=on&version=2.2&q=userId%3A207697+AND+isActive%3Atrue&start=0&rows=500&fl=*&qt=standard&wt=json&explainOther=&hl.fl='
