...
class RobinageFeed(Feed):
	...
	url = 'http://192.168.91.101:8080/listing/select?indent=on&version=2.2&q=userId%3A188822+AND+isActive%3Atrue&start=0&rows=1000&fl=*&qt=standard&wt=json&explainOther=&hl.fl='
        ...
        for product in prods:
            ...
            data['cleaned_data']['brand'] = Brand.objects.get(name='macmillan')
