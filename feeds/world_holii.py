...
class WHoliiFeed(Feed):
    ...
    def get_feature_group(self):
        try:
            get_feature_group = FeatureGroup.objects.get(name = 'World Holii Specifications', product_type = ProductType.objects.get(type = 'HandBags'))
        except FeatureGroup.DoesNotExist:
            get_feature_group = FeatureGroup(name = 'World Holii Specifications', product_type = ProductType.objects.get(type = 'HandBags'))
