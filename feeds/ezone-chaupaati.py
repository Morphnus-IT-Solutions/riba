...
class eZoneFeed(Feed):
    config = {
            ...
            'URL': {
                ...
                #'electronic-deals':'http://www.futurebazaar.com/atom?name=FutureBazaar&cat=Electronic+Deals',
                #'home-deals':'http://www.futurebazaar.com/atom?name=FutureBazaar&cat=Home+Deals',
                #'fashion-deals':'http://www.futurebazaar.com/atom?name=FutureBazaar&cat=Fashion+Deals'
                },
            'TYPE': 'XML'
            }
