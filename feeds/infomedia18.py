...
class RobinageFeed(Feed):
    ...
    def parse(self, sync, *args, **kwargs):
        ...
        url = 'http://192.168.91.101:8080/listing/select?indent=on&version=2.2&q=userId%3A144831+AND+isActive%3Atrue&start=0&rows=100&fl=*&qt=standard&wt=json&explainOther=&hl.fl='
        ...
        for product in prods:
            ...
            # single value fields
            single_value_fields = ['id','sku','brand','description','mrp','askingPrice','title','shippingDuration','gifts']
            ...
            data['cleaned_data']['brand'] = Brand.objects.get(name='infomedia18')
            ...
            data['cleaned_data']['gift_title'] = data['gifts']
