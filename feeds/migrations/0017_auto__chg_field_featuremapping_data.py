...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeatureMapping.data'
        db.alter_column('feeds_featuremapping', 'data', self.gf('django.db.models.fields.CharField')(max_length=1000, blank=True))


    def backwards(self, orm):
        
        # Changing field 'FeatureMapping.data'
        db.alter_column('feeds_featuremapping', 'data', self.gf('django.db.models.fields.CharField')(max_length=1000))
