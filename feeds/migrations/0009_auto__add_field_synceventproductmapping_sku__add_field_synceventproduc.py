...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SyncEventProductMapping.sku'
        db.add_column('feeds_synceventproductmapping', 'sku', self.gf('django.db.models.fields.CharField')(default='', max_length=100, db_index=True, blank=True), keep_default=False)

        # Adding field 'SyncEventProductMapping.item_title'
        db.add_column('feeds_synceventproductmapping', 'item_title', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'SyncEventRateChartMapping.sku'
        db.add_column('feeds_synceventratechartmapping', 'sku', self.gf('django.db.models.fields.CharField')(default='', max_length=100, db_index=True, blank=True), keep_default=False)

        # Adding field 'SyncEventRateChartMapping.item_title'
        db.add_column('feeds_synceventratechartmapping', 'item_title', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SyncEventProductMapping.sku'
        db.delete_column('feeds_synceventproductmapping', 'sku')

        # Deleting field 'SyncEventProductMapping.item_title'
        db.delete_column('feeds_synceventproductmapping', 'item_title')

        # Deleting field 'SyncEventRateChartMapping.sku'
        db.delete_column('feeds_synceventratechartmapping', 'sku')

        # Deleting field 'SyncEventRateChartMapping.item_title'
        db.delete_column('feeds_synceventratechartmapping', 'item_title')
    ...
    models = {
        ...
        'feeds.synceventproductmapping': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item_title': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Product']"}),
