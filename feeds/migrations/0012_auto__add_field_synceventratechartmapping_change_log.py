...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SyncEventRateChartMapping.change_log'
        db.add_column('feeds_synceventratechartmapping', 'change_log', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SyncEventRateChartMapping.change_log'
        db.delete_column('feeds_synceventratechartmapping', 'change_log')
