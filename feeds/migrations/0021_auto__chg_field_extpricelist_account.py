...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'ExtPricelist.account' to match new field type.
        db.rename_column('feeds_extpricelist', 'account', 'account_id')
        # Changing field 'ExtPricelist.account'
        db.alter_column('feeds_extpricelist', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account']))


    def backwards(self, orm):
        
        # Renaming column for 'ExtPricelist.account' to match new field type.
        db.rename_column('feeds_extpricelist', 'account_id', 'account')
        # Changing field 'ExtPricelist.account'
        db.alter_column('feeds_extpricelist', 'account', self.gf('django.db.models.fields.CharField')(max_length=100))
