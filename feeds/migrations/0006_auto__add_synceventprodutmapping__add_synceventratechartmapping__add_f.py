...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SyncEventProdutMapping'
        db.create_table('feeds_synceventprodutmapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sync_event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feeds.SyncEvent'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Product'])),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=25, db_index=True)),
        ))
        db.send_create_signal('feeds', ['SyncEventProdutMapping'])

        # Adding model 'SyncEventRateChartMapping'
        db.create_table('feeds_synceventratechartmapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sync_event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feeds.SyncEvent'])),
            ('rate_chart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SellerRateChart'])),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=25, db_index=True)),
        ))
        db.send_create_signal('feeds', ['SyncEventRateChartMapping'])

        # Adding field 'SyncEvent.new_masters'
        db.add_column('feeds_syncevent', 'new_masters', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'SyncEventProdutMapping'
        db.delete_table('feeds_synceventprodutmapping')

        # Deleting model 'SyncEventRateChartMapping'
        db.delete_table('feeds_synceventratechartmapping')

        # Deleting field 'SyncEvent.new_masters'
        db.delete_column('feeds_syncevent', 'new_masters')
    ...
    models = {
        ...
        'feeds.synceventprodutmapping': {
            'Meta': {'object_name': 'SyncEventProdutMapping'},
