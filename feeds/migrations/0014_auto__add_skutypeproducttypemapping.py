...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SkuTypeProductTypeMapping'
        db.create_table('feeds_skutypeproducttypemapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('sku_type', self.gf('django.db.models.fields.CharField')(max_length=200, db_index=True)),
            ('product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.ProductType'])),
        ))
        db.send_create_signal('feeds', ['SkuTypeProductTypeMapping'])


    def backwards(self, orm):
        
        # Deleting model 'SkuTypeProductTypeMapping'
        db.delete_table('feeds_skutypeproducttypemapping')
