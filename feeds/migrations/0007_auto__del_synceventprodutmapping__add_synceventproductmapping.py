...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SyncEventProductMapping'
        db.create_table('feeds_synceventproductmapping', (
        ...
        db.send_create_signal('feeds', ['SyncEventProductMapping'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SyncEventProductMapping'
        db.delete_table('feeds_synceventproductmapping')
