...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'APIResponse'
        db.create_table('feeds_apiresponse', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('feeds', ['APIResponse'])


    def backwards(self, orm):
        
        # Deleting model 'APIResponse'
        db.delete_table('feeds_apiresponse')
