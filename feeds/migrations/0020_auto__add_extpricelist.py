...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExtPricelist'
        db.create_table('feeds_extpricelist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rate_chart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SellerRateChart'])),
            ('priceList', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pricing.PriceList'])),
        ...
        db.send_create_signal('feeds', ['ExtPricelist'])


    def backwards(self, orm):
        
        # Deleting model 'ExtPricelist'
        db.delete_table('feeds_extpricelist')
