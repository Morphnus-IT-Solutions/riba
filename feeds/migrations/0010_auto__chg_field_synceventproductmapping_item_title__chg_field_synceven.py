...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SyncEventProductMapping.item_title'
        db.alter_column('feeds_synceventproductmapping', 'item_title', self.gf('django.db.models.fields.CharField')(max_length=1000, blank=True))

        # Changing field 'SyncEventRateChartMapping.item_title'
        db.alter_column('feeds_synceventratechartmapping', 'item_title', self.gf('django.db.models.fields.CharField')(max_length=1000, blank=True))


    def backwards(self, orm):
        
        # Changing field 'SyncEventProductMapping.item_title'
        db.alter_column('feeds_synceventproductmapping', 'item_title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))

        # Changing field 'SyncEventRateChartMapping.item_title'
        db.alter_column('feeds_synceventratechartmapping', 'item_title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))
