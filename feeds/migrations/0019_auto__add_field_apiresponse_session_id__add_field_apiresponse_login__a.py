...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'APIResponse.session_id'
        db.add_column('feeds_apiresponse', 'session_id', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'APIResponse.login'
        db.add_column('feeds_apiresponse', 'login', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'APIResponse.order_id'
        db.add_column('feeds_apiresponse', 'order_id', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'APIResponse.url'
        db.add_column('feeds_apiresponse', 'url', self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True), keep_default=False)

        # Adding field 'APIResponse.post'
        db.add_column('feeds_apiresponse', 'post', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'APIResponse.response'
        db.add_column('feeds_apiresponse', 'response', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'APIResponse.session_id'
        db.delete_column('feeds_apiresponse', 'session_id')

        # Deleting field 'APIResponse.login'
        db.delete_column('feeds_apiresponse', 'login')

        # Deleting field 'APIResponse.order_id'
        db.delete_column('feeds_apiresponse', 'order_id')

        # Deleting field 'APIResponse.url'
        db.delete_column('feeds_apiresponse', 'url')

        # Deleting field 'APIResponse.post'
        db.delete_column('feeds_apiresponse', 'post')

        # Deleting field 'APIResponse.response'
        db.delete_column('feeds_apiresponse', 'response')
    ...
    models = {
        ...
        'feeds.featuremapping': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sku_type': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
