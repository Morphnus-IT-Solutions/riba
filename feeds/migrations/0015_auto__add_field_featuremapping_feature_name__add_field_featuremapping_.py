...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeatureMapping.feature_name'
        db.add_column('feeds_featuremapping', 'feature_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'FeatureMapping.sku_type'
        db.add_column('feeds_featuremapping', 'sku_type', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FeatureMapping.feature_name'
        db.delete_column('feeds_featuremapping', 'feature_name')

        # Deleting field 'FeatureMapping.sku_type'
        db.delete_column('feeds_featuremapping', 'sku_type')
