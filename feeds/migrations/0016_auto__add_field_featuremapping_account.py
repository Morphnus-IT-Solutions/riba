...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeatureMapping.account'
        db.add_column('feeds_featuremapping', 'account', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FeatureMapping.account'
        db.delete_column('feeds_featuremapping', 'account')
