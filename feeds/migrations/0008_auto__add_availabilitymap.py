...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AvailabilityMap'
        db.create_table('feeds_availabilitymap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('category', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=200, blank=True)),
            ('brand', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=200, blank=True)),
            ('sku', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=200, blank=True)),
            ('applies_to', self.gf('django.db.models.fields.CharField')(default='account', max_length=25, db_index=True)),
            ('availability', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Availability'])),
        ))
        db.send_create_signal('feeds', ['AvailabilityMap'])


    def backwards(self, orm):
        
        # Deleting model 'AvailabilityMap'
        db.delete_table('feeds_availabilitymap')
