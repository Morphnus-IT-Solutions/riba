...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SubscriptionSync'
        db.create_table('feeds_subscriptionsync', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ext_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('account', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
        ))
        db.send_create_signal('feeds', ['SubscriptionSync'])


    def backwards(self, orm):
        
        # Deleting model 'SubscriptionSync'
        db.delete_table('feeds_subscriptionsync')
