...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SyncEvent'
        db.create_table('feeds_syncevent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='running', max_length=25)),
            ...
            ('found', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('adds', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('deletes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('edits', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('feeds', ['SyncEvent'])


    def backwards(self, orm):
        
        # Deleting model 'SyncEvent'
        db.delete_table('feeds_syncevent')
