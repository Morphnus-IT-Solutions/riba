...
class RobinageFeed(Feed):
    ...
    def parse(self, sync, *args, **kwargs):
        ...
        #ibh url = 'http://192.168.91.101:8080/listing/select?indent=on&version=2.2&q=make%3Aibh+AND+isActive%3Atrue&start=0&rows=2000&fl=*%2Cscore&qt=standard&wt=json&explainOther=&hl.fl='
	
	url = 'http://192.168.91.101:8080/listing/select?indent=on&version=2.2&q=make%3Arobinage+AND+isActive%3Atrue&start=0&rows=100&fl=*%2Cscore&qt=standard&wt=json&explainOther=&hl.fl='
        ...
        for product in prods:
            ...
            # single value fields
            single_value_fields = ['id','sku','brand','description','mrp','askingPrice','title']
