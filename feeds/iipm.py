...
class IIPMFeed(Feed):
    ...
    def parse(self, sync, *args, **kwargs):
        ...
        url = 'http://192.168.91.101:8080/listing/select?indent=on&version=2.2&q=userId%3A188004+AND+isActive%3Atrue&start=0&rows=10&fl=*%2Cscore&qt=standard&wt=json&explainOther=&hl.fl='
