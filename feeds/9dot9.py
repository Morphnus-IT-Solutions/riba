...
class RobinageFeed(Feed):
	...
	url = 'http://192.168.91.101:8080/listing/select?indent=on&version=2.2&q=userId%3A129913+AND+isActive%3Atrue&start=0&rows=100&fl=*%2Cscore&qt=standard&wt=json&explainOther=&hl.fl='
        ...
        for product in prods:
            ...
            data['cleaned_data']['brand'] = Brand.objects.get(name='9dot9')
