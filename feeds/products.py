...
class ToysFeed(Feed):
    ...
    def parse(self, sync, *args, **kwargs):
        ...
        #casio url = 'http://192.168.91.101:8080/listing/select?indent=on&version=2.2&q=userId%3A189046+AND+isActive%3Atrue&start=0&rows=1000&fl=*&qt=standard&wt=json&explainOther=&hl.fl='
        #funskool url = 'http://192.168.91.101:8080/listing/select?indent=on&version=2.2&q=userId%3A209685+AND+isActive%3Atrue&start=0&rows=1000&fl=*&qt=standard&wt=json&explainOther=&hl.fl='
        #iken url = 'http://192.168.91.101:8080/listing/select?indent=on&version=2.2&q=userId%3A182830+AND+isActive%3Atrue&start=0&rows=1000&fl=*&qt=standard&wt=json&explainOther=&hl.fl='
        #skillofun url = 'http://192.168.91.101:8080/listing/select?indent=on&version=2.2&q=userId%3A218956+AND+isActive%3Atrue&start=0&rows=1000&fl=*&qt=standard&wt=json&explainOther=&hl.fl='

        #vu url = 'http://192.168.91.101:8080/listing/select?indent=on&version=2.2&q=userId%3A190526+AND+isActive%3Atrue&start=0&rows=1000&fl=*&qt=standard&wt=json&explainOther=&hl.fl='

        url = 'http://192.168.91.101:8080/listing/select?indent=on&version=2.2&q=userId%3A215944+AND+isActive%3Atrue&start=0&rows=1000&fl=*&qt=standard&wt=json&explainOther=&hl.fl='
        ...
        for product in prods:
            ...
            # single value fields
            single_value_fields = ['id','sku','brand','make','description','mrp','askingPrice','title','shippingDuration']
