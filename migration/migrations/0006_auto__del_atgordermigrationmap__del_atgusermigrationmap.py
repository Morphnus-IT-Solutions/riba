...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('migration_atgordermigrationmap', (
            ...
            ('atg_order', self.gf('django.db.models.fields.CharField')(max_length=40, unique=True, db_index=True)),
        ...
        db.create_table('migration_atgusermigrationmap', (
            ...
            ('atg_login', self.gf('django.db.models.fields.CharField')(max_length=40, unique=True, db_index=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
