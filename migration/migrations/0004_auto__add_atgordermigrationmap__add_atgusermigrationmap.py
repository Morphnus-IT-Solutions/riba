...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AtgOrderMigrationMap'
        db.create_table('migration_atgordermigrationmap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Order'], unique=True)),
            ('atg_order', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40, db_index=True)),
        ))
        db.send_create_signal('migration', ['AtgOrderMigrationMap'])

        # Adding model 'AtgUserMigrationMap'
        db.create_table('migration_atgusermigrationmap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'], unique=True)),
            ('atg_login', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40, db_index=True)),
        ))
        db.send_create_signal('migration', ['AtgUserMigrationMap'])


    def backwards(self, orm):
        
        # Deleting model 'AtgOrderMigrationMap'
        db.delete_table('migration_atgordermigrationmap')

        # Deleting model 'AtgUserMigrationMap'
        db.delete_table('migration_atgusermigrationmap')
    ...
    models = {
        ...
        'migration.atgordermigrationmap': {
            'Meta': {'object_name': 'AtgOrderMigrationMap'},
            'atg_order': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.Order']", 'unique': 'True'})
        },
        'migration.atgusermigrationmap': {
            'Meta': {'object_name': 'AtgUserMigrationMap'},
            'atg_login': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Profile']", 'unique': 'True'})
        },
