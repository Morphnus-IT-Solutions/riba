...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentAttempt.instrument_issue_bank'
        db.add_column('payments_paymentattempt', 'instrument_issue_bank', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True, default=None), keep_default=True)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PaymentAttempt.instrument_issue_bank'
        db.delete_column('payments_paymentattempt', 'instrument_issue_bank')
    ...
    models = {
        ...
        'payments.pointsheader': {
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 27, 12, 15, 4, 501208)'}),
