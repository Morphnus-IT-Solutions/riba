...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentAttempt.emi_plan'
        db.add_column('payments_paymentattempt', 'emi_plan', self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PaymentAttempt.emi_plan'
        db.delete_column('payments_paymentattempt', 'emi_plan')
    ...
    models = {
        ...
        'orders.order': {
            ...
            'wstore': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Account']"})
        },
