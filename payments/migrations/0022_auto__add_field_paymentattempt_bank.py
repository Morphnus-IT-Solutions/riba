...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('payments_paymentattempt', 'bank', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=True)
    ...
    models = {
        ...
        'payments.pointsheader': {
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 21, 11, 50, 27, 589393)'}),
