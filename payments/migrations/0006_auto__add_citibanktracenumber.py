...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CitiBankTraceNumber'
        db.create_table('payments_citibanktracenumber', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('payment_attempt', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['payments.PaymentAttempt'], unique=True)),
            ('trace_number', self.gf('django.db.models.fields.CharField')(max_length=6)),
        ))
        db.send_create_signal('payments', ['CitiBankTraceNumber'])


    def backwards(self, orm):
        
        # Deleting model 'CitiBankTraceNumber'
        db.delete_table('payments_citibanktracenumber')
    ...
    models = {
        ...
        'payments.citibanktracenumber': {
            ...
            'trace_number': ('django.db.models.fields.CharField', [], {'max_length': '6'})
        },
