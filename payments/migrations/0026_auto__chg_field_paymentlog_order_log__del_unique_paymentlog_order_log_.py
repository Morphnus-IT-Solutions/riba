...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'payments.paymentlog': {
            ...
            'notes': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'order_log': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payment_log'", 'to': "orm['orders.OrderLog']"}),
        ...
        'payments.pointsheader': {
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 17, 5, 32, 330666)'}),
        ...
        'payments.refundlog': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'order_log': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'refund_log'", 'to': "orm['orders.OrderLog']"}),
