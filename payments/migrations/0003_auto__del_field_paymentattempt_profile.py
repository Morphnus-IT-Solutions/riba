...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PaymentAttempt.profile'
        db.delete_column('payments_paymentattempt', 'profile_id')


    def backwards(self, orm):
        
        # Adding field 'PaymentAttempt.profile'
        db.add_column('payments_paymentattempt', 'profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'], null=True, blank=True), keep_default=False)
