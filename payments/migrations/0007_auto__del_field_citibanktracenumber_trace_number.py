...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CitiBankTraceNumber.trace_number'
        db.delete_column('payments_citibanktracenumber', 'trace_number')


    def backwards(self, orm):
        
        # Adding field 'CitiBankTraceNumber.trace_number'
        db.add_column('payments_citibanktracenumber', 'trace_number', self.gf('django.db.models.fields.CharField')(default=1, max_length=6), keep_default=False)
