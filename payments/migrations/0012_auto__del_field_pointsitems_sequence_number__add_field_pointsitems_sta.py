...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PointsItems.sequence_number'
        #db.delete_column('payments_pointsitems', 'sequence_number')

        # Adding field 'PointsItems.status'
        #db.add_column('payments_pointsitems', 'status', self.gf('django.db.models.fields.CharField')(default='FRESH', max_length=10), keep_default=True)

        # Adding field 'PointsHeader.reason'
        #db.add_column('payments_pointsheader', 'reason',
        #self.gf('django.db.models.fields.TextField')(null=True, blank=True),
        #keep_default=True)

        # Adding field 'PaymentAttempt.fraud_status'
        #db.add_column('payments_paymentattempt', 'fraud_status', self.gf('django.db.models.fields.CharField')(default='', max_length=25, null=True, blank=True), keep_default=True)
        pass
    
    def backwards(self, orm):
        
        # Adding field 'PointsItems.sequence_number'
        #db.add_column('payments_pointsitems', 'sequence_number', self.gf('django.db.models.fields.IntegerField')(default=None, max_length=10), keep_default=False)

        # Deleting field 'PointsItems.status'
        db.delete_column('payments_pointsitems', 'status')

        # Deleting field 'PointsHeader.reason'
        db.delete_column('payments_pointsheader', 'reason')

        # Deleting field 'PaymentAttempt.fraud_status'
        db.delete_column('payments_paymentattempt', 'fraud_status')
    ...
    models = {
        ...
        'payments.pointsheader': {
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 7, 17, 0, 31, 597333)'}),
