...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StoreValue'
        db.create_table('payments_storevalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['users.Profile'], unique=True)),
            ('credit_available', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
        ))
        db.send_create_signal('payments', ['StoreValue'])

        # Adding model 'StoreValueLog'
        db.create_table('payments_storevaluelog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('store_value', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payments.StoreValue'])),
            ('transaction_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('payments', ['StoreValueLog'])


    def backwards(self, orm):
        
        # Deleting model 'StoreValue'
        db.delete_table('payments_storevalue')

        # Deleting model 'StoreValueLog'
        db.delete_table('payments_storevaluelog')
    ...
    models = {
        ...
        'payments.pointsheader': {
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 12, 17, 36, 9, 971036)'}),
