...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentAttempt.notes'
        db.add_column('payments_paymentattempt', 'notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True, default=None), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'PaymentAttempt.notes'
        db.delete_column('payments_paymentattempt', 'notes')
    ...
    models = {
        ...
        'payments.pointsheader': {
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 9, 17, 49, 33, 685086)'}),
