...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('payments_paymentattempt', 'fraud_status', self.gf('django.db.models.fields.CharField')(default='', max_length=25, null=True, blank=True), keep_default=False)
