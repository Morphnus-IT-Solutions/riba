...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentAttempt.currency'
        db.add_column('payments_paymentattempt', 'currency', self.gf('django.db.models.fields.CharField')(default='INR', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PaymentAttempt.currency'
        db.delete_column('payments_paymentattempt', 'currency')
