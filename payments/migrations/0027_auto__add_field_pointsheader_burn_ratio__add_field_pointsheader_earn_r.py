...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PointsHeader.burn_ratio'
        db.add_column('payments_pointsheader', 'burn_ratio', self.gf('django.db.models.fields.DecimalField')(default='4', max_digits=12, decimal_places=2), keep_default=True)

        # Adding field 'PointsHeader.earn_ratio'
        db.add_column('payments_pointsheader', 'earn_ratio', self.gf('django.db.models.fields.DecimalField')(default='0.03', max_digits=12, decimal_places=2), keep_default=True)

        # Changing field 'PaymentLog.order_log'
        db.alter_column('payments_paymentlog', 'order_log_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['orders.OrderLog']))

        # Adding unique constraint on 'PaymentLog', fields ['order_log']
        db.create_unique('payments_paymentlog', ['order_log_id'])

        # Changing field 'RefundLog.order_log'
        db.alter_column('payments_refundlog', 'order_log_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['orders.OrderLog']))

        # Adding unique constraint on 'RefundLog', fields ['order_log']
        db.create_unique('payments_refundlog', ['order_log_id'])


    def backwards(self, orm):
        
        # Deleting field 'PointsHeader.burn_ratio'
        db.delete_column('payments_pointsheader', 'burn_ratio')

        # Deleting field 'PointsHeader.earn_ratio'
        db.delete_column('payments_pointsheader', 'earn_ratio')

        # Changing field 'PaymentLog.order_log'
        db.alter_column('payments_paymentlog', 'order_log_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.OrderLog']))

        # Removing unique constraint on 'PaymentLog', fields ['order_log']
        db.delete_unique('payments_paymentlog', ['order_log_id'])

        # Changing field 'RefundLog.order_log'
        db.alter_column('payments_refundlog', 'order_log_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.OrderLog']))

        # Removing unique constraint on 'RefundLog', fields ['order_log']
        db.delete_unique('payments_refundlog', ['order_log_id'])
    ...
    models = {
        ...
        'payments.paymentattempt': {
            ...
            'bank': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'gateway': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instrument_issue_bank': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'instrument_recv_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.Order']", 'null': 'True', 'blank': 'True'}),
            'payment_mode': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
        ...
        'payments.paymentlog': {
            ...
            'amount': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instrument_issue_bank': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'instrument_no': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'instrument_recv_date': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'order_log': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'payment_log'", 'unique': 'True', 'to': "orm['orders.OrderLog']"}),
            'payment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payment_log'", 'to': "orm['payments.PaymentAttempt']"}),
            'pg_transaction_id': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        'payments.pointsheader': {
            ...
            'burn_ratio': ('django.db.models.fields.DecimalField', [], {'default': "'4'", 'max_digits': '12', 'decimal_places': '2'}),
            'earn_ratio': ('django.db.models.fields.DecimalField', [], {'default': "'0.03'", 'max_digits': '12', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 16, 12, 0, 42, 470659)'}),
        ...
        'payments.refundlog': {
            'Meta': {'object_name': 'RefundLog'},
            'amount': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'order_log': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'refund_log'", 'unique': 'True', 'to': "orm['orders.OrderLog']"}),
            'refund': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'refund_log'", 'to': "orm['payments.Refund']"}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        'payments.storevalue': {
