...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PointsItems'
        db.create_table('payments_pointsitems', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('points_header', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payments.PointsHeader'])),
            ('order_item', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['orders.OrderItem'], unique=True)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(max_length=10)),
            ('sequence_number', self.gf('django.db.models.fields.IntegerField')(max_length=10)),
            ('department_code', self.gf('django.db.models.fields.IntegerField')(max_length=10)),
            ('department_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('item_amount', self.gf('django.db.models.fields.IntegerField')(max_length=10)),
            ('article_id', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('action_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('payments', ['PointsItems'])

        # Adding model 'PointsHeader'
        db.create_table('payments_pointsheader', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Order'])),
            ('reference_id', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('loyalty_card', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True)),
            ('partner_merchant_id', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('partner_terminal_id', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('txn_action_code', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('txn_classification_code', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('txn_payment_type', self.gf('django.db.models.fields.CharField')(default='OTHERS', max_length=20)),
            ('txn_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ...
            ('settlement_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('txn_value', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True)),
            ('marketing_code', self.gf('django.db.models.fields.CharField')(default='DEFAULT', max_length=10)),
            ('branch_id', self.gf('django.db.models.fields.CharField')(default='ONLINE', max_length=10)),
            ('txn_points', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='FRESH', max_length=10)),
        ))
        db.send_create_signal('payments', ['PointsHeader'])


    def backwards(self, orm):
        
        # Deleting model 'PointsItems'
        db.delete_table('payments_pointsitems')

        # Deleting model 'PointsHeader'
        db.delete_table('payments_pointsheader')
    ...
    models = {
        ...
        'payments.pointsheader': {
            ...
            'settlement_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
