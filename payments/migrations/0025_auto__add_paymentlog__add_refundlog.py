...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('payments_paymentlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('payment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment_log', to=orm['payments.PaymentAttempt'])),
            ('order_log', self.gf('django.db.models.fields.related.OneToOneField')(related_name='payment_log', unique=True, to=orm['orders.OrderLog'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('pg_transaction_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True)),
            ('instrument_no', self.gf('django.db.models.fields.CharField')(default=None, max_length=10, null=True, blank=True)),
            ('instrument_issue_bank', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True)),
            ('instrument_recv_date', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('payments', ['PaymentLog'])

        # Adding model 'RefundLog'
        db.create_table('payments_refundlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('refund', self.gf('django.db.models.fields.related.ForeignKey')(related_name='refund_log', to=orm['payments.Refund'])),
            ('order_log', self.gf('django.db.models.fields.related.OneToOneField')(related_name='refund_log', unique=True, to=orm['orders.OrderLog'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('payments', ['RefundLog'])


    def backwards(self, orm):
        
        # Deleting model 'PaymentLog'
        db.delete_table('payments_paymentlog')

        # Deleting model 'RefundLog'
        db.delete_table('payments_refundlog')
    ...
    models = {
        ...
        'payments.pointsheader': {
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 20, 18, 40, 50, 94454)'}),
