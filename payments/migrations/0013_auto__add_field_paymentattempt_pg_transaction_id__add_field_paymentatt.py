...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentAttempt.pg_transaction_id'
        db.add_column('payments_paymentattempt', 'pg_transaction_id', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True, default=None), keep_default=True)

        # Adding field 'PaymentAttempt.instrument_no'
        db.add_column('payments_paymentattempt', 'instrument_no', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=50, null=True, blank=True, default=None), keep_default=True)

        # Adding field 'PaymentAttempt.bank'
        #db.add_column('payments_paymentattempt', 'bank', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'PaymentAttempt.instrument_date'
        db.add_column('payments_paymentattempt', 'instrument_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True, default=None), keep_default=True)

        # Adding field 'PaymentAttempt.instrument_received_by'
        db.add_column('payments_paymentattempt', 'instrument_received_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['users.Profile'], default=None), keep_default=True)

        # Changing field 'PaymentAttempt.response_detail'
        db.alter_column('payments_paymentattempt', 'response_detail', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Changing field 'PaymentAttempt.emi_plan'
        db.alter_column('payments_paymentattempt', 'emi_plan', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True))

        # Changing field 'PaymentAttempt.response'
        db.alter_column('payments_paymentattempt', 'response', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))

        # Changing field 'PaymentAttempt.transaction_id'
        db.alter_column('payments_paymentattempt', 'transaction_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'PaymentAttempt.pg_transaction_id'
        db.delete_column('payments_paymentattempt', 'pg_transaction_id')

        # Deleting field 'PaymentAttempt.instrument_no'
        db.delete_column('payments_paymentattempt', 'instrument_no')

        # Deleting field 'PaymentAttempt.bank'
        #db.delete_column('payments_paymentattempt', 'bank')

        # Deleting field 'PaymentAttempt.instrument_date'
        db.delete_column('payments_paymentattempt', 'instrument_date')

        # Deleting field 'PaymentAttempt.instrument_received_by'
        db.delete_column('payments_paymentattempt', 'instrument_received_by_id')

        # Changing field 'PaymentAttempt.response_detail'
        db.alter_column('payments_paymentattempt', 'response_detail', self.gf('django.db.models.fields.TextField')(blank=True))

        # Changing field 'PaymentAttempt.emi_plan'
        db.alter_column('payments_paymentattempt', 'emi_plan', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True))

        # Changing field 'PaymentAttempt.response'
        db.alter_column('payments_paymentattempt', 'response', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))

        # Changing field 'PaymentAttempt.transaction_id'
        db.alter_column('payments_paymentattempt', 'transaction_id', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'payments.pointsheader': {
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 8, 15, 44, 45, 488262)'}),
        ...
        'payments.pointsitems': {
            ...
            'action_code': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'article_id': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'department_code': ('django.db.models.fields.IntegerField', [], {'max_length': '10'}),
        ...
        'payments.refund': {
            ...
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.Order']"}),
            'order_items': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['orders.OrderItem']", 'null': 'True', 'blank': 'True'}),
