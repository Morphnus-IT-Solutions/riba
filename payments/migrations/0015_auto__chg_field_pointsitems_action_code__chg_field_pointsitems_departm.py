...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PointsItems.action_code'
        db.alter_column('payments_pointsitems', 'action_code', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'PointsItems.department_code'
        db.alter_column('payments_pointsitems', 'department_code', self.gf('django.db.models.fields.IntegerField')(max_length=20))

        # Changing field 'PointsItems.article_id'
        db.alter_column('payments_pointsitems', 'article_id', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'PointsItems.action_code'
        db.alter_column('payments_pointsitems', 'action_code', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'PointsItems.department_code'
        db.alter_column('payments_pointsitems', 'department_code', self.gf('django.db.models.fields.IntegerField')(max_length=10))

        # Changing field 'PointsItems.article_id'
        db.alter_column('payments_pointsitems', 'article_id', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'payments.pointsheader': {
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 10, 9, 17, 38, 299219)'}),
