...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'PaymentAttempt', fields ['created_on']
        db.create_index('payments_paymentattempt', ['created_on'])


    def backwards(self, orm):
        
        # Removing index on 'PaymentAttempt', fields ['created_on']
        db.delete_index('payments_paymentattempt', ['created_on'])
    ...
    models = {
        ...
        'payments.pointsheader': {
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 19, 1, 1, 35, 539647)'}),
