...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PointsHeader.created_on'
        #db.delete_column('payments_pointsheader', 'created_on')

        # Deleting field 'PointsHeader.modified_on'
        #db.delete_column('payments_pointsheader', 'modified_on')

        # Adding field 'PointsHeader.txn_timstamp'
        db.add_column('payments_pointsheader', 'txn_timstamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 11, 24, 17, 22, 42, 244555)), keep_default=True)

        # Changing field 'PointsHeader.settlement_date'
        db.alter_column('payments_pointsheader', 'settlement_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Adding field 'PointsHeader.created_on'
        #db.add_column('payments_pointsheader', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)

        # Adding field 'PointsHeader.modified_on'
        #db.add_column('payments_pointsheader', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)

        # Deleting field 'PointsHeader.txn_timstamp'
        db.delete_column('payments_pointsheader', 'txn_timstamp')

        # Changing field 'PointsHeader.settlement_date'
        db.alter_column('payments_pointsheader', 'settlement_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))
    ...
    models = {
        ...
        'payments.paymentattempt': {
            ...
            'emi_plan': ('django.db.models.fields.CharField', [], {'max_length': '2', 'blank': 'True'}),
        ...
        'payments.pointsheader': {
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 24, 17, 22, 42, 244555)'}),
        ...
        'payments.pointsitems': {
            ...
            'sequence_number': ('django.db.models.fields.IntegerField', [], {'max_length': '10'})
        },
        'payments.refund': {
