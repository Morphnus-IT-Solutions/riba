...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentAttempt.payment_mode'
        db.add_column('payments_paymentattempt', 'payment_mode', self.gf('django.db.models.fields.CharField')(default=None, null=True, blank=True, max_length=50, db_index=True), keep_default=True)

        # Adding field 'PaymentAttempt.payment_realized_on'
        db.add_column('payments_paymentattempt', 'payment_realized_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True, default=None), keep_default=True)

        # Changing field 'PaymentAttempt.gateway'
        db.alter_column('payments_paymentattempt', 'gateway', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'PaymentAttempt.payment_mode'
        db.delete_column('payments_paymentattempt', 'payment_mode')

        # Deleting field 'PaymentAttempt.payment_realized_on'
        db.delete_column('payments_paymentattempt', 'payment_realized_on')

        # Changing field 'PaymentAttempt.gateway'
        db.alter_column('payments_paymentattempt', 'gateway', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'payments.pointsheader': {
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 27, 13, 25, 3, 177244)'}),
