...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('payments_pointsitems', 'order_item', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['orders.OrderItem']), keep_default=True)
    ...
    models = {
        ...
        'payments.pointsheader': {
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 29, 23, 37, 3, 321519)'}),
