...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PointsItems.order_item'
        db.delete_column('payments_pointsitems', 'order_item_id')


    def backwards(self, orm):
        
        # Adding field 'PointsItems.order_item'
        db.add_column('payments_pointsitems', 'order_item', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['orders.OrderItem'], unique=True), keep_default=False)
    ...
    models = {
        ...
        'payments.pointsheader': {
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 29, 23, 36, 34, 72923)'}),
