...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentAttempt.instrument_recv_date'
        db.add_column('payments_paymentattempt', 'instrument_recv_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=True)


    def backwards(self, orm):
        
        # Adding field 'PaymentAttempt.instrument_date'
        db.add_column('payments_paymentattempt', 'instrument_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Deleting field 'PaymentAttempt.instrument_recv_date'
        db.delete_column('payments_paymentattempt', 'instrument_recv_date')
    ...
    models = {
        ...
        'payments.pointsheader': {
            ...
            'txn_timstamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 14, 12, 28, 59, 312742)'}),
