...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('payouts_configurations', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('service_tax', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=5, decimal_places=2)),
        ))
        db.send_create_signal('payouts', ['Configurations'])

        # Adding model 'SellerPayout'
        db.create_table('payouts_sellerpayout', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('seller', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'])),
            ('shipping_charges', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('gateway_charges', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('chaupaati_discount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('seller_discount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('collected_amount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('applicable_amount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('commission_amount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('gross_payout', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('commission_invoice_amount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('net_payout', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
        ))
        db.send_create_signal('payouts', ['SellerPayout'])

        # Adding model 'SellerPayoutDetails'
        db.create_table('payouts_sellerpayoutdetails', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('seller', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'])),
            ('order_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.OrderItem'])),
            ('sale_price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('shipping_charges', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('gateway_charges', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('chaupaati_discount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
            ('seller_discount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2)),
        ...
        db.send_create_signal('payouts', ['SellerPayoutDetails'])


    def backwards(self, orm):
        
        # Deleting model 'Configurations'
        db.delete_table('payouts_configurations')

        # Deleting model 'SellerPayout'
        db.delete_table('payouts_sellerpayout')

        # Deleting model 'SellerPayoutDetails'
        db.delete_table('payouts_sellerpayoutdetails')
