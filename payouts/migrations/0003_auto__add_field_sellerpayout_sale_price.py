...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerPayout.sale_price'
        db.add_column('payouts_sellerpayout', 'sale_price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=22, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SellerPayout.sale_price'
        db.delete_column('payouts_sellerpayout', 'sale_price')
