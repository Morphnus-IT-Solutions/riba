...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerPayout.year'
        db.add_column('payouts_sellerpayout', 'year', self.gf('django.db.models.fields.IntegerField')(default=2010), keep_default=False)

        # Adding field 'SellerPayout.month'
        db.add_column('payouts_sellerpayout', 'month', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2), keep_default=False)

        # Adding field 'SellerPayoutDetails.year'
        db.add_column('payouts_sellerpayoutdetails', 'year', self.gf('django.db.models.fields.IntegerField')(default=2010), keep_default=False)

        # Adding field 'SellerPayoutDetails.month'
        db.add_column('payouts_sellerpayoutdetails', 'month', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SellerPayout.year'
        db.delete_column('payouts_sellerpayout', 'year')

        # Deleting field 'SellerPayout.month'
        db.delete_column('payouts_sellerpayout', 'month')

        # Deleting field 'SellerPayoutDetails.year'
        db.delete_column('payouts_sellerpayoutdetails', 'year')

        # Deleting field 'SellerPayoutDetails.month'
        db.delete_column('payouts_sellerpayoutdetails', 'month')
