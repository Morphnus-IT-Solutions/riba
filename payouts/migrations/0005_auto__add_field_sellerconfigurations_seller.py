...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerConfigurations.seller'
        db.add_column('payouts_sellerconfigurations', 'seller', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['accounts.Account']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SellerConfigurations.seller'
        db.delete_column('payouts_sellerconfigurations', 'seller_id')
