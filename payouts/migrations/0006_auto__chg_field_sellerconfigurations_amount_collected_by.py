...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SellerConfigurations.amount_collected_by'
        db.alter_column('payouts_sellerconfigurations', 'amount_collected_by', self.gf('django.db.models.fields.CharField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'SellerConfigurations.amount_collected_by'
        db.alter_column('payouts_sellerconfigurations', 'amount_collected_by', self.gf('django.db.models.fields.TextField')(max_length=10))
    ...
    models = {
        ...
        'payouts.sellerconfigurations': {
            ...
            'amount_collected_by': ('django.db.models.fields.CharField', [], {'default': "'chaupaati'", 'max_length': '10'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
