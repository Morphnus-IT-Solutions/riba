...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerRateChart.is_free_shipping'
        db.add_column('catalog_sellerratechart', 'is_free_shipping', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SellerRateChart.is_free_shipping'
        db.delete_column('catalog_sellerratechart', 'is_free_shipping')
