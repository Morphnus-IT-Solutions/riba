...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Inventory.starts_on'
        db.add_column('catalog_inventory', 'starts_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True, default=None), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'Inventory.starts_on'
        db.delete_column('catalog_inventory', 'starts_on')
