...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerRateChart.article_id'
        db.add_column('catalog_sellerratechart', 'article_id', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SellerRateChart.article_id'
        db.delete_column('catalog_sellerratechart', 'article_id')
