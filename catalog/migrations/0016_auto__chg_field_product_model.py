...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('catalog_product', 'model', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Product.model'
        db.alter_column('catalog_product', 'model', self.gf('django.db.models.fields.CharField')(max_length=100))
