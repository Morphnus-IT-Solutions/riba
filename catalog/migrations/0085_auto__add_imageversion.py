...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catalog_imageversion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('version', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=5, decimal_places=0)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Product'])),
        ))
        db.send_create_signal('catalog', ['ImageVersion'])


    def backwards(self, orm):
        
        # Deleting model 'ImageVersion'
        db.delete_table('catalog_imageversion')
    ...
    models = {
        ...
        'catalog.bundleproducts': {
            ...
            'rate_chart': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bundle_products'", 'to': "orm['catalog.SellerRateChart']"})
        },
        ...
        'catalog.imageversion': {
            'Meta': {'object_name': 'ImageVersion'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Product']"}),
            'version': ('django.db.models.fields.DecimalField', [], {'default': '1', 'max_digits': '5', 'decimal_places': '0'})
        },
        'catalog.inventory': {
