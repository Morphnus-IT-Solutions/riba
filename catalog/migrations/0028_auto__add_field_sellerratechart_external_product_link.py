...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerRateChart.external_product_link'
        db.add_column('catalog_sellerratechart', 'external_product_link', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SellerRateChart.external_product_link'
        db.delete_column('catalog_sellerratechart', 'external_product_link')
