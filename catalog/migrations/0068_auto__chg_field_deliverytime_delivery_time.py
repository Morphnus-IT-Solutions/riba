...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeliveryTime.delivery_time'
        db.alter_column('catalog_deliverytime', 'delivery_time', self.gf('django.db.models.fields.PositiveIntegerField')())


    def backwards(self, orm):
        
        # Changing field 'DeliveryTime.delivery_time'
        db.alter_column('catalog_deliverytime', 'delivery_time', self.gf('django.db.models.fields.IntegerField')())
