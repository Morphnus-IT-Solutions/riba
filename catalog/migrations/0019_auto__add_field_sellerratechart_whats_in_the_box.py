...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerRateChart.whats_in_the_box'
        db.add_column('catalog_sellerratechart', 'whats_in_the_box', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SellerRateChart.whats_in_the_box'
        db.delete_column('catalog_sellerratechart', 'whats_in_the_box')
