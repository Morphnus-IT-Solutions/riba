...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        return
        # Deleting field 'Inventory.physical_stock'
        db.delete_column('catalog_inventory', 'physical_stock')

        # Adding field 'Inventory.stock'
        db.add_column('catalog_inventory', 'stock', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True), keep_default=True)


    def backwards(self, orm):
        return
        # Adding field 'Inventory.physical_stock'
        db.add_column('catalog_inventory', 'physical_stock', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True), keep_default=False)

        # Deleting field 'Inventory.stock'
        db.delete_column('catalog_inventory', 'stock')
