...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BundleProducts'
        db.create_table('catalog_bundleproducts', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rate_chart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SellerRateChart'])),
            ('bundle_sku', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('catalog', ['BundleProducts'])


    def backwards(self, orm):
        
        # Deleting model 'BundleProducts'
        db.delete_table('catalog_bundleproducts')
