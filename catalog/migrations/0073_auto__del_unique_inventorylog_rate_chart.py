...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        return        
        # Removing unique constraint on 'InventoryLog', fields ['rate_chart']
        db.delete_unique('catalog_inventorylog', ['rate_chart_id'])


    def backwards(self, orm):
        return
        # Adding unique constraint on 'InventoryLog', fields ['rate_chart']
        db.create_unique('catalog_inventorylog', ['rate_chart_id'])
