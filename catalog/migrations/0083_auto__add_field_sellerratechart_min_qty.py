...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerRateChart.min_qty'
        db.add_column('catalog_sellerratechart', 'min_qty', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SellerRateChart.min_qty'
        db.delete_column('catalog_sellerratechart', 'min_qty')
