...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SellerRateChart.unit_transfer__price'
        db.delete_column('catalog_sellerratechart', 'unit_transfer__price')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'SellerRateChart.unit_transfer__price'
        db.add_column('catalog_sellerratechart', 'unit_transfer__price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2), keep_default=False)
