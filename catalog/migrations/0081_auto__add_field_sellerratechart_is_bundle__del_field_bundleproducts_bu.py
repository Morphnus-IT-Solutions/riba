...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerRateChart.is_bundle'
        db.add_column('catalog_sellerratechart', 'is_bundle', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=True)

        # Deleting field 'BundleProducts.bundle_sku'
        db.delete_column('catalog_bundleproducts', 'bundle_sku')

        # Adding field 'BundleProducts.bundle_src'
        db.add_column('catalog_bundleproducts', 'bundle_src', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', to=orm['catalog.SellerRateChart']), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'SellerRateChart.is_bundle'
        db.delete_column('catalog_sellerratechart', 'is_bundle')

        # Adding field 'BundleProducts.bundle_sku'
        db.add_column('catalog_bundleproducts', 'bundle_sku', self.gf('django.db.models.fields.CharField')(default=None, max_length=100), keep_default=False)

        # Deleting field 'BundleProducts.bundle_src'
        db.delete_column('catalog_bundleproducts', 'bundle_src_id')
    ...
    models = {
        ...
        'catalog.bundleproducts': {
            ...
            'bundle_src': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['catalog.SellerRateChart']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'qty': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'rate_chart': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['catalog.SellerRateChart']"})
        },
        ...
        'catalog.inventory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rate_chart': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'unique': 'True', 'to': "orm['catalog.SellerRateChart']"}),
