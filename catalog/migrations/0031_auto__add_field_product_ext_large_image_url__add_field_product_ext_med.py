...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.ext_large_image_url'
        db.add_column('catalog_product', 'ext_large_image_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Product.ext_medium_image_url'
        db.add_column('catalog_product', 'ext_medium_image_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Product.ext_small_image_url'
        db.add_column('catalog_product', 'ext_small_image_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.ext_large_image_url'
        db.delete_column('catalog_product', 'ext_large_image_url')

        # Deleting field 'Product.ext_medium_image_url'
        db.delete_column('catalog_product', 'ext_medium_image_url')

        # Deleting field 'Product.ext_small_image_url'
        db.delete_column('catalog_product', 'ext_small_image_url')
