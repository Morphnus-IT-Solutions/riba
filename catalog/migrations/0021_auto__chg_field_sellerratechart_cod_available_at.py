...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SellerRateChart.cod_available_at'
        db.alter_column('catalog_sellerratechart', 'cod_available_at_id', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['catalog.Availability']))


    def backwards(self, orm):
        
        # Changing field 'SellerRateChart.cod_available_at'
        db.alter_column('catalog_sellerratechart', 'cod_available_at_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalog.Availability']))
