...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.video_embed'
        db.add_column('catalog_product', 'video_embed', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.video_embed'
        db.delete_column('catalog_product', 'video_embed')
