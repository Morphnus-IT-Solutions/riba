...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BundleProducts.qty'
        db.add_column('catalog_bundleproducts', 'qty', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=True)

        # Adding field 'BundleProducts.active'
        db.add_column('catalog_bundleproducts', 'active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'BundleProducts.qty'
        db.delete_column('catalog_bundleproducts', 'qty')

        # Deleting field 'BundleProducts.active'
        db.delete_column('catalog_bundleproducts', 'active')
