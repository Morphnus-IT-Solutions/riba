...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'catalog.inventory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rate_chart': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.SellerRateChart']"}),
            'stock': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'})
        },
        'catalog.product': {
            ...
            'product_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fulfillment.ProductGroup']", 'null': 'True', 'blank': 'True'}),
        ...
        'fulfillment.productgroup': {
            ...
            'ship_mode': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fulfillment.ShipMode']"})
        },
        'fulfillment.shipmode': {
            'Meta': {'object_name': 'ShipMode'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'transport_mode': ('django.db.models.fields.CharField', [], {'max_length': '8'})
        },
        'lists.battletab': {
