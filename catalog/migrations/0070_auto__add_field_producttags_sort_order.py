...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductTags.sort_order'
        db.add_column('catalog_producttags', 'sort_order', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductTags.sort_order'
        db.delete_column('catalog_producttags', 'sort_order')
