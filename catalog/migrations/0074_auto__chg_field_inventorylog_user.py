...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InventoryLog.user'
        db.alter_column('catalog_inventorylog', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'InventoryLog.user'
        db.alter_column('catalog_inventorylog', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'], null=True, blank=True))
