...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductTags.tab'
        db.add_column('catalog_producttags', 'tab', self.gf('django.db.models.fields.related.ForeignKey')(default=-2011, to=orm['lists.Tab'], blank=True), keep_default=False)

        # Adding field 'ProductTags.display_name'
        db.add_column('catalog_producttags', 'display_name', self.gf('django.db.models.fields.CharField')(default=-2011, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductTags.tab'
        db.delete_column('catalog_producttags', 'tab_id')
    ...
    models = {
        ...
        'catalog.producttags': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Product']"}),
            'tab': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lists.Tab']", 'blank': 'True'}),
