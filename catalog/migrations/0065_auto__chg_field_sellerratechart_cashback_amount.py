...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SellerRateChart.cashback_amount'
        db.alter_column('catalog_sellerratechart', 'cashback_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True))


    def backwards(self, orm):
        
        # Changing field 'SellerRateChart.cashback_amount'
        db.alter_column('catalog_sellerratechart', 'cashback_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
