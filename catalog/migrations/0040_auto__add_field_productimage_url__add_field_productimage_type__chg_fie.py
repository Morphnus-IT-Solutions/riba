...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductImage.url'
        db.add_column('catalog_productimage', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'ProductImage.type'
        db.add_column('catalog_productimage', 'type', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)

        # Changing field 'ProductImage.image'
        db.alter_column('catalog_productimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'ProductImage.url'
        db.delete_column('catalog_productimage', 'url')

        # Deleting field 'ProductImage.type'
        db.delete_column('catalog_productimage', 'type')

        # Changing field 'ProductImage.image'
        db.alter_column('catalog_productimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
