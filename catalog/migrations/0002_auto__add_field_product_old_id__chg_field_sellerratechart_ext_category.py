...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SellerRateChart.ext_category_name'
        db.alter_column('catalog_sellerratechart', 'ext_category_name', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SellerRateChart.ext_category_name'
        db.alter_column('catalog_sellerratechart', 'ext_category_name', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True))
