...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('catalog_tag', 'id')

        # Changing field 'Tag.tag'
        db.alter_column('catalog_tag', 'tag', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True))

        # Adding unique constraint on 'Tag', fields ['tag']
        db.create_unique('catalog_tag', ['tag'])


    def backwards(self, orm):
        
        # Adding field 'Tag.id'
        db.add_column('catalog_tag', 'id', self.gf('django.db.models.fields.AutoField')(default='', primary_key=True), keep_default=False)

        # Changing field 'Tag.tag'
        db.alter_column('catalog_tag', 'tag', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Removing unique constraint on 'Tag', fields ['tag']
        db.delete_unique('catalog_tag', ['tag'])
    ...
    models = {
        ...
        'catalog.tag': {
            ...
            'tag': ('django.db.models.fields.CharField', [], {'max_length': '100', 'primary_key': 'True'})
        },
        'categories.category': {
