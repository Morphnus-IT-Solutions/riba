...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Brand.moderate'
        db.add_column('catalog_brand', 'moderate', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Brand.moderate'
        db.delete_column('catalog_brand', 'moderate')
