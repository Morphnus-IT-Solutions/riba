...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerRateChart.ship_local_only'
        db.add_column('catalog_sellerratechart', 'ship_local_only', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'SellerRateChart.home_deliverable'
        db.add_column('catalog_sellerratechart', 'home_deliverable', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'SellerRateChart.otc'
        db.add_column('catalog_sellerratechart', 'otc', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SellerRateChart.ship_local_only'
        db.delete_column('catalog_sellerratechart', 'ship_local_only')

        # Deleting field 'SellerRateChart.home_deliverable'
        db.delete_column('catalog_sellerratechart', 'home_deliverable')

        # Deleting field 'SellerRateChart.otc'
        db.delete_column('catalog_sellerratechart', 'otc')
