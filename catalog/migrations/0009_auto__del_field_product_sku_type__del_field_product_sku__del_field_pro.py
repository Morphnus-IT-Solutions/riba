...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.sku_type'
        db.delete_column('catalog_product', 'sku_type')

        # Deleting field 'Product.sku'
        db.delete_column('catalog_product', 'sku')

        # Deleting field 'Product.old_id'
        db.delete_column('catalog_product', 'old_id')

        # Adding field 'SellerRateChart.sku'
        db.add_column('catalog_sellerratechart', 'sku', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Product.sku_type'
        db.add_column('catalog_product', 'sku_type', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'Product.sku'
        db.add_column('catalog_product', 'sku', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Adding field 'Product.old_id'
        db.add_column('catalog_product', 'old_id', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Deleting field 'SellerRateChart.sku'
        db.delete_column('catalog_sellerratechart', 'sku')
