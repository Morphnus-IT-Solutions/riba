...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Brand.tagline'
        db.add_column('catalog_brand', 'tagline', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True), keep_default=False)

        # Adding field 'Brand.description'
        db.add_column('catalog_brand', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Brand.tagline'
        db.delete_column('catalog_brand', 'tagline')

        # Deleting field 'Brand.description'
        db.delete_column('catalog_brand', 'description')
