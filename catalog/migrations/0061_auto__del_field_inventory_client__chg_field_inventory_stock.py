...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Inventory.client'
        db.delete_column('catalog_inventory', 'client_id')

        # Changing field 'Inventory.stock'
        db.alter_column('catalog_inventory', 'stock', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True))


    def backwards(self, orm):
        
        # Adding field 'Inventory.client'
        db.add_column('catalog_inventory', 'client', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Client']), keep_default=False)

        # Changing field 'Inventory.stock'
        db.alter_column('catalog_inventory', 'stock', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=0, blank=True))
