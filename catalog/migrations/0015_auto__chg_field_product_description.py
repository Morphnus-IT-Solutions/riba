...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('catalog_product', 'description', self.gf('tinymce.models.HTMLField')())


    def backwards(self, orm):
        
        # Changing field 'Product.description'
        db.alter_column('catalog_product', 'description', self.gf('django.db.models.fields.TextField')())
