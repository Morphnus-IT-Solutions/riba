...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SellerRateChart.availibility'
        db.delete_column('catalog_sellerratechart', 'availibility_id')

        # Adding field 'SellerRateChart.availability'
        db.add_column('catalog_sellerratechart', 'availability', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['catalog.Availability']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'SellerRateChart.availibility'
        db.add_column('catalog_sellerratechart', 'availibility', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['catalog.Availability']), keep_default=False)

        # Deleting field 'SellerRateChart.availability'
        db.delete_column('catalog_sellerratechart', 'availability_id')
