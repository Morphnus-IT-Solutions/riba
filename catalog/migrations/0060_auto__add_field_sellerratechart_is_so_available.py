...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerRateChart.is_so_available'
        db.add_column('catalog_sellerratechart', 'is_so_available', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SellerRateChart.is_so_available'
        db.delete_column('catalog_sellerratechart', 'is_so_available')
    ...
    models = {
        ...
        'catalog.inventory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rate_chart': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.SellerRateChart']"}),
            'stock': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '0', 'blank': 'True'})
        },
        'catalog.product': {
