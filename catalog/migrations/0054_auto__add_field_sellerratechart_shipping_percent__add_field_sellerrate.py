...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerRateChart.shipping_percent'
        db.add_column('catalog_sellerratechart', 'shipping_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2), keep_default=False)

        # Adding field 'SellerRateChart.min_shipping'
        db.add_column('catalog_sellerratechart', 'min_shipping', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'SellerRateChart.max_shipping'
        db.add_column('catalog_sellerratechart', 'max_shipping', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SellerRateChart.shipping_percent'
        db.delete_column('catalog_sellerratechart', 'shipping_percent')

        # Deleting field 'SellerRateChart.min_shipping'
        db.delete_column('catalog_sellerratechart', 'min_shipping')

        # Deleting field 'SellerRateChart.max_shipping'
        db.delete_column('catalog_sellerratechart', 'max_shipping')
