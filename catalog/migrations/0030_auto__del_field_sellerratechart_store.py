...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SellerRateChart.store'
        db.delete_column('catalog_sellerratechart', 'store_id')


    def backwards(self, orm):
        
        # Adding field 'SellerRateChart.store'
        db.add_column('catalog_sellerratechart', 'store', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['categories.Store']), keep_default=False)
