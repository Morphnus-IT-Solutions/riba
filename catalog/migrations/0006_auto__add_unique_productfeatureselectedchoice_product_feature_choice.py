...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ProductFeatureSelectedChoice', fields ['product_feature', 'choice']
        db.create_unique('catalog_productfeatureselectedchoice', ['product_feature_id', 'choice_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ProductFeatureSelectedChoice', fields ['product_feature', 'choice']
        db.delete_unique('catalog_productfeatureselectedchoice', ['product_feature_id', 'choice_id'])
