...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.is_online'
        db.add_column('catalog_product', 'is_online', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.is_online'
        db.delete_column('catalog_product', 'is_online')
