...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerRateChart.short_desc'
        db.add_column('catalog_sellerratechart', 'short_desc', self.gf('tinymce.models.HTMLField')(null=True, blank=True), keep_default=False)

        # Adding field 'SellerRateChart.key_feature'
        db.add_column('catalog_sellerratechart', 'key_feature', self.gf('tinymce.models.HTMLField')(null=True, blank=True), keep_default=False)

        # Adding field 'SellerRateChart.detailed_desc'
        db.add_column('catalog_sellerratechart', 'detailed_desc', self.gf('tinymce.models.HTMLField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SellerRateChart.short_desc'
        db.delete_column('catalog_sellerratechart', 'short_desc')

        # Deleting field 'SellerRateChart.key_feature'
        db.delete_column('catalog_sellerratechart', 'key_feature')

        # Deleting field 'SellerRateChart.detailed_desc'
        db.delete_column('catalog_sellerratechart', 'detailed_desc')
