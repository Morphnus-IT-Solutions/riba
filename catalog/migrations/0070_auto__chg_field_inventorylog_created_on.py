...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InventoryLog.created_on'
        db.alter_column('catalog_inventorylog', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'InventoryLog.created_on'
        db.alter_column('catalog_inventorylog', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True))
    ...
    models = {
        ...
        'catalog.inventory': {
            ...
            'physical_stock': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
