...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.moderate'
        db.add_column('catalog_product', 'moderate', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.moderate'
        db.delete_column('catalog_product', 'moderate')
