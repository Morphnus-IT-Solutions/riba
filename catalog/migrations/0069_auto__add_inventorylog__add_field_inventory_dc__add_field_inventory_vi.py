...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InventoryLog'
        db.create_table('catalog_inventorylog', (
            ...
            ('was_physical_stock', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('new_physical_stock', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('was_virtual_stock', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('new_virtual_stock', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('was_threshold_stock', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('new_threshold_stock', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('was_overbooked', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('new_overbooked', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('was_expected_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('new_expected_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('was_expires_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('new_expires_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ...
            ('modified_by', self.gf('django.db.models.fields.CharField')(default='website', max_length=20)),
        ))
        db.send_create_signal('catalog', ['InventoryLog'])

        # Adding field 'Inventory.dc'
        db.add_column('catalog_inventory', 'dc', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['fulfillment.Dc'],null=True, blank=True), keep_default=True)

        # Adding field 'Inventory.virtual_stock'
        db.add_column('catalog_inventory', 'virtual_stock', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True), keep_default=True)

        # Adding field 'Inventory.threshold_stock'
        db.add_column('catalog_inventory', 'threshold_stock', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True), keep_default=True)

        # Adding field 'Inventory.overbooked'
        db.add_column('catalog_inventory', 'overbooked', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True), keep_default=True)

        # Adding field 'Inventory.expected_on'
        db.add_column('catalog_inventory', 'expected_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True, default=None), keep_default=True)

        # Adding field 'Inventory.expires_on'
        db.add_column('catalog_inventory', 'expires_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True, default=None), keep_default=True)

        # Adding field 'Inventory.modified_on'
        db.add_column('catalog_inventory', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True, default=None), keep_default=True)

        # Adding unique constraint on 'Inventory', fields ['rate_chart', 'dc']
        db.create_unique('catalog_inventory', ['rate_chart_id', 'dc_id'])


    def backwards(self, orm):
        
        # Deleting model 'InventoryLog'
        db.delete_table('catalog_inventorylog')

        # Deleting field 'Inventory.dc'
        db.delete_column('catalog_inventory', 'dc_id')

        # Deleting field 'Inventory.virtual_stock'
        db.delete_column('catalog_inventory', 'virtual_stock')

        # Deleting field 'Inventory.threshold_stock'
        db.delete_column('catalog_inventory', 'threshold_stock')

        # Deleting field 'Inventory.overbooked'
        db.delete_column('catalog_inventory', 'overbooked')

        # Deleting field 'Inventory.expected_on'
        db.delete_column('catalog_inventory', 'expected_on')

        # Deleting field 'Inventory.expires_on'
        db.delete_column('catalog_inventory', 'expires_on')

        # Deleting field 'Inventory.modified_on'
        db.delete_column('catalog_inventory', 'modified_on')

        # Removing unique constraint on 'Inventory', fields ['rate_chart', 'dc']
        db.delete_unique('catalog_inventory', ['rate_chart_id', 'dc_id'])
