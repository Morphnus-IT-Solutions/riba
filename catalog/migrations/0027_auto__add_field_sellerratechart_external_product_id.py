...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerRateChart.external_product_id'
        db.add_column('catalog_sellerratechart', 'external_product_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SellerRateChart.external_product_id'
        db.delete_column('catalog_sellerratechart', 'external_product_id')
