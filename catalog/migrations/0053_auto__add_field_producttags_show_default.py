...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductTags.show_default'
        db.add_column('catalog_producttags', 'show_default', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductTags.show_default'
        db.delete_column('catalog_producttags', 'show_default')
