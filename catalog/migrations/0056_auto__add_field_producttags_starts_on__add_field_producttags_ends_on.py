...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductTags.starts_on'
        db.add_column('catalog_producttags', 'starts_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'ProductTags.ends_on'
        db.add_column('catalog_producttags', 'ends_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductTags.starts_on'
        db.delete_column('catalog_producttags', 'starts_on')

        # Deleting field 'ProductTags.ends_on'
        db.delete_column('catalog_producttags', 'ends_on')
