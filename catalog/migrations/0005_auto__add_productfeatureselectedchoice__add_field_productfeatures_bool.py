...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProductFeatureSelectedChoice'
        db.create_table('catalog_productfeatureselectedchoice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('choice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.FeatureChoice'])),
            ('product_feature', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.ProductFeatures'])),
        ))
        db.send_create_signal('catalog', ['ProductFeatureSelectedChoice'])

        # Adding field 'ProductFeatures.bool'
        db.add_column('catalog_productfeatures', 'bool', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'ProductFeatures.data'
        db.alter_column('catalog_productfeatures', 'data', self.gf('django.db.models.fields.CharField')(max_length=1000))


    def backwards(self, orm):
        
        # Deleting model 'ProductFeatureSelectedChoice'
        db.delete_table('catalog_productfeatureselectedchoice')

        # Deleting field 'ProductFeatures.bool'
        db.delete_column('catalog_productfeatures', 'bool')

        # Changing field 'ProductFeatures.data'
        db.alter_column('catalog_productfeatures', 'data', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        'catalog.productfeatureselectedchoice': {
            'Meta': {'object_name': 'ProductFeatureSelectedChoice'},
