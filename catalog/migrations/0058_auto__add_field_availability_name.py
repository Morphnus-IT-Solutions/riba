...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('catalog_availability', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Availability.name'
        db.delete_column('catalog_availability', 'name')
