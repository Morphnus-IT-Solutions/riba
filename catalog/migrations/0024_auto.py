...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'SellerRateChart', fields ['listing_id']
        db.create_index('catalog_sellerratechart', ['listing_id'])


    def backwards(self, orm):
        
        # Removing index on 'SellerRateChart', fields ['listing_id']
        db.delete_index('catalog_sellerratechart', ['listing_id'])
