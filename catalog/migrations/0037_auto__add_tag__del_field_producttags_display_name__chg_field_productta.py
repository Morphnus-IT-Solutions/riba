...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProductTags.display_name'
        db.delete_column('catalog_producttags', 'display_name')

        # Renaming column for 'ProductTags.tag' to match new field type.
        db.rename_column('catalog_producttags', 'tag', 'tag_id')
        # Changing field 'ProductTags.tag'
        db.alter_column('catalog_producttags', 'tag_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Tag'], null=True, blank=True))

        # Adding index on 'ProductTags', fields ['tag']
        db.create_index('catalog_producttags', ['tag_id'])
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ProductTags.display_name'
        db.add_column('catalog_producttags', 'display_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Renaming column for 'ProductTags.tag' to match new field type.
        db.rename_column('catalog_producttags', 'tag_id', 'tag')
        # Changing field 'ProductTags.tag'
        db.alter_column('catalog_producttags', 'tag', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Removing index on 'ProductTags', fields ['tag']
        db.delete_index('catalog_producttags', ['tag_id'])
    ...
    models = {
        ...
        'catalog.producttags': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Product']"}),
            'tab': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'to': "orm['lists.Tab']", 'null': 'True', 'blank': 'True'}),
