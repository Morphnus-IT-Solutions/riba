...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerRateChart.is_fmemi_available'
        db.add_column('catalog_sellerratechart', 'is_fmemi_available', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SellerRateChart.is_fmemi_available'
        db.delete_column('catalog_sellerratechart', 'is_fmemi_available')
