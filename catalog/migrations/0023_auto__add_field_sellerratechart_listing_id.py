...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SellerRateChart.listing_id'
        db.add_column('catalog_sellerratechart', 'listing_id', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SellerRateChart.listing_id'
        db.delete_column('catalog_sellerratechart', 'listing_id')
    ...
    models = {
        ...
        'catalog.sellerratechart': {
            ...
            'listing_id': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
