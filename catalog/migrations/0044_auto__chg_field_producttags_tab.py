...
class Migration(SchemaMigration):
	...
	pass        
#        # Changing field 'ProductTags.tab'
#        db.alter_column('catalog_producttags', 'tab_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lists.BattleTab'], null=True, blank=True))
#

    def backwards(self, orm):
        
        # Changing field 'ProductTags.tab'
        db.alter_column('catalog_producttags', 'tab_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lists.Tab'], null=True, blank=True))
