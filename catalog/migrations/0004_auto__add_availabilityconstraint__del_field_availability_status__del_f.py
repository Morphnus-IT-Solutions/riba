...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AvailabilityConstraint'
        db.create_table('catalog_availabilityconstraint', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('availability', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Availability'])),
        ...
        db.send_create_signal('catalog', ['AvailabilityConstraint'])

        # Deleting field 'Availability.status'
        db.delete_column('catalog_availability', 'status')

        # Deleting field 'Availability.city'
        db.delete_column('catalog_availability', 'city_id')

        # Deleting field 'Availability.state'
        db.delete_column('catalog_availability', 'state_id')

        # Deleting field 'Availability.zone'
        db.delete_column('catalog_availability', 'zone')

        # Deleting field 'Availability.country'
        db.delete_column('catalog_availability', 'country_id')

        # Deleting field 'Availability.zipcode'
        db.delete_column('catalog_availability', 'zipcode')

        # Deleting field 'SellerRateChart.shipped_by'
        db.delete_column('catalog_sellerratechart', 'shipped_by_id')

        # Adding field 'SellerRateChart.shipping_paid_by'
        db.add_column('catalog_sellerratechart', 'shipping_paid_by', self.gf('django.db.models.fields.CharField')(default='vendor', max_length=15), keep_default=False)

        # Adding field 'SellerRateChart.payment_charges_paid_by'
        db.add_column('catalog_sellerratechart', 'payment_charges_paid_by', self.gf('django.db.models.fields.CharField')(default='chaupaati', max_length=15), keep_default=False)

        # Adding index on 'SellerRateChart', fields ['visibility_status']
        db.create_index('catalog_sellerratechart', ['visibility_status'])

        # Adding index on 'SellerRateChart', fields ['condition']
        db.create_index('catalog_sellerratechart', ['condition'])


    def backwards(self, orm):
        
        # Deleting model 'AvailabilityConstraint'
        db.delete_table('catalog_availabilityconstraint')

        # Adding field 'Availability.status'
        db.add_column('catalog_availability', 'status', self.gf('django.db.models.fields.CharField')(default='available', max_length=15), keep_default=False)

        # Adding field 'Availability.city'
        db.add_column('catalog_availability', 'city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.City'], null=True, blank=True), keep_default=False)

        # Adding field 'Availability.state'
        db.add_column('catalog_availability', 'state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.State'], null=True, blank=True), keep_default=False)

        # Adding field 'Availability.zone'
        db.add_column('catalog_availability', 'zone', self.gf('django.db.models.fields.CharField')(default='country', max_length=10), keep_default=False)

        # Adding field 'Availability.country'
        db.add_column('catalog_availability', 'country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Country'], null=True, blank=True), keep_default=False)

        # Adding field 'Availability.zipcode'
        db.add_column('catalog_availability', 'zipcode', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'SellerRateChart.shipped_by'
        db.add_column('catalog_sellerratechart', 'shipped_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Account']), keep_default=False)

        # Deleting field 'SellerRateChart.shipping_paid_by'
        db.delete_column('catalog_sellerratechart', 'shipping_paid_by')

        # Deleting field 'SellerRateChart.payment_charges_paid_by'
        db.delete_column('catalog_sellerratechart', 'payment_charges_paid_by')

        # Removing index on 'SellerRateChart', fields ['visibility_status']
        db.delete_index('catalog_sellerratechart', ['visibility_status'])

        # Removing index on 'SellerRateChart', fields ['condition']
        db.delete_index('catalog_sellerratechart', ['condition'])
