...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('catalog_inventory')

        # Changing field 'DeliveryTime.inventory'
        db.alter_column('catalog_deliverytime', 'inventory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Inventory']))
    ...
    def backwards(self, orm):
        ...
        db.create_table('catalog_inventory', (
            ('overbooked', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ('threshold_stock', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
            ...
            ('virtual_stock', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=7, decimal_places=2, blank=True)),
        ...
        # Changing field 'DeliveryTime.inventory'
        db.alter_column('catalog_deliverytime', 'inventory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Inventory']))
    ...
    models = {
        ...
        'catalog.producttags': {
            'Meta': {'unique_together': "(('tag', 'product', 'type'),)", 'object_name': 'ProductTags'},
