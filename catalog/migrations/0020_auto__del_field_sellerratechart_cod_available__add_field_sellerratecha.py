...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SellerRateChart.cod_available'
        db.delete_column('catalog_sellerratechart', 'cod_available_id')

        # Adding field 'SellerRateChart.is_cod_available'
        db.add_column('catalog_sellerratechart', 'is_cod_available', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'SellerRateChart.cod_available_at'
        db.add_column('catalog_sellerratechart', 'cod_available_at', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cod_available_at', null=True, to=orm['catalog.Availability']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'SellerRateChart.cod_available'
        db.add_column('catalog_sellerratechart', 'cod_available', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cod_available_at', null=True, to=orm['catalog.Availability']), keep_default=False)

        # Deleting field 'SellerRateChart.is_cod_available'
        db.delete_column('catalog_sellerratechart', 'is_cod_available')

        # Deleting field 'SellerRateChart.cod_available_at'
        db.delete_column('catalog_sellerratechart', 'cod_available_at_id')
    ...
    models = {
        ...
        'catalog.sellerratechart': {
            ...
            'availability': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Availability']"}),
            'cod_available_at': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cod_available_at'", 'null': 'True', 'to': "orm['catalog.Availability']"}),
