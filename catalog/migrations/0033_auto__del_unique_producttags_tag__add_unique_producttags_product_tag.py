...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ProductTags', fields ['tag']
        db.delete_unique('catalog_producttags', ['tag'])

        # Adding unique constraint on 'ProductTags', fields ['product', 'tag']
        db.create_unique('catalog_producttags', ['product_id', 'tag'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'ProductTags', fields ['tag']
        db.create_unique('catalog_producttags', ['tag'])

        # Removing unique constraint on 'ProductTags', fields ['product', 'tag']
        db.delete_unique('catalog_producttags', ['product_id', 'tag'])
