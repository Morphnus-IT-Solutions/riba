...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.page_title'
        db.add_column('catalog_product', 'page_title', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.page_title'
        db.delete_column('catalog_product', 'page_title')
