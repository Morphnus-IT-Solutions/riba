...
#        db.create_table('catalog_pincode', (
#            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
#            ('pin', self.gf('django.db.models.fields.CharField')(max_length=6)),
#        ))
#        db.send_create_signal('catalog', ['Pincode'])

        # Adding model 'DeliveryTime'
        db.create_table('catalog_deliverytime', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inventory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Inventory'])),
            ('delivery_time', self.gf('django.db.models.fields.IntegerField')(default=7)),
        ))
        db.send_create_signal('catalog', ['DeliveryTime'])

#        # Adding model 'ServicablePincodes'
#        db.create_table('catalog_servicablepincodes', (
#            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
#            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Client'])),
#            ('service_type', self.gf('django.db.models.fields.CharField')(default='otc', max_length=20, db_index=True)),
#            ('pincode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Pincode'])),
#        ))
#        db.send_create_signal('catalog', ['ServicablePincodes'])
#
#        # Deleting field 'Product.product_group'
#        db.delete_column('catalog_product', 'product_group_id')
#
#        # Adding field 'SellerRateChart.cashback_amount'
#        db.add_column('catalog_sellerratechart', 'cashback_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)
#
#        # Adding unique constraint on 'Inventory', fields ['rate_chart']
#        db.create_unique('catalog_inventory', ['rate_chart_id'])


    def backwards(self, orm):
        
        # Deleting model 'Pincode'
        db.delete_table('catalog_pincode')

#        # Deleting model 'DeliveryTime'
#        db.delete_table('catalog_deliverytime')
#
#        # Deleting model 'ServicablePincodes'
#        db.delete_table('catalog_servicablepincodes')
#
#        # Adding field 'Product.product_group'
#        db.add_column('catalog_product', 'product_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fulfillment.ProductGroup'], null=True, blank=True), keep_default=False)
#
#        # Deleting field 'SellerRateChart.cashback_amount'
#        db.delete_column('catalog_sellerratechart', 'cashback_amount')
#
#        # Removing unique constraint on 'Inventory', fields ['rate_chart']
#        db.delete_unique('catalog_inventory', ['rate_chart_id'])
    ...
    models = {
        ...
        'catalog.deliverytime': {
            ...
            'delivery_time': ('django.db.models.fields.IntegerField', [], {'default': '7'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
