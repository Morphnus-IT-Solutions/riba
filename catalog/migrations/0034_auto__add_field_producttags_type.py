...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductTags.type'
        db.add_column('catalog_producttags', 'type', self.gf('django.db.models.fields.CharField')(default='facet', max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductTags.type'
        db.delete_column('catalog_producttags', 'type')
