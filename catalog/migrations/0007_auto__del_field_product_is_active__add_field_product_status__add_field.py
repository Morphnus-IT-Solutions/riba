...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('catalog_product', 'status', self.gf('django.db.models.fields.CharField')(default='Available', max_length=15, db_index=True), keep_default=False)

        # Adding field 'Product.has_images'
        db.add_column('catalog_product', 'has_images', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Product.is_active'
        db.add_column('catalog_product', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Deleting field 'Product.status'
        db.delete_column('catalog_product', 'status')

        # Deleting field 'Product.has_images'
        db.delete_column('catalog_product', 'has_images')
