...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ProductTags', fields ['product', 'tag']
        db.delete_unique('catalog_producttags', ['product_id', 'tag_id'])

        # Adding unique constraint on 'ProductTags', fields ['product', 'tag', 'type']
        db.create_unique('catalog_producttags', ['product_id', 'tag_id', 'type'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'ProductTags', fields ['product', 'tag']
        db.create_unique('catalog_producttags', ['product_id', 'tag_id'])

        # Removing unique constraint on 'ProductTags', fields ['product', 'tag', 'type']
        db.delete_unique('catalog_producttags', ['product_id', 'tag_id', 'type'])
    ...
    models = {
        ...
        'lists.list': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'battle'", 'max_length': '50', 'db_index': 'True'}),
