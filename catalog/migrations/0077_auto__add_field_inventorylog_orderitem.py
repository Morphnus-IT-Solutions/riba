...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InventoryLog.orderitem'
        db.add_column('catalog_inventorylog', 'orderitem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.OrderItem'], null=True, blank=True, default=None), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'InventoryLog.orderitem'
        db.delete_column('catalog_inventorylog', 'orderitem_id')
