...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #db.add_column('catalog_tag', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=25, null=True, blank=True), keep_default=False)

        # Adding field 'SellerRateChart.pricing_maintained'
        db.add_column('catalog_sellerratechart', 'pricing_maintained', self.gf('django.db.models.fields.CharField')(default='no', max_length=100), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'Tag.type'
        #db.delete_column('catalog_tag', 'type')

        # Deleting field 'SellerRateChart.pricing_maintained'
        db.delete_column('catalog_sellerratechart', 'pricing_maintained')
    ...
    models = {
        ...
        'catalog.tag': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25', 'null': 'True', 'blank': 'True'})
        },
        'categories.category': {
