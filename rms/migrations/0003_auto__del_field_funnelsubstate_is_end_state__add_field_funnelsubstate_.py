...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FunnelSubState.is_end_state'
        db.delete_column('rms_funnelsubstate', 'is_end_state')

        # Adding field 'FunnelSubState.exit_substate'
        db.add_column('rms_funnelsubstate', 'exit_substate', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'FunnelSubState.is_end_state'
        db.add_column('rms_funnelsubstate', 'is_end_state', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Deleting field 'FunnelSubState.exit_substate'
        db.delete_column('rms_funnelsubstate', 'exit_substate')
    ...
    models = {
        ...
        'rms.response': {
            ...
            'followup_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 13, 15, 28, 8, 696571)'}),
