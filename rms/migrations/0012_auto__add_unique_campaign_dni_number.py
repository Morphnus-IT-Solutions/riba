...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Campaign', fields ['dni_number']
        db.create_unique('rms_campaign', ['dni_number'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Campaign', fields ['dni_number']
        db.delete_unique('rms_campaign', ['dni_number'])
    ...
    models = {
        ...
        'rms.response': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'followup_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 4, 15, 16, 59, 384983)', 'null': 'True', 'blank': 'True'}),
