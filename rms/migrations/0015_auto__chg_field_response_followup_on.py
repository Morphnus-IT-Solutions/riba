...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('rms_response', 'followup_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True))

        # Adding index on 'Response', fields ['followup_on']
        db.create_index('rms_response', ['followup_on'])

        # Adding index on 'Interaction', fields ['timestamp']
        db.create_index('rms_interaction', ['timestamp'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'Response', fields ['followup_on']
        db.delete_index('rms_response', ['followup_on'])

        # Removing index on 'Interaction', fields ['timestamp']
        db.delete_index('rms_interaction', ['timestamp'])
