...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Response.followup_on'
        db.alter_column('rms_response', 'followup_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Response.followup_on'
        db.alter_column('rms_response', 'followup_on', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'rms.response': {
            ...
            'followup_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 13, 17, 11, 31, 624345)', 'null': 'True', 'blank': 'True'}),
