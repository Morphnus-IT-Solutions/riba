...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Campaign.hotline'
        db.alter_column('rms_campaign', 'hotline', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Campaign.hotline'
        db.alter_column('rms_campaign', 'hotline', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        ...
        'rms.response': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'followup_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 2, 17, 0, 51, 815078)', 'null': 'True', 'blank': 'True'}),
