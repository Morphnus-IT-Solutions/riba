...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Response.user'
        db.delete_column('rms_response', 'user_id')

        # Adding field 'Response.phone'
        db.add_column('rms_response', 'phone', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.Phone']), keep_default=False)

        # Adding field 'Response.closed_by'
        db.add_column('rms_response', 'closed_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, blank=True, to=orm['ccm.Agent']), keep_default=False)

        # Adding field 'Response.on_hold'
        db.add_column('rms_response', 'on_hold', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'Response.funnel_state'
        db.alter_column('rms_response', 'funnel_state_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['rms.FunnelState']))

        # Changing field 'Response.last_interacted_on'
        db.alter_column('rms_response', 'last_interacted_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))

        # Adding field 'Interaction.call_status'
        db.add_column('rms_interaction', 'call_status', self.gf('django.db.models.fields.CharField')(default=None, max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Response.user'
        db.add_column('rms_response', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.Phone']), keep_default=False)

        # Deleting field 'Response.phone'
        db.delete_column('rms_response', 'phone_id')

        # Deleting field 'Response.closed_by'
        db.delete_column('rms_response', 'closed_by_id')

        # Deleting field 'Response.on_hold'
        db.delete_column('rms_response', 'on_hold')

        # Changing field 'Response.funnel_state'
        db.alter_column('rms_response', 'funnel_state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rms.FunnelState']))

        # Changing field 'Response.last_interacted_on'
        # Commented out as last interacted on is not present
        #db.alter_column('rms_response', 'last_interacted_on', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Deleting field 'Interaction.call_status'
        db.delete_column('rms_interaction', 'call_status')
    ...
    models = {
        ...
        'rms.response': {
            ...
            'followup_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 5, 17, 6, 6, 349117)'}),
