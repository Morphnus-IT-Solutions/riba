...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field inbound_agents on 'Campaign'
        db.create_table('rms_campaign_inbound_agents', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('campaign', models.ForeignKey(orm['rms.campaign'], null=False)),
            ('agent', models.ForeignKey(orm['ccm.agent'], null=False))
        ))
        db.create_unique('rms_campaign_inbound_agents', ['campaign_id', 'agent_id'])

        # Adding M2M table for field outbound_agents on 'Campaign'
        db.create_table('rms_campaign_outbound_agents', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('campaign', models.ForeignKey(orm['rms.campaign'], null=False)),
            ('agent', models.ForeignKey(orm['ccm.agent'], null=False))
        ))
        db.create_unique('rms_campaign_outbound_agents', ['campaign_id', 'agent_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field inbound_agents on 'Campaign'
        db.delete_table('rms_campaign_inbound_agents')

        # Removing M2M table for field outbound_agents on 'Campaign'
        db.delete_table('rms_campaign_outbound_agents')
    ...
    models = {
        ...
        'rms.response': {
            ...
            'followup_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 11, 17, 21, 25, 693465)', 'null': 'True', 'blank': 'True'}),
