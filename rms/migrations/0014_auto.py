...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Response', fields ['is_closed']
        db.create_index('rms_response', ['is_closed'])


    def backwards(self, orm):
        
        # Removing index on 'Response', fields ['is_closed']
        db.delete_index('rms_response', ['is_closed'])
    ...
    models = {
        ...
        'rms.response': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'followup_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 21, 19, 29, 6, 314371)', 'null': 'True', 'blank': 'True'}),
