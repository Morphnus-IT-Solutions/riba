...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FunnelSubState.index'
        db.add_column('rms_funnelsubstate', 'index', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FunnelSubState.index'
        db.delete_column('rms_funnelsubstate', 'index')
    ...
    models = {
        ...
        'rms.response': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'followup_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 19, 13, 57, 31, 816204)', 'null': 'True', 'blank': 'True'}),
