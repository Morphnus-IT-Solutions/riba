...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field orders on 'Response'
        db.create_table('rms_response_orders', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('response', models.ForeignKey(orm['rms.response'], null=False)),
            ('order', models.ForeignKey(orm['orders.order'], null=False))
        ))
        db.create_unique('rms_response_orders', ['response_id', 'order_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field orders on 'Response'
        db.delete_table('rms_response_orders')
    ...
    models = {
        ...
        'rms.response': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'followup_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 13, 19, 35, 44, 548035)', 'null': 'True', 'blank': 'True'}),
