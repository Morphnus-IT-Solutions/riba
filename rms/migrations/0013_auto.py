...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Response', fields ['last_interacted_on']
        db.create_index('rms_response', ['last_interacted_on'])


    def backwards(self, orm):
        
        # Removing index on 'Response', fields ['last_interacted_on']
        db.delete_index('rms_response', ['last_interacted_on'])
    ...
    models = {
        ...
        'rms.response': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'followup_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 10, 53, 32, 68752)', 'null': 'True', 'blank': 'True'}),
