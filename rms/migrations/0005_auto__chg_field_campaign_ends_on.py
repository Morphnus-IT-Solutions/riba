...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Campaign.ends_on'
        db.alter_column('rms_campaign', 'ends_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Campaign.ends_on'
        db.alter_column('rms_campaign', 'ends_on', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'rms.response': {
            ...
            'followup_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 20, 16, 5, 22, 574593)', 'null': 'True', 'blank': 'True'}),
