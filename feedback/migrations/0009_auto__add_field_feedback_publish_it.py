...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feedback.publish_it'
        db.add_column('feedback_feedback', 'publish_it', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feedback.publish_it'
        db.delete_column('feedback_feedback', 'publish_it')
    ...
    models = {
        ...
        'feedback.contactus': {
            ...
            'submitted_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 15, 1, 51, 31, 71719)'})
        },
        ...
        'feedback.feedback': {
            ...
            'publish_it': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'submitted_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 15, 1, 51, 31, 70192)'}),
