...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        return        
        # Changing field 'DepositPaymentOptions.bank_name'
        db.alter_column('accounts_depositpaymentoptions', 'bank_name', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'DepositPaymentOptions.bank_ifsc'
        db.alter_column('accounts_depositpaymentoptions', 'bank_ifsc', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'DepositPaymentOptions.bank_ac_name'
        db.alter_column('accounts_depositpaymentoptions', 'bank_ac_name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'DepositPaymentOptions.bank_ac_no'
        db.alter_column('accounts_depositpaymentoptions', 'bank_ac_no', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'DepositPaymentOptions.bank_ac_type'
        db.alter_column('accounts_depositpaymentoptions', 'bank_ac_type', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        return
        # Changing field 'DepositPaymentOptions.bank_name'
        db.alter_column('accounts_depositpaymentoptions', 'bank_name', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'DepositPaymentOptions.bank_ifsc'
        db.alter_column('accounts_depositpaymentoptions', 'bank_ifsc', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'DepositPaymentOptions.bank_ac_name'
        db.alter_column('accounts_depositpaymentoptions', 'bank_ac_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'DepositPaymentOptions.bank_ac_no'
        db.alter_column('accounts_depositpaymentoptions', 'bank_ac_no', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'DepositPaymentOptions.bank_ac_type'
        db.alter_column('accounts_depositpaymentoptions', 'bank_ac_type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        'accounts.depositpaymentoptions': {
            'Meta': {'object_name': 'DepositPaymentOptions'},
