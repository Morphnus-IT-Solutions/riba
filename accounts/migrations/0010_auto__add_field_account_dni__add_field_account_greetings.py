...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.dni'
        db.add_column('accounts_account', 'dni', self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Account.dni'
        db.delete_column('accounts_account', 'dni')
    ...
    models = {
        'accounts.account': {
            ...
            'greetings': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
