...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DomainPaymentOptions.book_order'
        db.delete_column('accounts_domainpaymentoptions', 'book_order')

        # Deleting field 'DomainPaymentOptions.book_and_confirm_order'
        db.delete_column('accounts_domainpaymentoptions', 'book_and_confirm_order')

        # Adding field 'DomainPaymentOptions.order_taking_option'
        db.add_column('accounts_domainpaymentoptions', 'order_taking_option', self.gf('django.db.models.fields.CharField')(default='book', max_length='20'), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'DomainPaymentOptions.book_order'
        db.add_column('accounts_domainpaymentoptions', 'book_order', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'DomainPaymentOptions.book_and_confirm_order'
        db.add_column('accounts_domainpaymentoptions', 'book_and_confirm_order', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Deleting field 'DomainPaymentOptions.order_taking_option'
        db.delete_column('accounts_domainpaymentoptions', 'order_taking_option')
