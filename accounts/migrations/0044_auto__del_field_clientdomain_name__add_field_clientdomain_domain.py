...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ClientDomain.name'
        db.delete_column('accounts_clientdomain', 'name')

        # Adding field 'ClientDomain.domain'
        db.add_column('accounts_clientdomain', 'domain', self.gf('django.db.models.fields.CharField')(default='', max_length=150), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ClientDomain.name'
        db.add_column('accounts_clientdomain', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=150), keep_default=False)

        # Deleting field 'ClientDomain.domain'
        db.delete_column('accounts_clientdomain', 'domain')
    ...
    models = {
        ...
        'accounts.clientdomain': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Client']"}),
            'custom_home_page': ('django.db.models.fields.CharField', [], {'default': "'home/home.html'", 'max_length': '100'}),
