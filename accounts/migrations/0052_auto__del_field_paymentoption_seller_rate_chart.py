...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PaymentOption.seller_rate_chart'
        db.delete_column('accounts_paymentoption', 'seller_rate_chart_id')

        # Adding M2M table for field seller_rate_chart on 'PaymentOption'
        db.create_table('accounts_paymentoption_seller_rate_chart', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('paymentoption', models.ForeignKey(orm['accounts.paymentoption'], null=False)),
            ('sellerratechart', models.ForeignKey(orm['catalog.sellerratechart'], null=False))
        ))
        db.create_unique('accounts_paymentoption_seller_rate_chart', ['paymentoption_id', 'sellerratechart_id'])


    def backwards(self, orm):
        
        # Adding field 'PaymentOption.seller_rate_chart'
        db.add_column('accounts_paymentoption', 'seller_rate_chart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SellerRateChart'], null=True, blank=True), keep_default=False)

        # Removing M2M table for field seller_rate_chart on 'PaymentOption'
        db.delete_table('accounts_paymentoption_seller_rate_chart')
    ...
    models = {
        ...
        'accounts.paymentoption': {
            ...
            'seller_rate_chart': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['catalog.SellerRateChart']", 'null': 'True', 'blank': 'True'}),
