...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.sale_pricelist'
        db.add_column('accounts_client', 'sale_pricelist', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)

        # Adding field 'Client.list_pricelist'
        db.add_column('accounts_client', 'list_pricelist', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Client.sale_pricelist'
        db.delete_column('accounts_client', 'sale_pricelist')

        # Deleting field 'Client.list_pricelist'
        db.delete_column('accounts_client', 'list_pricelist')
