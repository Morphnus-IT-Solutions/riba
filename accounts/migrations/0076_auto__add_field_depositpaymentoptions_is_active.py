...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        return        
        # Adding field 'DepositPaymentOptions.is_active'
        db.add_column('accounts_depositpaymentoptions', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        return
        # Deleting field 'DepositPaymentOptions.is_active'
        db.delete_column('accounts_depositpaymentoptions', 'is_active')
