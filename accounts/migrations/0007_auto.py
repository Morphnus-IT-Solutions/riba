...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field managers on 'Account'
        db.create_table('accounts_account_managers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('account', models.ForeignKey(orm['accounts.account'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('accounts_account_managers', ['account_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field managers on 'Account'
        db.delete_table('accounts_account_managers')
