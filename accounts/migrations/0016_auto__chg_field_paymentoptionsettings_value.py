...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PaymentOptionSettings.value'
        db.alter_column('accounts_paymentoptionsettings', 'value', self.gf('django.db.models.fields.TextField')(blank=True))


    def backwards(self, orm):
        
        # Changing field 'PaymentOptionSettings.value'
        db.alter_column('accounts_paymentoptionsettings', 'value', self.gf('django.db.models.fields.TextField')())
