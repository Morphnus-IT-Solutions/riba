...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentMode.collection_mode'
        db.add_column('accounts_paymentmode', 'collection_mode', self.gf('django.db.models.fields.CharField')(default='online', max_length=8), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PaymentMode.collection_mode'
        db.delete_column('accounts_paymentmode', 'collection_mode')
