...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentOption.is_noninstant'
        db.add_column('accounts_paymentoption', 'is_noninstant', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'PaymentOption.is_offline'
        db.add_column('accounts_paymentoption', 'is_offline', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PaymentOption.is_noninstant'
        db.delete_column('accounts_paymentoption', 'is_noninstant')

        # Deleting field 'PaymentOption.is_offline'
        db.delete_column('accounts_paymentoption', 'is_offline')
