...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PaymentOption.account'
        db.alter_column('accounts_paymentoption', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account']))
    ...
    models = {
        ...
        'accounts.paymentoption': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Account']", 'blank': 'True'}),
