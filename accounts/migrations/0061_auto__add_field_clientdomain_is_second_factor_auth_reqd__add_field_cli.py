...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClientDomain.is_second_factor_auth_reqd'
        db.add_column('accounts_clientdomain', 'is_second_factor_auth_reqd', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'ClientDomain.is_channel'
        db.add_column('accounts_clientdomain', 'is_channel', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClientDomain.is_second_factor_auth_reqd'
        db.delete_column('accounts_clientdomain', 'is_second_factor_auth_reqd')

        # Deleting field 'ClientDomain.is_channel'
        db.delete_column('accounts_clientdomain', 'is_channel')
