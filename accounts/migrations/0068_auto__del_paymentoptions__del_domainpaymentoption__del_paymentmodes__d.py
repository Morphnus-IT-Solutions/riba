...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('accounts_paymentoptions')

        # Deleting model 'DomainPaymentOption'
        db.delete_table('accounts_domainpaymentoption')

        # Deleting model 'PaymentModes'
        db.delete_table('accounts_paymentmodes')
        ...
        db.add_column('accounts_paymentmode', 'group', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.PaymentGroups']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('accounts_paymentoptions', (
            ...
            ('payment_mode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.PaymentModes'])),
        ...
        db.send_create_signal('accounts', ['PaymentOptions'])

        # Adding model 'DomainPaymentOption'
        db.create_table('accounts_domainpaymentoption', (
            ('payment_option', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.PaymentOptions'])),
        ...
        db.send_create_signal('accounts', ['DomainPaymentOption'])

        # Adding model 'PaymentModes'
        db.create_table('accounts_paymentmodes', (
        ...
        db.send_create_signal('accounts', ['PaymentModes'])

        # Adding field 'PaymentMode.group_code'
        db.add_column('accounts_paymentmode', 'group_code', self.gf('django.db.models.fields.CharField')(default='abc', max_length=25, blank=True), keep_default=False)
        ...
        db.add_column('accounts_paymentmode', 'group_name', self.gf('django.db.models.fields.CharField')(default='abc', max_length=25), keep_default=False)

        # Adding field 'PaymentMode.client'
        db.add_column('accounts_paymentmode', 'client', self.gf('django.db.models.fields.related.ForeignKey')(default='abc', to=orm['accounts.Client']), keep_default=False)
