...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_depositpaymentoptions', (
            ...
            ('bank_ac_no', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('bank_ac_type', self.gf('django.db.models.fields.CharField')(default='current', max_length=100, null=True)),
            ('bank_ac_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('bank_name', self.gf('django.db.models.fields.CharField')(max_length=300, null=True)),
            ('bank_ifsc', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
        ))
    ...
    models = {
        ...
        'accounts.depositpaymentoptions': {
            'Meta': {'unique_together': "(('client', 'bank_ac_no'),)", 'object_name': 'DepositPaymentOptions'},
