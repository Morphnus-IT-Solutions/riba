...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'accounts.domainpaymentoption': {
            'Meta': {'object_name': 'DomainPaymentOption'},
            ...
            'payment_option': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.PaymentOptions']"})
        },
        ...
        'accounts.paymentmodes': {
            'Meta': {'object_name': 'PaymentModes'},
        ...
        'accounts.paymentoptions': {
            ...
            'location_url': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
            'payment_delivery_address': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'payment_mode': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.PaymentModes']"}),
            'sort_order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'})
        },
        'accounts.storeowner': {
