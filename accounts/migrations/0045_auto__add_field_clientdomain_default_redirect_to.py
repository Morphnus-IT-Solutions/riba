...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClientDomain.default_redirect_to'
        db.add_column('accounts_clientdomain', 'default_redirect_to', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClientDomain.default_redirect_to'
        db.delete_column('accounts_clientdomain', 'default_redirect_to')
