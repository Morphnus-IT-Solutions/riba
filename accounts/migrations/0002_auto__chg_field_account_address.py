...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.address'
        db.alter_column('accounts_account', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Address'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Account.address'
        db.alter_column('accounts_account', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Address']))
