...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PaymentMode.is_online'
        db.delete_column('accounts_paymentmode', 'is_online')

        # Deleting field 'PaymentMode.is_instant'
        db.delete_column('accounts_paymentmode', 'is_instant')

        # Adding field 'PaymentOption.is_instant'
        db.add_column('accounts_paymentoption', 'is_instant', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'PaymentOption.is_online'
        db.add_column('accounts_paymentoption', 'is_online', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'PaymentMode.is_online'
        db.add_column('accounts_paymentmode', 'is_online', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'PaymentMode.is_instant'
        db.add_column('accounts_paymentmode', 'is_instant', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Deleting field 'PaymentOption.is_instant'
        db.delete_column('accounts_paymentoption', 'is_instant')

        # Deleting field 'PaymentOption.is_online'
        db.delete_column('accounts_paymentoption', 'is_online')
    ...
    models = {
        'accounts.account': {
            ...
            'confirmed_order_email': ('django.db.models.fields.CharField', [], {'default': "'order@chaupaati.com'", 'max_length': '500'}),
            ...
            'pending_order_email': ('django.db.models.fields.CharField', [], {'default': "'lead@chaupaati.com'", 'max_length': '500'}),
