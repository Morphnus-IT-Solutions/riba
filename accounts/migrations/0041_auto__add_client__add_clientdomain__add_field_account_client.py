...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.client'
        db.add_column('accounts_account', 'client', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Client']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Account.client'
        db.delete_column('accounts_account', 'client_id')
