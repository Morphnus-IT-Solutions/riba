...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('accounts_account', 'address_id')


    def backwards(self, orm):
        
        # Adding field 'Account.address'
        db.add_column('accounts_account', 'address', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Address'], null=True, blank=True), keep_default=False)
