...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_client', 'order_prefix', self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True, blank=True),
        keep_default=False)

        # Removing unique constraint on 'DepositPaymentOptions', fields ['bank_ac_no']
        db.delete_unique('accounts_depositpaymentoptions', ['bank_ac_no'])

        # Adding unique constraint on 'DepositPaymentOptions', fields ['bank_name', 'client']
        db.create_unique('accounts_depositpaymentoptions', ['bank_name', 'client_id'])


    def backwards(self, orm):
        return
        # Deleting field 'Client.slug'
        db.delete_column('accounts_client', 'slug')

        # Deleting field 'Client.order_prefix'
        db.delete_column('accounts_client', 'order_prefix')

        # Deleting field 'Account.slug'
        db.delete_column('accounts_account', 'slug')

        # Adding unique constraint on 'DepositPaymentOptions', fields ['bank_ac_no']
        db.create_unique('accounts_depositpaymentoptions', ['bank_ac_no'])

        # Removing unique constraint on 'DepositPaymentOptions', fields ['bank_name', 'client']
        db.delete_unique('accounts_depositpaymentoptions', ['bank_name', 'client_id'])
    ...
    models = {
        ...
        'accounts.client': {
            ...
            'order_prefix': ('django.db.models.fields.IntegerField', [], {'default': '505', 'max_length': '5'}),
            'pending_order_email': ('django.db.models.fields.CharField', [], {'default': "'<Chaupaati Bazaar> lead@chaupaati.com'", 'max_length': '500'}),
            'pending_order_helpline': ('django.db.models.fields.CharField', [], {'default': "'0-922-222-1947'", 'max_length': '25'}),
