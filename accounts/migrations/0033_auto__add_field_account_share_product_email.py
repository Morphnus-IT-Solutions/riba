...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.share_product_email'
        db.add_column('accounts_account', 'share_product_email', self.gf('django.db.models.fields.CharField')(default='<Chaupaati Bazaar> share@chaupaati.com', max_length=500), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.share_product_email'
        db.delete_column('accounts_account', 'share_product_email')
