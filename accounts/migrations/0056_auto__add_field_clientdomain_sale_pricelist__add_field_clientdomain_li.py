...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClientDomain.sale_pricelist'
        db.add_column('accounts_clientdomain', 'sale_pricelist', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)

        # Adding field 'ClientDomain.list_pricelist'
        db.add_column('accounts_clientdomain', 'list_pricelist', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClientDomain.sale_pricelist'
        db.delete_column('accounts_clientdomain', 'sale_pricelist')

        # Deleting field 'ClientDomain.list_pricelist'
        db.delete_column('accounts_clientdomain', 'list_pricelist')
