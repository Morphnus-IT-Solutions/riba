...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClientDomain.currency'
        db.add_column('accounts_clientdomain', 'currency', self.gf('django.db.models.fields.CharField')(default='inr', max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClientDomain.currency'
        db.delete_column('accounts_clientdomain', 'currency')
