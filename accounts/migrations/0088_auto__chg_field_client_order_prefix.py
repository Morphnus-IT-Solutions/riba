...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('accounts_client', 'order_prefix', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True, default=''))


    def backwards(self, orm):
        
        # Changing field 'Client.order_prefix'
        db.alter_column('accounts_client', 'order_prefix', self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True, blank=True, default=None))
