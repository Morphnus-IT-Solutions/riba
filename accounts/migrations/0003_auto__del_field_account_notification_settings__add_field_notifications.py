...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Account.notification_settings'
        db.delete_column('accounts_account', 'notification_settings_id')

        # Adding field 'NotificationSettings.account'
        db.add_column('accounts_notificationsettings', 'account', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['accounts.Account']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Account.notification_settings'
        db.add_column('accounts_account', 'notification_settings', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['accounts.NotificationSettings'], blank=True), keep_default=False)

        # Deleting field 'NotificationSettings.account'
        db.delete_column('accounts_notificationsettings', 'account_id')
