...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StoreOwner.category'
        db.alter_column('accounts_storeowner', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Category'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'StoreOwner.category'
        db.alter_column('accounts_storeowner', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Category']))
