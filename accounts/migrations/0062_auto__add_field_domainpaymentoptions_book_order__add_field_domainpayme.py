...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'accounts.domainpaymentoptions': {
            ...
            'book_and_confirm_order': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'book_order': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
