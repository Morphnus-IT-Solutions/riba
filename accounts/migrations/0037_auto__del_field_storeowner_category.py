...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StoreOwner.category'
        db.delete_column('accounts_storeowner', 'category_id')


    def backwards(self, orm):
        
        # Adding field 'StoreOwner.category'
        db.add_column('accounts_storeowner', 'category', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['categories.Category']), keep_default=False)
