...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentOption.is_active'
        db.add_column('accounts_paymentoption', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PaymentOption.is_active'
        db.delete_column('accounts_paymentoption', 'is_active')
