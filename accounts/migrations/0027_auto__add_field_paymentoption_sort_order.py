...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentOption.sort_order'
        db.add_column('accounts_paymentoption', 'sort_order', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PaymentOption.sort_order'
        db.delete_column('accounts_paymentoption', 'sort_order')
