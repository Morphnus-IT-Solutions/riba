...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_paymentoption', 'seller_rate_chart', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['catalog.SellerRateChart'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'accounts.paymentoption': {
            ...
            'seller_rate_chart': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.SellerRateChart']", 'blank': 'True'})
        },
