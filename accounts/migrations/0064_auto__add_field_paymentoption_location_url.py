...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentOption.location_url'
        db.add_column('accounts_paymentoption', 'location_url', self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PaymentOption.location_url'
        db.delete_column('accounts_paymentoption', 'location_url')
