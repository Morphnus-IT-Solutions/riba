...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        return        
        # Deleting field 'Client.pg_return_url'
        db.delete_column('accounts_client', 'pg_return_url')


    def backwards(self, orm):
        return
        # Adding field 'Client.pg_return_url'
        db.add_column('accounts_client', 'pg_return_url', self.gf('django.db.models.fields.URLField')(default='http://www.chaupaati.in', max_length=200, blank=True), keep_default=False)
