...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_domainpaymentoptions', 'payment_option', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.PaymentOption']), keep_default=False)
