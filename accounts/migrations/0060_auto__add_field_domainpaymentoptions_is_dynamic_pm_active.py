...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DomainPaymentOptions.is_dynamic_pm_active'
        db.add_column('accounts_domainpaymentoptions', 'is_dynamic_pm_active', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DomainPaymentOptions.is_dynamic_pm_active'
        db.delete_column('accounts_domainpaymentoptions', 'is_dynamic_pm_active')
