...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_paymentmode', 'client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Client'], null=True, blank=True), keep_default=False)
        ...
        db.add_column('accounts_paymentmode', 'group_code', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)

        # Adding field 'PaymentMode.group_name'
        db.add_column('accounts_paymentmode', 'group_name', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)

        # Adding field 'PaymentMode.service_provider'
        db.add_column('accounts_paymentmode', 'service_provider', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)
