...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClientDomain.type'
        db.add_column('accounts_clientdomain', 'type', self.gf('django.db.models.fields.CharField')(default='website', max_length=25), keep_default=False)

        # Adding field 'ClientDomain.is_public'
        db.add_column('accounts_clientdomain', 'is_public', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'ClientDomain.custom_home_page'
        db.add_column('accounts_clientdomain', 'custom_home_page', self.gf('django.db.models.fields.CharField')(default='home/home.html', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClientDomain.type'
        db.delete_column('accounts_clientdomain', 'type')

        # Deleting field 'ClientDomain.is_public'
        db.delete_column('accounts_clientdomain', 'is_public')

        # Deleting field 'ClientDomain.custom_home_page'
        db.delete_column('accounts_clientdomain', 'custom_home_page')
