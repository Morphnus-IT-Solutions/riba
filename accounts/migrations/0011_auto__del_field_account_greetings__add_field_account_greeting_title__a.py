...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Account.greetings'
        db.delete_column('accounts_account', 'greetings')

        # Adding field 'Account.greeting_title'
        db.add_column('accounts_account', 'greeting_title', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Account.greeting_text'
        db.add_column('accounts_account', 'greeting_text', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Account.greetings'
        db.add_column('accounts_account', 'greetings', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Deleting field 'Account.greeting_title'
        db.delete_column('accounts_account', 'greeting_title')

        # Deleting field 'Account.greeting_text'
        db.delete_column('accounts_account', 'greeting_text')
