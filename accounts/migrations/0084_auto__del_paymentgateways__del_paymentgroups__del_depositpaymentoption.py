...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentMode.client'
        db.add_column('accounts_paymentmode', 'client', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['accounts.Client']), keep_default=False)

        # Adding field 'PaymentMode.is_grouped'
        db.add_column('accounts_paymentmode', 'is_grouped', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'PaymentMode.group_code'
        db.add_column('accounts_paymentmode', 'group_code', self.gf('django.db.models.fields.CharField')(default=None, max_length=25, blank=True), keep_default=False)

        # Adding field 'PaymentMode.group_name'
        db.add_column('accounts_paymentmode', 'group_name', self.gf('django.db.models.fields.CharField')(default=None, max_length=25), keep_default=False)

        # Adding field 'PaymentMode.service_provider'
        db.add_column('accounts_paymentmode', 'service_provider', self.gf('django.db.models.fields.CharField')(default=None, max_length=25, blank=True), keep_default=False)

        # Changing field 'PaymentMode.code'
        db.alter_column('accounts_paymentmode', 'code', self.gf('django.db.models.fields.CharField')(max_length=25))
        ...
        # Adding field 'Client.terms_and_conditions'
        db.add_column('accounts_client', 'terms_and_conditions', self.gf('django.db.models.fields.TextField')(default=None), keep_default=False)

        # Deleting field 'PaymentOption.client'
        db.delete_column('accounts_paymentoption', 'client_id')

        # Adding field 'PaymentOption.account'
        db.add_column('accounts_paymentoption', 'account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'], null=True, blank=True), keep_default=False)
        ...
        # Changing field 'PaymentOption.bank_ac_type'
        db.alter_column('accounts_paymentoption', 'bank_ac_type', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))
    ...
    def backwards(self, orm):
        ...
        db.add_column('accounts_paymentmode', 'group', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['accounts.PaymentGroups']), keep_default=False)

        # Deleting field 'PaymentMode.client'
        db.delete_column('accounts_paymentmode', 'client_id')

        # Deleting field 'PaymentMode.is_grouped'
        db.delete_column('accounts_paymentmode', 'is_grouped')

        # Deleting field 'PaymentMode.group_code'
        db.delete_column('accounts_paymentmode', 'group_code')

        # Deleting field 'PaymentMode.group_name'
        db.delete_column('accounts_paymentmode', 'group_name')

        # Deleting field 'PaymentMode.service_provider'
        db.delete_column('accounts_paymentmode', 'service_provider')

        # Changing field 'PaymentMode.code'
        db.alter_column('accounts_paymentmode', 'code', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'PaymentMode.name'
        db.alter_column('accounts_paymentmode', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Adding field 'Client.emi_amount'
        db.add_column('accounts_client', 'emi_amount', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Client.order_prefix'
        db.add_column('accounts_client', 'order_prefix', self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True, blank=True), keep_default=False)

        # Deleting field 'Client.terms_and_conditions'
        db.delete_column('accounts_client', 'terms_and_conditions')

        # Adding field 'PaymentOption.client'
        db.add_column('accounts_paymentoption', 'client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Client'], null=True, blank=True), keep_default=False)

        # Deleting field 'PaymentOption.account'
        db.delete_column('accounts_paymentoption', 'account_id')

        # Changing field 'PaymentOption.bank_name'
        db.alter_column('accounts_paymentoption', 'bank_name', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'PaymentOption.bank_address'
        db.alter_column('accounts_paymentoption', 'bank_address', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'PaymentOption.bank_ifsc'
        db.alter_column('accounts_paymentoption', 'bank_ifsc', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'PaymentOption.bank_ac_name'
        db.alter_column('accounts_paymentoption', 'bank_ac_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'PaymentOption.bank_ac_no'
        db.alter_column('accounts_paymentoption', 'bank_ac_no', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'PaymentOption.complete_order_url'
        db.alter_column('accounts_paymentoption', 'complete_order_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'PaymentOption.bank_branch'
        db.alter_column('accounts_paymentoption', 'bank_branch', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'PaymentOption.bank_ac_type'
        db.alter_column('accounts_paymentoption', 'bank_ac_type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'PaymentOption.in_favor_of'
        db.alter_column('accounts_paymentoption', 'in_favor_of', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'PaymentOption.payment_delivery_address'
        db.alter_column('accounts_paymentoption', 'payment_delivery_address', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'PaymentOption.location_url'
        db.alter_column('accounts_paymentoption', 'location_url', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))
