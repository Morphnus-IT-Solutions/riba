...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.pg_return_url'
        db.add_column('accounts_account', 'pg_return_url', self.gf('django.db.models.fields.URLField')(default='http://www.chaupaati.in', max_length=200, blank=True), keep_default=False)

        # Adding field 'Account.sms_mask'
        db.add_column('accounts_account', 'sms_mask', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Account.track_url_prefix'
        db.add_column('accounts_account', 'track_url_prefix', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Deleting field 'Account.pg_return_url'
        db.delete_column('accounts_account', 'pg_return_url')

        # Deleting field 'Account.sms_mask'
        db.delete_column('accounts_account', 'sms_mask')
