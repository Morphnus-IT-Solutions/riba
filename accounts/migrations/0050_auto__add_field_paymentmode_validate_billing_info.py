...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentMode.validate_billing_info'
        db.add_column('accounts_paymentmode', 'validate_billing_info', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PaymentMode.validate_billing_info'
        db.delete_column('accounts_paymentmode', 'validate_billing_info')
