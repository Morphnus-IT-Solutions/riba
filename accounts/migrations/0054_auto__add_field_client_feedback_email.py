...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.feedback_email'
        db.add_column('accounts_client', 'feedback_email', self.gf('django.db.models.fields.CharField')(default='<Chaupaati Bazaar> feedback@chaupaati.com', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Client.feedback_email'
        db.delete_column('accounts_client', 'feedback_email')
