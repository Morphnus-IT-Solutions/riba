...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoreOwner.position'
        db.add_column('accounts_storeowner', 'position', self.gf('django.db.models.fields.CharField')(default='left', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StoreOwner.position'
        db.delete_column('accounts_storeowner', 'position')
