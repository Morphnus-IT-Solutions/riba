...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.noreply_email'
        db.add_column('accounts_client', 'noreply_email', self.gf('django.db.models.fields.CharField')(default='<Chaupaati Bazaar> noreply@chaupaati.com', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Client.noreply_email'
        db.delete_column('accounts_client', 'noreply_email')
