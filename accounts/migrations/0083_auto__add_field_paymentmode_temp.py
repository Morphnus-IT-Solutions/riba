...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        return
        #Removing fields
        db.delete_column('accounts_paymentmode', 'is_offline')
    ...
    def backwards(self, orm):
        return
        #Adding fields
        db.add_column('accounts_paymentmode', 'is_offline', self.gf('django.db.models.fields.BooleanField')(default=True,),)
        db.add_column('accounts_paymentmode', 'is_grouped', self.gf('django.db.models.fields.BooleanField')(default=True,),)
        db.add_column('accounts_paymentmode', 'group_code', self.gf('django.db.models.fields.CharField')(default='', max_length=25),)
        db.add_column('accounts_paymentmode', 'client', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['accounts.Client'], null=True, blank=True),)
    ...
    models = {
        ...
        'accounts.domainpaymentoptions': {
            ...
            'payment_option': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payment_option'", 'to': "orm['accounts.PaymentOption']"})
        },
        'accounts.feed': {
