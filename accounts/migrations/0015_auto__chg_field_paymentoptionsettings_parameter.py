...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PaymentOptionSettings.parameter'
        db.alter_column('accounts_paymentoptionsettings', 'parameter', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True))


    def backwards(self, orm):
        
        # Changing field 'PaymentOptionSettings.parameter'
        db.alter_column('accounts_paymentoptionsettings', 'parameter', self.gf('django.db.models.fields.CharField')(max_length=200))
