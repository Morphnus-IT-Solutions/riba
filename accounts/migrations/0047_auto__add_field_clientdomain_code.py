...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClientDomain.code'
        db.add_column('accounts_clientdomain', 'code', self.gf('django.db.models.fields.CharField')(default='chaupaati', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClientDomain.code'
        db.delete_column('accounts_clientdomain', 'code')
