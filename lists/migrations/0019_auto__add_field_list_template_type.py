...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'List.template_type'
        db.add_column('lists_list', 'template_type', self.gf('django.db.models.fields.CharField')(default='normal', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'List.template_type'
        db.delete_column('lists_list', 'template_type')
