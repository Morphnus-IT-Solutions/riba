...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Filter.list'
        db.add_column('lists_filter', 'list', self.gf('django.db.models.fields.related.ForeignKey')(default=-2011, to=orm['lists.List']), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Filter.list'
        db.delete_column('lists_filter', 'list_id')
