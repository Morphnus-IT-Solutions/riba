...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ListItem.user_features'
        db.add_column('lists_listitem', 'user_features', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ListItem.user_features'
        db.delete_column('lists_listitem', 'user_features')
