...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tab.list'
        db.add_column('lists_tab', 'list', self.gf('django.db.models.fields.related.ForeignKey')(default=-2011, to=orm['lists.List']), keep_default=False)

        # Adding field 'Filter.tab'
        db.add_column('lists_filter', 'tab', self.gf('django.db.models.fields.related.ForeignKey')(default=-2011, to=orm['lists.Tab']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tab.list'
        db.delete_column('lists_tab', 'list_id')

        # Deleting field 'Filter.tab'
        db.delete_column('lists_filter', 'tab_id')
    ...
    models = {
        ...
        'lists.filter': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'tab': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lists.Tab']"})
        },
        'lists.list': {
