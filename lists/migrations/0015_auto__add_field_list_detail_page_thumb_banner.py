...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'List.detail_page_thumb_banner'
        db.add_column('lists_list', 'detail_page_thumb_banner', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'List.detail_page_thumb_banner'
        db.delete_column('lists_list', 'detail_page_thumb_banner')
    ...
    models = {
        ...
        'lists.list': {
            ...
            'tag': ('django.db.models.fields.CharField', [], {'max_length': '50', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
