...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'List', fields ['client', 'title']
        #db.delete_unique('lists_list', ['client_id', 'title'])

        # Adding unique constraint on 'List', fields ['client', 'Type']
        #db.create_unique('lists_list', ['client_id', 'Type'])


    def backwards(self, orm):
		pass
        
        # Adding unique constraint on 'List', fields ['client', 'title']
        #db.create_unique('lists_list', ['client_id', 'title'])

        # Removing unique constraint on 'List', fields ['client', 'Type']
        #db.delete_unique('lists_list', ['client_id', 'Type'])
    ...
    models = {
        ...
        'lists.list': {
            'Meta': {'unique_together': "(('client', 'Type'),)", 'object_name': 'List'},
