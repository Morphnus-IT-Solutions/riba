...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ListItem', fields ['sku', 'list']
        db.delete_unique('lists_listitem', ['sku_id', 'list_id'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'ListItem', fields ['sku', 'list']
        db.create_unique('lists_listitem', ['sku_id', 'list_id'])

        # Changing field 'List.slug'
        db.alter_column('lists_list', 'slug', self.gf('django.db.models.fields.SlugField')(blank=True, max_length=1000, null=True))
