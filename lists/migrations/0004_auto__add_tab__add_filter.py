...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Tab'
        db.create_table('lists_tab', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('lists', ['Tab'])

        # Adding model 'Filter'
        db.create_table('lists_filter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('lists', ['Filter'])


    def backwards(self, orm):
        
        # Deleting model 'Tab'
        db.delete_table('lists_tab')

        # Deleting model 'Filter'
        db.delete_table('lists_filter')
