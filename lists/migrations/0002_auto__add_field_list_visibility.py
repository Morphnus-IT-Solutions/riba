...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'List.visibility'
        db.add_column('lists_list', 'visibility', self.gf('django.db.models.fields.CharField')(default='private', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'List.visibility'
        db.delete_column('lists_list', 'visibility')
