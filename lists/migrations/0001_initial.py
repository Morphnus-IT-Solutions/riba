...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lists_list', (
            ...
            ('curator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'], null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('banner_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('starts_on', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
            ('ends_on', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
            ('is_featured', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(default='top_10', max_length=50, db_index=True)),
        ))
        ...
        db.create_table('lists_listitem', (
            ...
            ('user_title', self.gf('django.db.models.fields.CharField')(max_length=1000, blank=True)),
            ('user_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='active', max_length=10, db_index=True)),
        ))
        db.send_create_signal('lists', ['ListItem'])

        # Adding unique constraint on 'ListItem', fields ['list', 'sku']
        db.create_unique('lists_listitem', ['list_id', 'sku_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'ListItem', fields ['list', 'sku']
        db.delete_unique('lists_listitem', ['list_id', 'sku_id'])
