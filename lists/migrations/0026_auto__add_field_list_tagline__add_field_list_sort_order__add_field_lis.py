...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'List.tagline'
        db.add_column('lists_list', 'tagline', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'List.sort_order'
        db.add_column('lists_list', 'sort_order', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'List.redirect_to'
        db.add_column('lists_list', 'redirect_to', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'List.banner_type'
        db.add_column('lists_list', 'banner_type', self.gf('django.db.models.fields.CharField')(default='direct_link', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'List.tagline'
        db.delete_column('lists_list', 'tagline')

        # Deleting field 'List.sort_order'
        db.delete_column('lists_list', 'sort_order')

        # Deleting field 'List.redirect_to'
        db.delete_column('lists_list', 'redirect_to')

        # Deleting field 'List.banner_type'
        db.delete_column('lists_list', 'banner_type')
    ...
    models = {
        ...
        'lists.listitem': {
            'Meta': {'unique_together': "(('list', 'sku'),)", 'object_name': 'ListItem'},
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '10', 'db_index': 'True'}),
            'user_description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'user_features': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'user_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'user_title': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'blank': 'True'})
        },
        'lists.tab': {
