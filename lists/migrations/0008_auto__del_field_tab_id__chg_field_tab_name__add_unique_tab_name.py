...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Tab.id'
        db.delete_column('lists_tab', 'id')

        # Changing field 'Tab.name'
        db.alter_column('lists_tab', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True))

        # Adding unique constraint on 'Tab', fields ['name']
        db.create_unique('lists_tab', ['name'])


    def backwards(self, orm):
        
        # Adding field 'Tab.id'
        db.add_column('lists_tab', 'id', self.gf('django.db.models.fields.AutoField')(default='', primary_key=True), keep_default=False)

        # Changing field 'Tab.name'
        db.alter_column('lists_tab', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Removing unique constraint on 'Tab', fields ['name']
        db.delete_unique('lists_tab', ['name'])
