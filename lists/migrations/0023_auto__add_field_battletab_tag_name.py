...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BattleTab.tag_name'
        db.add_column('lists_battletab', 'tag_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BattleTab.tag_name'
        db.delete_column('lists_battletab', 'tag_name')
