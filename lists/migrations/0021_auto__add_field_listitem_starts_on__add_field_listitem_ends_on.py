...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ListItem.starts_on'
        db.add_column('lists_listitem', 'starts_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'ListItem.ends_on'
        db.add_column('lists_listitem', 'ends_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ListItem.starts_on'
        db.delete_column('lists_listitem', 'starts_on')

        # Deleting field 'ListItem.ends_on'
        db.delete_column('lists_listitem', 'ends_on')
