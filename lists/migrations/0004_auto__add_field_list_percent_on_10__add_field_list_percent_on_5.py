...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'List.percent_on_10'
        db.add_column('lists_list', 'percent_on_10', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)

        # Adding field 'List.percent_on_5'
        db.add_column('lists_list', 'percent_on_5', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'List.percent_on_10'
        db.delete_column('lists_list', 'percent_on_10')

        # Deleting field 'List.percent_on_5'
        db.delete_column('lists_list', 'percent_on_5')
