...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tab.sort_order'
        db.add_column('lists_tab', 'sort_order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tab.sort_order'
        db.delete_column('lists_tab', 'sort_order')
