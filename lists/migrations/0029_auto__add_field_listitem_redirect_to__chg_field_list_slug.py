...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ListItem.redirect_to'
        db.add_column('lists_listitem', 'redirect_to', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Changing field 'List.slug'
        db.alter_column('lists_list', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=1000, null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'ListItem.redirect_to'
        db.delete_column('lists_listitem', 'redirect_to')

        # Changing field 'List.slug'
        db.alter_column('lists_list', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=1000))
