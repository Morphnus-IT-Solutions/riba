...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ListItem.sequence'
        db.alter_column('lists_listitem', 'sequence', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True))

        # Changing field 'ListItem.status'
        db.alter_column('lists_listitem', 'status', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'ListItem.sequence'
        db.alter_column('lists_listitem', 'sequence', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'ListItem.status'
        db.alter_column('lists_listitem', 'status', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'lists.listitem': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'active'", 'max_length': '10', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
