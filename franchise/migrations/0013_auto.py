...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'FranchiseOrder', fields ['franc_commission_amnt']
        db.create_index('franchise_franchiseorder', ['franc_commission_amnt'])

        # Adding index on 'FranchiseOrder', fields ['network_commission_amnt']
        db.create_index('franchise_franchiseorder', ['network_commission_amnt'])


    def backwards(self, orm):
        
        # Removing index on 'FranchiseOrder', fields ['franc_commission_amnt']
        db.delete_index('franchise_franchiseorder', ['franc_commission_amnt'])

        # Removing index on 'FranchiseOrder', fields ['network_commission_amnt']
        db.delete_index('franchise_franchiseorder', ['network_commission_amnt'])
    ...
    models = {
        ...
        'franchise.merchanttypekey': {
            ...
            'network': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['franchise.Network']"}),
            'percentage': ('django.db.models.fields.FloatField', [], {'max_length': '200'})
        },
        'franchise.network': {
