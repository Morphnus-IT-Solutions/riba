...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Network.shareType'
        db.delete_column('franchise_network', 'shareType')


    def backwards(self, orm):
        
        # Adding field 'Network.shareType'
        db.add_column('franchise_network', 'shareType', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)
