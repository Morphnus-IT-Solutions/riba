...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'MerchantTypeKey', fields ['key']
        db.create_unique('franchise_merchanttypekey', ['key'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'MerchantTypeKey', fields ['key']
        db.delete_unique('franchise_merchanttypekey', ['key'])
