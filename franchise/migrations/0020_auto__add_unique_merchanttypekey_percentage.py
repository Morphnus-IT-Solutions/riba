...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'MerchantTypeKey', fields ['percentage']
        db.create_unique('franchise_merchanttypekey', ['percentage'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'MerchantTypeKey', fields ['percentage']
        db.delete_unique('franchise_merchanttypekey', ['percentage'])
