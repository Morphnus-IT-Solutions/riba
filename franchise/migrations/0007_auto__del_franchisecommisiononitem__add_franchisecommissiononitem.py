...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FranchiseCommissionOnItem'
        db.create_table('franchise_franchisecommissiononitem', (
        ...
        db.send_create_signal('franchise', ['FranchiseCommissionOnItem'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FranchiseCommissionOnItem'
        db.delete_table('franchise_franchisecommissiononitem')
