...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Network', fields ['name']
        db.create_unique('franchise_network', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Network', fields ['name']
        db.delete_unique('franchise_network', ['name'])
