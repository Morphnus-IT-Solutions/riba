...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CommisionOn.referencing_id'
        db.delete_column('franchise_commisionon', 'referencing_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'CommisionOn.referencing_id'
        db.add_column('franchise_commisionon', 'referencing_id', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)
    ...
    models = {
        ...
        'franchise.commisionon': {
            ...
            'sku': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.SellerRateChart']", 'null': 'True'})
        },
