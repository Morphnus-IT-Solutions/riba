...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'CommisionPriorities'
        db.delete_table('franchise_commisionpriorities')

        # Adding model 'MerchantTypeKey'
        db.create_table('franchise_merchanttypekey', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('percentage', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('network', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['franchise.Network'])),
        ))
        db.send_create_signal('franchise', ['MerchantTypeKey'])

        # Deleting field 'CommisionOn.commisionType'
        db.delete_column('franchise_commisionon', 'commisionType')

        # Deleting field 'CommisionOn.commision_priorities'
        db.delete_column('franchise_commisionon', 'commision_priorities_id')

        # Renaming column for 'CommisionOn.commision' to match new field type.
        db.rename_column('franchise_commisionon', 'commision', 'commision_id')
        # Changing field 'CommisionOn.commision'
        db.alter_column('franchise_commisionon', 'commision_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['franchise.MerchantTypeKey']))

        # Adding index on 'CommisionOn', fields ['commision']
        db.create_index('franchise_commisionon', ['commision_id'])


    def backwards(self, orm):
        
        # Adding model 'CommisionPriorities'
        db.create_table('franchise_commisionpriorities', (
            ('priority', self.gf('django.db.models.fields.CharField')(max_length=5, unique=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('franchise', ['CommisionPriorities'])

        # Deleting model 'MerchantTypeKey'
        db.delete_table('franchise_merchanttypekey')

        # Adding field 'CommisionOn.commisionType'
        db.add_column('franchise_commisionon', 'commisionType', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Adding field 'CommisionOn.commision_priorities'
        db.add_column('franchise_commisionon', 'commision_priorities', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['franchise.CommisionPriorities'], null=True, blank=True), keep_default=False)

        # Renaming column for 'CommisionOn.commision' to match new field type.
        db.rename_column('franchise_commisionon', 'commision_id', 'commision')
        # Changing field 'CommisionOn.commision'
        db.alter_column('franchise_commisionon', 'commision', self.gf('django.db.models.fields.FloatField')(max_length=30))

        # Removing index on 'CommisionOn', fields ['commision']
        db.delete_index('franchise_commisionon', ['commision_id'])
    ...
    models = {
        ...
        'franchise.commisionon': {
            ...
            'commision': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['franchise.MerchantTypeKey']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'network': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['franchise.Network']"}),
            'seller_rate_chart': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.SellerRateChart']", 'null': 'True'})
        },
        'franchise.franchise': {
        ...
        'franchise.franchisecommissiononitem': {
            'Meta': {'object_name': 'FranchiseCommissionOnItem'},
            'franc_commission_amnt': ('django.db.models.fields.FloatField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'franchise_order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['franchise.FranchiseOrder']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'network_commission_amnt': ('django.db.models.fields.FloatField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        'franchise.merchanttypekey': {
            'Meta': {'object_name': 'MerchantTypeKey'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'network': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['franchise.Network']"}),
            'percentage': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'franchise.network': {
