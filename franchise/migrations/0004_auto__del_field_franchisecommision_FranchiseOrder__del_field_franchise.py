...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FranchiseCommision.FranchiseOrder'
        db.delete_column('franchise_franchisecommision', 'FranchiseOrder_id')

        # Deleting field 'FranchiseCommision.CommisionAmnt'
        db.delete_column('franchise_franchisecommision', 'CommisionAmnt')

        # Adding field 'FranchiseCommision.commissionAmnt'
        db.add_column('franchise_franchisecommision', 'commissionAmnt', self.gf('django.db.models.fields.FloatField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'FranchiseCommision.franchiseOrder'
        db.add_column('franchise_franchisecommision', 'franchiseOrder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['franchise.FranchiseOrder'], null=True, blank=True), keep_default=False)

        # Deleting field 'NetworkCommision.FranchiseOrder'
        db.delete_column('franchise_networkcommision', 'FranchiseOrder_id')

        # Deleting field 'NetworkCommision.CommisionAmnt'
        db.delete_column('franchise_networkcommision', 'CommisionAmnt')

        # Adding field 'NetworkCommision.commissionAmnt'
        db.add_column('franchise_networkcommision', 'commissionAmnt', self.gf('django.db.models.fields.FloatField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'NetworkCommision.franchiseOrder'
        db.add_column('franchise_networkcommision', 'franchiseOrder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['franchise.FranchiseOrder'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'FranchiseCommision.CommisionAmnt'
        db.add_column('franchise_franchisecommision', 'CommisionAmnt', self.gf('django.db.models.fields.FloatField')(max_length=50, null=True, blank=True), keep_default=False)

        # Deleting field 'FranchiseCommision.commissionAmnt'
        db.delete_column('franchise_franchisecommision', 'commissionAmnt')
        ...
        # Adding field 'NetworkCommision.CommisionAmnt'
        db.add_column('franchise_networkcommision', 'CommisionAmnt', self.gf('django.db.models.fields.FloatField')(max_length=50, null=True, blank=True), keep_default=False)

        # Deleting field 'NetworkCommision.commissionAmnt'
        db.delete_column('franchise_networkcommision', 'commissionAmnt')
    ...
    models = {
        ...
        'franchise.franchisecommision': {
            ...
            'commissionAmnt': ('django.db.models.fields.FloatField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
