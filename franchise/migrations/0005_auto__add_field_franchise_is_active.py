...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Franchise.is_active'
        db.add_column('franchise_franchise', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Franchise.is_active'
        db.delete_column('franchise_franchise', 'is_active')
