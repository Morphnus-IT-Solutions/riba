...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'CommisionOn', fields ['network', 'seller_rate_chart']
        db.create_unique('franchise_commisionon', ['network_id', 'seller_rate_chart_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CommisionOn', fields ['network', 'seller_rate_chart']
        db.delete_unique('franchise_commisionon', ['network_id', 'seller_rate_chart_id'])
