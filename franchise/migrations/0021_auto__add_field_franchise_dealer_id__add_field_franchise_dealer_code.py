...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Franchise.dealer_id'
        db.add_column('franchise_franchise', 'dealer_id', self.gf('django.db.models.fields.CharField')(default='Itzdl20000', max_length=20), keep_default=False)

        # Adding field 'Franchise.dealer_code'
        db.add_column('franchise_franchise', 'dealer_code', self.gf('django.db.models.fields.CharField')(default='D000032000', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Franchise.dealer_id'
        db.delete_column('franchise_franchise', 'dealer_id')

        # Deleting field 'Franchise.dealer_code'
        db.delete_column('franchise_franchise', 'dealer_code')
    ...
    models = {
        ...
        'franchise.commisionon': {
            'Meta': {'unique_together': "(('network', 'seller_rate_chart'),)", 'object_name': 'CommisionOn'},
        ...
        'franchise.franchise': {
            ...
            'dealer_code': ('django.db.models.fields.CharField', [], {'default': "'D000032000'", 'max_length': '20'}),
            'dealer_id': ('django.db.models.fields.CharField', [], {'default': "'Itzdl20000'", 'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'network': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['franchise.Network']"}),
            'role': ('django.db.models.fields.CharField', [], {'default': "'franchises'", 'max_length': '30', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        'franchise.franchiseorder': {
            ...
            'franc_commission_amnt': ('django.db.models.fields.FloatField', [], {'db_index': 'True', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'franchise': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['franchise.Franchise']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'network_commission_amnt': ('django.db.models.fields.FloatField', [], {'db_index': 'True', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        'franchise.merchanttypekey': {
            ...
            'network': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['franchise.Network']"}),
            'percentage': ('django.db.models.fields.FloatField', [], {'unique': 'True', 'max_length': '200'})
        },
        'franchise.network': {
