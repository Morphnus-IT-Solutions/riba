...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CommisionOn.timestamp'
        db.add_column('franchise_commisionon', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CommisionOn.timestamp'
        db.delete_column('franchise_commisionon', 'timestamp')
