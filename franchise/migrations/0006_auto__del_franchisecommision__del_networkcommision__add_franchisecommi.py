...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'FranchiseCommision'
        db.delete_table('franchise_franchisecommision')

        # Deleting model 'NetworkCommision'
        db.delete_table('franchise_networkcommision')

        # Adding model 'FranchiseCommisionOnItem'
        db.create_table('franchise_franchisecommisiononitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('franchise_order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['franchise.FranchiseOrder'])),
            ('order_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.OrderItem'])),
            ('franc_commission_amnt', self.gf('django.db.models.fields.FloatField')(max_length=50, null=True, blank=True)),
            ('network_commission_amnt', self.gf('django.db.models.fields.FloatField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal('franchise', ['FranchiseCommisionOnItem'])

        # Adding field 'FranchiseOrder.franc_commission_amnt'
        db.add_column('franchise_franchiseorder', 'franc_commission_amnt', self.gf('django.db.models.fields.FloatField')(max_length=50, null=True, blank=True), keep_default=False)

        # Adding field 'FranchiseOrder.network_commission_amnt'
        db.add_column('franchise_franchiseorder', 'network_commission_amnt', self.gf('django.db.models.fields.FloatField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'FranchiseCommision'
        db.create_table('franchise_franchisecommision', (
            ('franchise', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['franchise.Franchise'])),
            ('commissionAmnt', self.gf('django.db.models.fields.FloatField')(max_length=50, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('franchiseOrder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['franchise.FranchiseOrder'], null=True, blank=True)),
        ))
        db.send_create_signal('franchise', ['FranchiseCommision'])

        # Adding model 'NetworkCommision'
        db.create_table('franchise_networkcommision', (
            ('commissionAmnt', self.gf('django.db.models.fields.FloatField')(max_length=50, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('network', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['franchise.Network'])),
            ('franchiseOrder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['franchise.FranchiseOrder'], null=True, blank=True)),
        ))
        db.send_create_signal('franchise', ['NetworkCommision'])

        # Deleting model 'FranchiseCommisionOnItem'
        db.delete_table('franchise_franchisecommisiononitem')

        # Deleting field 'FranchiseOrder.franc_commission_amnt'
        db.delete_column('franchise_franchiseorder', 'franc_commission_amnt')

        # Deleting field 'FranchiseOrder.network_commission_amnt'
        db.delete_column('franchise_franchiseorder', 'network_commission_amnt')
    ...
    models = {
        ...
        'franchise.franchisecommisiononitem': {
            'Meta': {'object_name': 'FranchiseCommisionOnItem'},
        ...
        'orders.orderitem': {
            ...
            'received_by': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'receivers_contact': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
