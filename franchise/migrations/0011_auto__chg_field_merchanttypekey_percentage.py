...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MerchantTypeKey.percentage'
        db.alter_column('franchise_merchanttypekey', 'percentage', self.gf('django.db.models.fields.FloatField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'MerchantTypeKey.percentage'
        db.alter_column('franchise_merchanttypekey', 'percentage', self.gf('django.db.models.fields.CharField')(max_length=200))
