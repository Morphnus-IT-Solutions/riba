...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('franchise_network', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('shareType', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('share', self.gf('django.db.models.fields.FloatField')(max_length=30)),
            ('parent_network', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parent_Network', null=True, to=orm['franchise.Network'])),
            ('clients', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Client'], null=True, blank=True)),
        ))
        db.send_create_signal('franchise', ['Network'])

        # Adding model 'Franchise'
        db.create_table('franchise_franchise', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('network', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['franchise.Network'])),
            ('role', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=30, null=True, blank=True)),
        ))
        db.send_create_signal('franchise', ['Franchise'])

        # Adding model 'CommisionPriorities'
        db.create_table('franchise_commisionpriorities', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('priority', self.gf('django.db.models.fields.CharField')(unique=True, max_length=5)),
        ))
        db.send_create_signal('franchise', ['CommisionPriorities'])

        # Adding model 'CommisionOn'
        db.create_table('franchise_commisionon', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('network', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['franchise.Network'])),
            ('commision_priorities', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['franchise.CommisionPriorities'], null=True, blank=True)),
            ('referencing_id', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('commisionType', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('commision', self.gf('django.db.models.fields.FloatField')(max_length=30)),
        ))
        db.send_create_signal('franchise', ['CommisionOn'])

        # Adding model 'FranchiseOrder'
        db.create_table('franchise_franchiseorder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('franchise', ['FranchiseOrder'])

        # Adding model 'FranchiseCommision'
        db.create_table('franchise_franchisecommision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('franchise', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['franchise.Franchise'])),
            ('CommisionAmnt', self.gf('django.db.models.fields.FloatField')(max_length=50, null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('franchise_network')

        # Deleting model 'Franchise'
        db.delete_table('franchise_franchise')

        # Deleting model 'CommisionPriorities'
        db.delete_table('franchise_commisionpriorities')

        # Deleting model 'CommisionOn'
        db.delete_table('franchise_commisionon')

        # Deleting model 'FranchiseOrder'
        db.delete_table('franchise_franchiseorder')
