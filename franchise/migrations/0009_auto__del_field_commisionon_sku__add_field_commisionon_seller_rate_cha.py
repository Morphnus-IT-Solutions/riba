...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CommisionOn.sku'
        db.delete_column('franchise_commisionon', 'sku_id')

        # Adding field 'CommisionOn.seller_rate_chart'
        db.add_column('franchise_commisionon', 'seller_rate_chart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SellerRateChart'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CommisionOn.sku'
        db.add_column('franchise_commisionon', 'sku', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SellerRateChart'], null=True), keep_default=False)

        # Deleting field 'CommisionOn.seller_rate_chart'
        db.delete_column('franchise_commisionon', 'seller_rate_chart_id')
