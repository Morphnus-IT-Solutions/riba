...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('categories_producttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
        ))
        db.send_create_signal('categories', ['ProductType'])

        # Adding field 'Feature.product_type'
        db.add_column('categories_feature', 'product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.ProductType'], null=True, blank=True), keep_default=False)

        # Adding field 'FeatureGroup.product_type'
        db.add_column('categories_featuregroup', 'product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.ProductType'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ProductType'
        db.delete_table('categories_producttype')

        # Deleting field 'Feature.product_type'
        db.delete_column('categories_feature', 'product_type_id')

        # Deleting field 'FeatureGroup.product_type'
        db.delete_column('categories_featuregroup', 'product_type_id')
