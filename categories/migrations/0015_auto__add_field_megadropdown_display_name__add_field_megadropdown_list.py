...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MegaDropDown.display_name'
        db.add_column('categories_megadropdown', 'display_name', self.gf('django.db.models.fields.CharField')(default=1, max_length=100, blank=True), keep_default=False)

        # Adding field 'MegaDropDown.list'
        db.add_column('categories_megadropdown', 'list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lists.List'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MegaDropDown.display_name'
        db.delete_column('categories_megadropdown', 'display_name')

        # Deleting field 'MegaDropDown.list'
        db.delete_column('categories_megadropdown', 'list_id')
