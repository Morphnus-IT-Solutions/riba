...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeatureGroup.category'
        db.alter_column('categories_featuregroup', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Category'], null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'FeatureGroup.category'
        db.alter_column('categories_featuregroup', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Category']))
