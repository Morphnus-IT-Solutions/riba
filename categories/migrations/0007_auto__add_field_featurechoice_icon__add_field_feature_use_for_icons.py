...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeatureChoice.icon'
        db.add_column('categories_featurechoice', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Feature.use_for_icons'
        db.add_column('categories_feature', 'use_for_icons', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FeatureChoice.icon'
        db.delete_column('categories_featurechoice', 'icon')

        # Deleting field 'Feature.use_for_icons'
        db.delete_column('categories_feature', 'use_for_icons')
