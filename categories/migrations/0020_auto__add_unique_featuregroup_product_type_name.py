...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'FeatureGroup', fields ['product_type', 'name']
        db.create_unique('categories_featuregroup', ['product_type_id', 'name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FeatureGroup', fields ['product_type', 'name']
        db.delete_unique('categories_featuregroup', ['product_type_id', 'name'])
