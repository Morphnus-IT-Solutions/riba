...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CategoryGraph'
        db.create_table('categories_categorygraph', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Category'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='category_parent', to=orm['categories.Category'])),
        ))
        db.send_create_signal('categories', ['CategoryGraph'])


    def backwards(self, orm):
        
        # Deleting model 'CategoryGraph'
        db.delete_table('categories_categorygraph')
    ...
    models = {
        ...
        'categories.categorygraph': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'category_parent'", 'to': "orm['categories.Category']"})
        },
        'categories.feature': {
