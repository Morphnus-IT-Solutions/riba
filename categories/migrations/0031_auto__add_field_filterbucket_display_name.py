...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FilterBucket.display_name'
        db.add_column('categories_filterbucket', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FilterBucket.display_name'
        db.delete_column('categories_filterbucket', 'display_name')
