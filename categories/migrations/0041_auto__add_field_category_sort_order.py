...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('categories_category', 'sort_order', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.sort_order'
        db.delete_column('categories_category', 'sort_order')
