...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CategoryGraph.position'
        db.delete_column('categories_categorygraph', 'position')


    def backwards(self, orm):
        
        # Adding field 'CategoryGraph.position'
        db.add_column('categories_categorygraph', 'position', self.gf('django.db.models.fields.CharField')(default='left', max_length=5), keep_default=False)
