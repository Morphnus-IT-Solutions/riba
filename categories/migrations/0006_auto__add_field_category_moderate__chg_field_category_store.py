...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Category.store'
        db.alter_column('categories_category', 'store_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Store'], null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Category.store'
        db.alter_column('categories_category', 'store_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Store']))
