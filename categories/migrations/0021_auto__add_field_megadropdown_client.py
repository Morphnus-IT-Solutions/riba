...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MegaDropDown.client'
        db.add_column('categories_megadropdown', 'client', self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['accounts.Client']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MegaDropDown.client'
        db.delete_column('categories_megadropdown', 'client_id')
