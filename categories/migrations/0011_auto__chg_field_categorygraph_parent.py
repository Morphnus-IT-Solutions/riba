...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CategoryGraph.parent'
        db.alter_column('categories_categorygraph', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['categories.Category']))


    def backwards(self, orm):
        
        # Changing field 'CategoryGraph.parent'
        db.alter_column('categories_categorygraph', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Category']))
