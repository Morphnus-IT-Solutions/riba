...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MegaDropDown'
        db.create_table('categories_megadropdown', (
        ...
        db.send_create_signal('categories', ['MegaDropDown'])


    def backwards(self, orm):
        
        # Deleting model 'MegaDropDown'
        db.delete_table('categories_megadropdown')
