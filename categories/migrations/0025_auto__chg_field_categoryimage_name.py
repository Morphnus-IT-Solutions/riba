...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CategoryImage.name'
        db.alter_column('categories_categoryimage', 'name', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'CategoryImage.name'
        db.alter_column('categories_categoryimage', 'name', self.gf('django.db.models.fields.CharField')(max_length=25))
