...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Filter.feature_group'
        db.add_column('categories_filter', 'feature_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.FeatureGroup'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Filter.feature_group'
        db.delete_column('categories_filter', 'feature_group_id')
