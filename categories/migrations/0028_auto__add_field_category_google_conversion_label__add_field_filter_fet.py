...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Filter.feture_group'
        db.add_column('categories_filter', 'feture_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.FeatureGroup'], null=True, blank=True), keep_default=False)

        # Changing field 'Filter.feature'
        db.alter_column('categories_filter', 'feature_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Feature'], null=True, blank=True))

        # Adding field 'Feature.index_for_presence'
        db.add_column('categories_feature', 'index_for_presence', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Filter.feture_group'
        db.delete_column('categories_filter', 'feture_group_id')

        # Changing field 'Filter.feature'
        db.alter_column('categories_filter', 'feature_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Feature']))

        # Deleting field 'Feature.index_for_presence'
        db.delete_column('categories_feature', 'index_for_presence')
    ...
    models = {
        ...
        'categories.filter': {
            ...
            'feture_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['categories.FeatureGroup']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'sort_order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
