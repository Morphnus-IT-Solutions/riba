...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('categories_category', 'parent')

        # Deleting field 'Category.image'
        db.delete_column('categories_category', 'image')

        # Deleting field 'Category.owner'
        db.delete_column('categories_category', 'owner_id')

        # Deleting field 'Category.google_conversion_label'
        db.delete_column('categories_category', 'google_conversion_label')

        # Deleting field 'Category.ext_id'
        db.delete_column('categories_category', 'ext_id')

        # Deleting field 'Category.tagline'
        db.delete_column('categories_category', 'tagline')

        # Deleting field 'Category.client'
        db.delete_column('categories_category', 'client_id')

        # Deleting field 'Category.show_compare'
        db.delete_column('categories_category', 'show_compare')

        # Deleting field 'Category.moderate'
        db.delete_column('categories_category', 'moderate')

        # Deleting field 'Category.store'
        db.delete_column('categories_category', 'store_id')


    def backwards(self, orm):
        
        # Adding field 'Category.parent'
        db.add_column('categories_category', 'parent', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
        ...
        db.add_column('categories_category', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'], null=True, blank=True), keep_default=False)

        # Adding field 'Category.google_conversion_label'
        db.add_column('categories_category', 'google_conversion_label', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Category.ext_id'
        db.add_column('categories_category', 'ext_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Category.tagline'
        db.add_column('categories_category', 'tagline', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True), keep_default=False)

        # Adding field 'Category.client'
        db.add_column('categories_category', 'client', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['accounts.Client']), keep_default=False)

        # Adding field 'Category.show_compare'
        db.add_column('categories_category', 'show_compare', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Category.moderate'
        db.add_column('categories_category', 'moderate', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Category.store'
        db.add_column('categories_category', 'store', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Store'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'categories.categoryproducttypemapping': {
            'Meta': {'object_name': 'CategoryProducttypeMapping'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['categories.Category']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'categories.filter': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['categories.Category']"}),
            'feature': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['categories.Feature']", 'null': 'True', 'blank': 'True'}),
            'feature_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['categories.FeatureGroup']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'sort_order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
        ...
        'categories.filterbucket': {
            'Meta': {'object_name': 'FilterBucket'},
            'display_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'end': ('django.db.models.fields.CharField', [], {'default': "'*'", 'max_length': '10'}),
            'fil': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['categories.Filter']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {'default': '10'}),
            'start': ('django.db.models.fields.CharField', [], {'default': "'*'", 'max_length': '10'})
        },
        ...
        'categories.megadropdown': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level_2_type': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lists.List']", 'null': 'True', 'blank': 'True'}),
            'sort_order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'category'", 'max_length': '30'})
        },
