...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MegaDropDown.level_2_type'
        db.add_column('categories_megadropdown', 'level_2_type', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MegaDropDown.level_2_type'
        db.delete_column('categories_megadropdown', 'level_2_type')
