...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feature.use_as_key_features'
        db.add_column('categories_feature', 'use_as_key_features', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feature.use_as_key_features'
        db.delete_column('categories_feature', 'use_as_key_features')
