...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ProductType', fields ['type']
        db.delete_unique('categories_producttype', ['type'])

        # Adding unique constraint on 'ProductType', fields ['client', 'type']
        db.create_unique('categories_producttype', ['client_id', 'type'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'ProductType', fields ['type']
        db.create_unique('categories_producttype', ['type'])

        # Removing unique constraint on 'ProductType', fields ['client', 'type']
        db.delete_unique('categories_producttype', ['client_id', 'type'])
