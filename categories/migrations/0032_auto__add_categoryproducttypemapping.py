...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CategoryProducttypeMapping'
        db.create_table('categories_categoryproducttypemapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Category'])),
            ('product_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.ProductType'])),
        ))
        db.send_create_signal('categories', ['CategoryProducttypeMapping'])


    def backwards(self, orm):
        
        # Deleting model 'CategoryProducttypeMapping'
        db.delete_table('categories_categoryproducttypemapping')
