...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductType.client'
        db.add_column('categories_producttype', 'client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Client'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductType.client'
        db.delete_column('categories_producttype', 'client_id')
