...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FilterBucket'
        db.create_table('categories_filterbucket', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fil', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Filter'])),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(default=10)),
            ('start', self.gf('django.db.models.fields.CharField')(default='*', max_length=10)),
            ('end', self.gf('django.db.models.fields.CharField')(default='*', max_length=10)),
        ))
        db.send_create_signal('categories', ['FilterBucket'])


    def backwards(self, orm):
        
        # Deleting model 'FilterBucket'
        db.delete_table('categories_filterbucket')
