...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MegaDropDown.is_group_category'
        db.add_column('categories_megadropdown', 'is_group_category', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'MegaDropDown.type'
        db.alter_column('categories_megadropdown', 'type', self.gf('django.db.models.fields.CharField')(max_length=30))


    def backwards(self, orm):
        
        # Deleting field 'MegaDropDown.is_group_category'
        db.delete_column('categories_megadropdown', 'is_group_category')

        # Changing field 'MegaDropDown.type'
        db.alter_column('categories_megadropdown', 'type', self.gf('django.db.models.fields.CharField')(max_length=25))
    ...
    models = {
        ...
        'categories.megadropdown': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_group_category': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
