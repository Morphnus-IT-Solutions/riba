...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Coordinates.banner'
        db.delete_column('web_coordinates', 'banner_id')

        # Adding field 'Coordinates.list'
        db.add_column('web_coordinates', 'list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lists.List'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Coordinates.banner'
        db.add_column('web_coordinates', 'banner', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['lists.List'], blank=True), keep_default=False)

        # Deleting field 'Coordinates.list'
        db.delete_column('web_coordinates', 'list_id')
    ...
    models = {
        ...
        'lists.list': {
            ...
            'banner_type': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50'}),
