...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('web_announcements', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('landing_page_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ...
        db.send_create_signal('web', ['Announcements'])


    def backwards(self, orm):
        
        # Deleting model 'Announcements'
        db.delete_table('web_announcements')
