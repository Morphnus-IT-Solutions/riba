...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Coordinates.sequence'
        db.alter_column('web_coordinates', 'sequence', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Coordinates.sequence'
        db.alter_column('web_coordinates', 'sequence', self.gf('django.db.models.fields.PositiveIntegerField')())
