...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Announcements.title'
        db.add_column('web_announcements', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Announcements.title'
        db.delete_column('web_announcements', 'title')
