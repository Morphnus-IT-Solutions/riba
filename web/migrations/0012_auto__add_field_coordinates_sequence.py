...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Coordinates.sequence'
        db.add_column('web_coordinates', 'sequence', self.gf('django.db.models.fields.PositiveIntegerField')(default=None), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Coordinates.sequence'
        db.delete_column('web_coordinates', 'sequence')
