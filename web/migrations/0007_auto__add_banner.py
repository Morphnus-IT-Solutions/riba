...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('web_banner', (
            ...
            ('tagline', self.gf('django.db.models.fields.CharField')(max_length=5000, blank=True)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Client'])),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('redirect_to', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
    ...
    models = {
        ...
        'web.banner': {
            ...
            'redirect_to': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
            'sort_order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'tagline': ('django.db.models.fields.CharField', [], {'max_length': '5000', 'blank': 'True'})
        },
        'web.menuitem': {
