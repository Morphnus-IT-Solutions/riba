...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Coordinates.banner'
        db.alter_column('web_coordinates', 'banner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lists.List'], blank=True))


    def backwards(self, orm):
        
        # Changing field 'Coordinates.banner'
        db.alter_column('web_coordinates', 'banner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Banner'], blank=True))
    ...
    models = {
        ...
        'web.coordinates': {
            ...
            'banner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lists.List']", 'blank': 'True'}),
