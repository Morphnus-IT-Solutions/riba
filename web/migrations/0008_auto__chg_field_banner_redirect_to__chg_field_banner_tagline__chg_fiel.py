...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Banner.tagline'
        db.alter_column('web_banner', 'tagline', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True))

        # Changing field 'Banner.image'
        db.alter_column('web_banner', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Banner.redirect_to'
        db.alter_column('web_banner', 'redirect_to', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True))

        # Changing field 'Banner.tagline'
        db.alter_column('web_banner', 'tagline', self.gf('django.db.models.fields.CharField')(max_length=5000, blank=True))

        # Changing field 'Banner.image'
        db.alter_column('web_banner', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
