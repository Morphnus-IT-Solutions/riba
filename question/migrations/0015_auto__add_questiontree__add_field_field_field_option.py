...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('question_questiontree', (
            ...
            ('parent_question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parent_question', blank=True, null=True, to=orm['question.Question'])),
            ('parent_value', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ...
        # Adding field 'Field.field_option'
        db.add_column('question_field', 'field_option', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Field.field_option'
        db.delete_column('question_field', 'field_option')
    ...
    models = {
        ...
        'question.option': {
            ...
            'dependent_question': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dependent_question'", 'blank': 'True', 'null': 'True', 'to': "orm['question.Question']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'question.questiontree': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent_question': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'parent_question'", 'blank': 'True', 'null': 'True', 'to': "orm['question.Question']"}),
