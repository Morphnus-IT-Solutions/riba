...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Field.field_label'
        db.alter_column('question_field', 'field_label', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Option.option_value'
        db.alter_column('question_option', 'option_value', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Field.field_label'
        db.alter_column('question_field', 'field_label', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))

        # Changing field 'Option.option_value'
        db.alter_column('question_option', 'option_value', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))
    ...
    models = {
        ...
        'question.field': {
            ...
            'field_label': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        'question.option': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'option_value': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['question.Question']"})
        },
        'question.question': {
