...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('question_question', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Category']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Question.category'
        db.delete_column('question_question', 'category_id')
