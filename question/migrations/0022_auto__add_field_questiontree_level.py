...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'QuestionTree.level'
        db.add_column('question_questiontree', 'level', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'QuestionTree.level'
        db.delete_column('question_questiontree', 'level')
