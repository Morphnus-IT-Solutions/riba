...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuestionTree.parent_value'
        db.alter_column('question_questiontree', 'parent_value', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'QuestionTree.parent_value'
        db.alter_column('question_questiontree', 'parent_value', self.gf('django.db.models.fields.CharField')(max_length=200))
