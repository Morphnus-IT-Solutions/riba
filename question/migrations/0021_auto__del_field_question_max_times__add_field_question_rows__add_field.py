...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Question.rows'
        db.add_column('question_question', 'rows', self.gf('django.db.models.fields.IntegerField')(default=5, null=True, blank=True), keep_default=False)

        # Adding field 'Question.columns'
        db.add_column('question_question', 'columns', self.gf('django.db.models.fields.IntegerField')(default=40, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Question.max_times'
        db.add_column('question_question', 'max_times', self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True), keep_default=False)

        # Deleting field 'Question.rows'
        db.delete_column('question_question', 'rows')

        # Deleting field 'Question.columns'
        db.delete_column('question_question', 'columns')
