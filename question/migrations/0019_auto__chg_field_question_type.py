...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('question_question', 'type', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Question.type'
        db.alter_column('question_question', 'type', self.gf('django.db.models.fields.CharField')(max_length=10))
