...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('question_question', 'type')

        # Adding field 'Question.is_recurring'
        db.add_column('question_question', 'is_recurring', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=True)

        # Adding field 'Question.recurring_times'
        db.add_column('question_question', 'recurring_times', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, null=True, blank=True), keep_default=True)


    def backwards(self, orm):
        
        # Adding field 'Question.type'
        db.add_column('question_question', 'type', self.gf('django.db.models.fields.CharField')(default='normal', max_length=10, null=True, blank=True, db_index=True), keep_default=False)

        # Deleting field 'Question.is_recurring'
        db.delete_column('question_question', 'is_recurring')

        # Deleting field 'Question.recurring_times'
        db.delete_column('question_question', 'recurring_times')
