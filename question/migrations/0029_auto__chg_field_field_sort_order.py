...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Field.sort_order'
        db.alter_column('question_field', 'sort_order', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Field.sort_order'
        db.alter_column('question_field', 'sort_order', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        'question.field': {
            ...
            'sort_order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1', 'null': 'True', 'blank': 'True'})
        },
        'question.option': {
