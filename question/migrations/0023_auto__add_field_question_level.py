...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('question_question', 'level', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'Question.level'
        db.delete_column('question_question', 'level')
