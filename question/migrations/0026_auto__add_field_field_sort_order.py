...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('question_field', 'sort_order', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'Field.sort_order'
        db.delete_column('question_field', 'sort_order')
