...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('question_option', 'question', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['question.Question']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Option.question'
        db.delete_column('question_option', 'question_id')
    ...
    models = {
        'question.option': {
            ...
            'nested_question': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'Nested Question'", 'to': "orm['question.Question']"}),
