...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'activitystream.activity': {
            ...
            'aclientdomain': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.ClientDomain']"}),
            'asrc': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.SellerRateChart']", 'null': 'True', 'blank': 'True'}),
            'astatus': ('django.db.models.fields.CharField', [], {'default': "'Visible'", 'max_length': '50'}),
            'astream': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'atime': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1302257077'}),
            'atype': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
