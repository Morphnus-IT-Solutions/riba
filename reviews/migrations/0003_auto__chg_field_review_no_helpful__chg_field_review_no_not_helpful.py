...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Review.no_helpful'
        db.alter_column('reviews_review', 'no_helpful', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Review.no_not_helpful'
        db.alter_column('reviews_review', 'no_not_helpful', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Review.no_helpful'
        db.alter_column('reviews_review', 'no_helpful', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Review.no_not_helpful'
        db.alter_column('reviews_review', 'no_not_helpful', self.gf('django.db.models.fields.IntegerField')(null=True))
