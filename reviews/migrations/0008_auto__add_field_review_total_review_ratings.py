...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.total_review_ratings'
        db.add_column('reviews_review', 'total_review_ratings', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.total_review_ratings'
        db.delete_column('reviews_review', 'total_review_ratings')
    ...
    models = {
        ...
        'reviews.review': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 18, 38, 0, 51852)', 'auto_now': 'True', 'blank': 'True'}),
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'total_review_ratings': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
