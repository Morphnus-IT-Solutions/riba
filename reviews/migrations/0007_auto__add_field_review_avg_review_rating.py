...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.avg_review_rating'
        db.add_column('reviews_review', 'avg_review_rating', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding M2M table for field review_rating_user on 'Review'
        db.create_table('reviews_review_review_rating_user', (
        ...
        db.create_unique('reviews_review_review_rating_user', ['review_id', 'profile_id'])


    def backwards(self, orm):
        
        # Deleting field 'Review.avg_review_rating'
        db.delete_column('reviews_review', 'avg_review_rating')

        # Removing M2M table for field review_rating_user on 'Review'
        db.delete_table('reviews_review_review_rating_user')
    ...
    models = {
        ...
        'reviews.review': {
            ...
            'avg_review_rating': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 18, 30, 14, 530904)', 'auto_now': 'True', 'blank': 'True'}),
            'no_helpful': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'no_not_helpful': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Product']"}),
            ...
            'review_rating_user': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'rating_user'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['users.Profile']"}),
            'reviewed_by': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
