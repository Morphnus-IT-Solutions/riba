...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.reviewed_by'
        db.add_column('reviews_review', 'reviewed_by', self.gf('django.db.models.fields.CharField')(default=None, max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.reviewed_by'
        db.delete_column('reviews_review', 'reviewed_by')
    ...
    models = {
        ...
        'reviews.review': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 20, 23, 15, 9, 217079)', 'auto_now': 'True', 'blank': 'True'}),
