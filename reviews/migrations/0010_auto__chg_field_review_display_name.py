...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Review.display_name'
        db.alter_column('reviews_review', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Review.display_name'
        db.alter_column('reviews_review', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        'reviews.review': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 14, 19, 37, 8, 864593)', 'auto_now': 'True', 'blank': 'True'}),
