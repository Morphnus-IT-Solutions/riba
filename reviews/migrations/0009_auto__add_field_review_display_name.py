...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.display_name'
        db.add_column('reviews_review', 'display_name', self.gf('django.db.models.fields.CharField')(default=1, max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.display_name'
        db.delete_column('reviews_review', 'display_name')
    ...
    models = {
        ...
        'reviews.review': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 18, 58, 44, 885405)', 'auto_now': 'True', 'blank': 'True'}),
