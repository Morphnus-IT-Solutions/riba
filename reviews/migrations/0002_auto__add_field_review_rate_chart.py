...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.rate_chart'
        db.add_column('reviews_review', 'rate_chart', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['catalog.SellerRateChart']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.rate_chart'
        db.delete_column('reviews_review', 'rate_chart_id')
