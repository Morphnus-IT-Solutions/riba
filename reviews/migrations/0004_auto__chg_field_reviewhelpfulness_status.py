...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReviewHelpfulness.status'
        db.alter_column('reviews_reviewhelpfulness', 'status', self.gf('django.db.models.fields.CharField')(max_length=15))


    def backwards(self, orm):
        
        # Changing field 'ReviewHelpfulness.status'
        db.alter_column('reviews_reviewhelpfulness', 'status', self.gf('django.db.models.fields.CharField')(max_length=10))
