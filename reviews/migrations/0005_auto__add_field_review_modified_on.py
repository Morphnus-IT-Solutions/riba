...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.modified_on'
        db.add_column('reviews_review', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 9, 27, 15, 32, 27, 111739), auto_now=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.modified_on'
        db.delete_column('reviews_review', 'modified_on')
    ...
    models = {
        ...
        'reviews.review': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 27, 15, 32, 27, 111739)', 'auto_now': 'True', 'blank': 'True'}),
