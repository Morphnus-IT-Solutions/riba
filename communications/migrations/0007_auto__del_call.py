...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('communications_call', (
            ...
            ('unique_id', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True, db_index=True)),
        ))
    ...
    models = {
        ...
        'communications.email': {
            ...
            'client_domain': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['accounts.ClientDomain']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
