...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('communications_email', 'body', self.gf('tinymce.models.HTMLField')())


    def backwards(self, orm):
        
        # Changing field 'Email.body'
        db.alter_column('communications_email', 'body', self.gf('django.db.models.fields.TextField')())
