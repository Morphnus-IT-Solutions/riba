...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Email.client_domain'
        db.alter_column('communications_email', 'client_domain_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.ClientDomain']))


    def backwards(self, orm):
        
        # Changing field 'Email.client_domain'
        db.alter_column('communications_email', 'client_domain_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.ClientDomain'], null=True, blank=True))
    ...
    models = {
        ...
        'communications.email': {
            ...
            'client_domain': ('django.db.models.fields.related.ForeignKey', [], {'default': "'10.0.101.14'", 'to': "orm['accounts.ClientDomain']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
