...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Email.client_domain'
        db.add_column('communications_email', 'client_domain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.ClientDomain'], null=True, blank=True), keep_default=False)

        # Adding field 'Email.order'
        db.add_column('communications_email', 'order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Order'], null=True, blank=True), keep_default=False)

        # Adding field 'Email.profile'
        db.add_column('communications_email', 'profile', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_profile', null=True, to=orm['users.Profile']), keep_default=False)

        # Adding field 'Email.type'
        db.add_column('communications_email', 'type', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Email.client_domain'
        db.delete_column('communications_email', 'client_domain_id')

        # Deleting field 'Email.order'
        db.delete_column('communications_email', 'order_id')

        # Deleting field 'Email.profile'
        db.delete_column('communications_email', 'profile_id')

        # Deleting field 'Email.type'
        db.delete_column('communications_email', 'type')
    ...
    models = {
        ...
        'communications.email': {
            ...
            'client_domain': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.ClientDomain']", 'null': 'True', 'blank': 'True'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'user_profile'", 'null': 'True', 'to': "orm['users.Profile']"}),
            ...
            'type': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '30', 'null': 'True', 'blank': 'True'})
        },
        'communications.sms': {
