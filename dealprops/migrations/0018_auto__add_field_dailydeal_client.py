...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailyDeal.client'
        db.add_column('dealprops_dailydeal', 'client', self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['accounts.Client']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DailyDeal.client'
        db.delete_column('dealprops_dailydeal', 'client_id')
