...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'DailyDeal', fields ['ends_on']
        db.create_index('dealprops_dailydeal', ['ends_on'])

        # Adding index on 'DailyDeal', fields ['starts_on']
        db.create_index('dealprops_dailydeal', ['starts_on'])


    def backwards(self, orm):
        
        # Removing index on 'DailyDeal', fields ['ends_on']
        db.delete_index('dealprops_dailydeal', ['ends_on'])

        # Removing index on 'DailyDeal', fields ['starts_on']
        db.delete_index('dealprops_dailydeal', ['starts_on'])
    ...
    models = {
        ...
        'dealprops.dailydeal': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'default': '5', 'to': "orm['accounts.Client']"}),
            'description': ('tinymce.models.HTMLField', [], {'null': 'True', 'blank': 'True'}),
            'ends_on': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
            'features': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'home_thumb_banner': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'n_orders': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            ...
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'starts_on': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'hero'", 'max_length': '15'}),
        ...
        'dealprops.dailydealproduct': {
            'Meta': {'object_name': 'DailyDealProduct'},
            'daily_deal': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dealprops.DailyDeal']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Product']"})
        },
        'dealprops.fridaydeal': {
            'Meta': {'object_name': 'FridayDeal'},
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'published'", 'max_length': '15', 'db_index': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'})
        },
        'dealprops.fridaydealproducts': {
            'Meta': {'unique_together': "(('deal', 'product'),)", 'object_name': 'FridayDealProducts'},
            'deal': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dealprops.FridayDeal']"}),
            'ends_on': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.Product']"}),
        ...
        'dealprops.middaydeal': {
            'Meta': {'object_name': 'MidDayDeal'},
            'ends_on': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'starts_on': ('django.db.models.fields.DateTimeField', [], {}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'published'", 'max_length': '15', 'db_index': 'True'}),
        ...
        'dealprops.middayproducts': {
            'Meta': {'unique_together': "(('midday', 'sku'),)", 'object_name': 'MidDayProducts'},
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'features': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'midday': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dealprops.MidDayDeal']"}),
            'sequence': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'sku': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalog.SellerRateChart']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'blank': 'True'})
        }
    }
