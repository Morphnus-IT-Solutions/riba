...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailyDeal.rate_chart'
        db.alter_column('dealprops_dailydeal', 'rate_chart_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SellerRateChart'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'DailyDeal.rate_chart'
        db.alter_column('dealprops_dailydeal', 'rate_chart_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SellerRateChart']))
