...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FridayDeal'
        db.create_table('dealprops_fridaydeal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('starts_on', self.gf('django.db.models.fields.DateTimeField')()),
            ('ends_on', self.gf('django.db.models.fields.DateTimeField')()),
            ('status', self.gf('django.db.models.fields.CharField')(default='published', max_length=15, db_index=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('banner_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('dealprops', ['FridayDeal'])

        # Adding model 'FridayDealProducts'
        db.create_table('dealprops_fridaydealproducts', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dealprops.FridayDeal'])),
        ...
        db.send_create_signal('dealprops', ['FridayDealProducts'])


    def backwards(self, orm):
        
        # Deleting model 'FridayDeal'
        db.delete_table('dealprops_fridaydeal')

        # Deleting model 'FridayDealProducts'
        db.delete_table('dealprops_fridaydealproducts')
    ...
    models = {
        ...
        'dealprops.dailydeal': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'single'", 'max_length': '15'}),
