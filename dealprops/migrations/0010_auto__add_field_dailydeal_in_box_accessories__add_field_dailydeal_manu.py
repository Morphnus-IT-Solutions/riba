...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailyDeal.in_box_accessories'
        db.add_column('dealprops_dailydeal', 'in_box_accessories', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'DailyDeal.manufactures_warranty'
        db.add_column('dealprops_dailydeal', 'manufactures_warranty', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DailyDeal.in_box_accessories'
        db.delete_column('dealprops_dailydeal', 'in_box_accessories')

        # Deleting field 'DailyDeal.manufactures_warranty'
        db.delete_column('dealprops_dailydeal', 'manufactures_warranty')
