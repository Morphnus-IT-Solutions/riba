...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailyDeal.weekday_image'
        db.add_column('dealprops_dailydeal', 'weekday_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DailyDeal.weekday_image'
        db.delete_column('dealprops_dailydeal', 'weekday_image')
    ...
    models = {
        ...
        'dealprops.dailydeal': {
            ...
            'manufactures_warranty': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'blank': 'True'}),
            ...
            'steal_now_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
            ...
            'weekday_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'})
        },
