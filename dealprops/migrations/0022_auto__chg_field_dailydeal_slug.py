...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailyDeal.slug'
        db.alter_column('dealprops_dailydeal', 'slug', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'DailyDeal.slug'
        db.alter_column('dealprops_dailydeal', 'slug', self.gf('django.db.models.fields.CharField')(max_length=100))
