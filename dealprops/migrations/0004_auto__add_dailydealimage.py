...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DailyDealImage'
        db.create_table('dealprops_dailydealimage', (
        ...
        db.send_create_signal('dealprops', ['DailyDealImage'])


    def backwards(self, orm):
        
        # Deleting model 'DailyDealImage'
        db.delete_table('dealprops_dailydealimage')
