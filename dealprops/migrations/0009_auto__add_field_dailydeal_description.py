...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailyDeal.description'
        db.add_column('dealprops_dailydeal', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DailyDeal.description'
        db.delete_column('dealprops_dailydeal', 'description')
