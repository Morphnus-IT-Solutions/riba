...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailyDeal.manufactures_warranty'
        db.alter_column('dealprops_dailydeal', 'manufactures_warranty', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'DailyDeal.manufactures_warranty'
        db.alter_column('dealprops_dailydeal', 'manufactures_warranty', self.gf('django.db.models.fields.PositiveIntegerField')(blank=True))
