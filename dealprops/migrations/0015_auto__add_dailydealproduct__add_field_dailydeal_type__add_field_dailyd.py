...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DailyDealProduct'
        db.create_table('dealprops_dailydealproduct', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Product'])),
            ('daily_deal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dealprops.DailyDeal'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
        ))
        db.send_create_signal('dealprops', ['DailyDealProduct'])

        # Adding field 'DailyDeal.type'
        db.add_column('dealprops_dailydeal', 'type', self.gf('django.db.models.fields.CharField')(default='single', max_length=15), keep_default=False)

        # Adding field 'DailyDeal.slug'
        db.add_column('dealprops_dailydeal', 'slug', self.gf('django.db.models.fields.CharField')(default=' ', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'DailyDealProduct'
        db.delete_table('dealprops_dailydealproduct')

        # Deleting field 'DailyDeal.type'
        db.delete_column('dealprops_dailydeal', 'type')

        # Deleting field 'DailyDeal.slug'
        db.delete_column('dealprops_dailydeal', 'slug')
