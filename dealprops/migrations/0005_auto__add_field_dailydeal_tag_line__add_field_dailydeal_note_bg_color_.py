...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailyDeal.tag_line'
        db.add_column('dealprops_dailydeal', 'tag_line', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)

        # Adding field 'DailyDeal.note_bg_color_code'
        db.add_column('dealprops_dailydeal', 'note_bg_color_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True), keep_default=False)

        # Changing field 'DailyDeal.features'
        db.alter_column('dealprops_dailydeal', 'features', self.gf('django.db.models.fields.TextField')(blank=True))

        # Changing field 'DailyDeal.title'
        db.alter_column('dealprops_dailydeal', 'title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'DailyDeal.tag_line'
        db.delete_column('dealprops_dailydeal', 'tag_line')

        # Deleting field 'DailyDeal.note_bg_color_code'
        db.delete_column('dealprops_dailydeal', 'note_bg_color_code')

        # Changing field 'DailyDeal.features'
        db.alter_column('dealprops_dailydeal', 'features', self.gf('django.db.models.fields.TextField')())

        # Changing field 'DailyDeal.title'
        db.alter_column('dealprops_dailydeal', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'dealprops.dailydeal': {
            ...
            'tag_line': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
