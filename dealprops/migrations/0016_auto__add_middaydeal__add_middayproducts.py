...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MidDayDeal'
        db.create_table('dealprops_middaydeal', (
        ...
        db.send_create_signal('dealprops', ['MidDayDeal'])

        # Adding model 'MidDayProducts'
        db.create_table('dealprops_middayproducts', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('midday', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dealprops.MidDayDeal'])),
            ('sku', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.SellerRateChart'])),
        ...
        db.send_create_signal('dealprops', ['MidDayProducts'])


    def backwards(self, orm):
        
        # Deleting model 'MidDayDeal'
        db.delete_table('dealprops_middaydeal')

        # Deleting model 'MidDayProducts'
        db.delete_table('dealprops_middayproducts')
