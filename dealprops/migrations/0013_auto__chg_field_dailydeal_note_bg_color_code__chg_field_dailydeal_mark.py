...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailyDeal.note_bg_color_code'
        db.alter_column('dealprops_dailydeal', 'note_bg_color_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True))

        # Changing field 'DailyDeal.market_price_color_code'
        db.alter_column('dealprops_dailydeal', 'market_price_color_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True))

        # Changing field 'DailyDeal.product_color_code'
        db.alter_column('dealprops_dailydeal', 'product_color_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True))

        # Changing field 'DailyDeal.weekday_image'
        db.alter_column('dealprops_dailydeal', 'weekday_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True))

        # Changing field 'DailyDeal.todays_steal_color_code'
        db.alter_column('dealprops_dailydeal', 'todays_steal_color_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True))

        # Changing field 'DailyDeal.steal_now_image'
        db.alter_column('dealprops_dailydeal', 'steal_now_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True))

        # Changing field 'DailyDeal.tag_line_color_code'
        db.alter_column('dealprops_dailydeal', 'tag_line_color_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True))

        # Changing field 'DailyDeal.tag_line'
        db.alter_column('dealprops_dailydeal', 'tag_line', self.gf('django.db.models.fields.TextField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'DailyDeal.note_bg_color_code'
        db.alter_column('dealprops_dailydeal', 'note_bg_color_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'DailyDeal.market_price_color_code'
        db.alter_column('dealprops_dailydeal', 'market_price_color_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'DailyDeal.product_color_code'
        db.alter_column('dealprops_dailydeal', 'product_color_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'DailyDeal.weekday_image'
        db.alter_column('dealprops_dailydeal', 'weekday_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'DailyDeal.todays_steal_color_code'
        db.alter_column('dealprops_dailydeal', 'todays_steal_color_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'DailyDeal.steal_now_image'
        db.alter_column('dealprops_dailydeal', 'steal_now_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'DailyDeal.tag_line_color_code'
        db.alter_column('dealprops_dailydeal', 'tag_line_color_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'DailyDeal.tag_line'
        db.alter_column('dealprops_dailydeal', 'tag_line', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'dealprops.dailydeal': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_box_accessories': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'manufactures_warranty': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'market_price_color_code': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'n_orders': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'note_bg_color_code': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'product_color_code': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'tag_line': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'tag_line_color_code': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'todays_steal_color_code': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'weekday_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
