...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailyDeal.home_thumb_banner'
        db.add_column('dealprops_dailydeal', 'home_thumb_banner', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DailyDeal.home_thumb_banner'
        db.delete_column('dealprops_dailydeal', 'home_thumb_banner')
