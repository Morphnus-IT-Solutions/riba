...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailyDeal.features'
        db.add_column('dealprops_dailydeal', 'features', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DailyDeal.features'
        db.delete_column('dealprops_dailydeal', 'features')
