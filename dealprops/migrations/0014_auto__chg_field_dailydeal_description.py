...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailyDeal.description'
        db.alter_column('dealprops_dailydeal', 'description', self.gf('tinymce.models.HTMLField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'DailyDeal.description'
        db.alter_column('dealprops_dailydeal', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True))
