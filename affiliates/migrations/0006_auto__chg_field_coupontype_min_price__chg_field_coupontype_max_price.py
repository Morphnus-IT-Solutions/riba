...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CouponType.min_price'
        db.alter_column('affiliates_coupontype', 'min_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True))

        # Changing field 'CouponType.max_price'
        db.alter_column('affiliates_coupontype', 'max_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True))


    def backwards(self, orm):
        
        # Changing field 'CouponType.min_price'
        db.alter_column('affiliates_coupontype', 'min_price', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True))

        # Changing field 'CouponType.max_price'
        db.alter_column('affiliates_coupontype', 'max_price', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True))
