...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Voucher', fields ['status']
        db.create_index('affiliates_voucher', ['status'])

        # Adding field 'Affiliate.is_coupon_avail'
        db.add_column('affiliates_affiliate', 'is_coupon_avail', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Removing index on 'Voucher', fields ['status']
        db.delete_index('affiliates_voucher', ['status'])

        # Deleting field 'Affiliate.is_coupon_avail'
        db.delete_column('affiliates_affiliate', 'is_coupon_avail')
    ...
    models = {
        ...
        'affiliates.voucher': {
            ...
            'expires_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 16, 16, 37, 57, 129654)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'inactive'", 'max_length': '25', 'db_index': 'True'}),
