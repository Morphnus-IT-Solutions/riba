...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Voucher.affiliate'
        db.add_column('affiliates_voucher', 'affiliate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['affiliates.Affiliate'], null=True, blank=True), keep_default=False)

        # Changing field 'Voucher.type'
        db.alter_column('affiliates_voucher', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['affiliates.CouponType'], null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'Voucher.affiliate'
        db.delete_column('affiliates_voucher', 'affiliate_id')

        # Changing field 'Voucher.type'
        db.alter_column('affiliates_voucher', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['affiliates.CouponType']))
    ...
    models = {
        ...
        'affiliates.voucher': {
            ...
            'expires_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 7, 2, 25, 15, 55866)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'inactive'", 'max_length': '25'}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['affiliates.CouponType']", 'null': 'True', 'blank': 'True'}),
